 ...
 */
export type TypeAttribute = "AsBoolean" | "AsUndefined" | "AsNumber";
 ...
 */
export type TsIdentifier = {
  readonly _: "Identifier";
  readonly string: String;
};
 ...
 */
export type ProjectDataFileHashValue = string & {
  readonly _projectDataFileHashValue: never;
};
...
export type Location =
  ...
  | { readonly _: "Part"; readonly partId: PartId }
  | { readonly _: "LocalProject" };
...
export const ProjectId: {
   ...
   * 文字列から変換する
   */
  readonly fromString: (a: string) => ProjectId;
} = {
  ...
  fromString: (str: string): ProjectId => str as ProjectId,
};
...
export const ElmTypeName: {
  ...
  codec: {
    ...
    decode: (
      ...
      if (patternIndex.result === 0) {
        const result: { readonly result: String; readonly nextIndex: number } =
  ...
  codec: {
    ...
    decode: (
      ...
      if (patternIndex.result === 3) {
        const result: { readonly result: ElmType; readonly nextIndex: number } =
...
export const TsType: {
  ...
  ScopeInFile: (tsIdentifier: TsIdentifier): TsType => ({
    _: "ScopeInFile",
    tsIdentifier,
  }),
  ScopeInGlobal: (tsIdentifier: TsIdentifier): TsType => ({
    _: "ScopeInGlobal",
    tsIdentifier,
  }),
  ...
  codec: {
    ...
    decode: (
      ...
      if (patternIndex.result === 13) {
        const result: {
          readonly result: TsIdentifier;
          readonly nextIndex: number;
        } = TsIdentifier.codec.decode(patternIndex.nextIndex, binary);
        return {
...
export const ResourceState: {
  ...
  codec: <data extends unknown>(
    ...
    decode: (
      ...
      if (patternIndex.result === 1) {
        const result: { readonly result: Time; readonly nextIndex: number } =
...
export const TypeAttribute: {
   ...
   */
  readonly AsNumber: TypeAttribute;
} = {
  AsBoolean: "AsBoolean",
...
export const EvaluateExprError: {
  ...
  codec: {
    ...
    decode: (
      ...
      if (patternIndex.result === 0) {
        const result: { readonly result: PartId; readonly nextIndex: number } =
...
export const TsIdentifier: {
   ...
   */
  readonly Identifier: (a: String) => TsIdentifier;
} = {
  Identifier: (string_: String): TsIdentifier => ({
    _: "Identifier",
    string: string_,
  }),
  typePartId: "2a75ad7c7ccc58ba56f6c8545c8150d1" as TypePartId,
  codec: {
    encode: (value: TsIdentifier): ReadonlyArray<number> => {
      switch (value._) {
        case "Identifier": {
          return [0].concat(String.codec.encode(value.string));
        }
    ...
    decode: (
      index: number,
      binary: Uint8Array
    ): { readonly result: TsIdentifier; readonly nextIndex: number } => {
      const patternIndex: {
        readonly result: number;
        readonly nextIndex: number;
      } = Int32.codec.decode(index, binary);
      if (patternIndex.result === 0) {
        const result: { readonly result: String; readonly nextIndex: number } =
          String.codec.decode(patternIndex.nextIndex, binary);
        return {
          result: TsIdentifier.Identifier(result.result),
          nextIndex: result.nextIndex,
        };
      }
      throw new Error("存在しないパターンを指定された 型を更新してください");
...
export const Maybe: {
  ...
  codec: <value extends unknown>(
    ...
    decode: (
      ...
      if (patternIndex.result === 0) {
        const result: { readonly result: value; readonly nextIndex: number } =
...
export const Binary: {
  ...
  codec: {
    ...
    decode: (
      ...
      const length: { readonly result: number; readonly nextIndex: number } =
        Int32.codec.decode(index, binary);
  ...
  codec: {
    ...
    decode: (
      ...
      const nameAndNextIndex: {
        readonly result: TsIdentifier;
        readonly nextIndex: number;
      } = TsIdentifier.codec.decode(index, binary);
      const typeAndNextIndex: {
        readonly result: TsType;
        readonly nextIndex: number;
  ...
  codec: <key extends unknown, value extends unknown>(
    ...
    decode: (
      ...
      for (let i = 0; i < lengthResult.result; i += 1) {
        const keyResult: { readonly result: key; readonly nextIndex: number } =
...
export const PartId: {
  ...
  fromString: (str: string): PartId => str as PartId,
};
...
export const AccountTokenAccountId: {
   ...
   * 型を合わせる上で便利なヘルパー関数
   */
  readonly helper: (a: AccountTokenAccountId) => AccountTokenAccountId;
} = {
  typePartId: "5d291325e9d7bc27ff35e907f59bde54" as TypePartId,
  helper: (
    accountTokenAccountId: AccountTokenAccountId
  ): AccountTokenAccountId => accountTokenAccountId,
  codec: {
    encode: (value: AccountTokenAccountId): ReadonlyArray<number> =>
      AccountToken.codec
        .encode(value.accountToken)
        .concat(AccountId.codec.encode(value.accountId)),
    decode: (
      index: number,
      binary: Uint8Array
    ): {
      readonly result: AccountTokenAccountId;
      readonly nextIndex: number;
    } => {
      ...
      return {
        result: {
          ...
          accountId: accountIdAndNextIndex.result,
        },
        nextIndex: accountIdAndNextIndex.nextIndex,
      };
    },
  },
};
...
export const TagId: {
   ...
   * 文字列から変換する
   */
  readonly fromString: (a: string) => TagId;
} = {
  ...
  fromString: (str: string): TagId => str as TagId,
};
  ...
  codec: {
    ...
    decode: (
      ...
      const idAndNextIndex: {
        readonly result: AccountId;
        readonly nextIndex: number;
      } = AccountId.codec.decode(nameAndNextIndex.nextIndex, binary);
      return {
        result: {
...
export const StaticResourceState: {
  ...
  codec: <data extends unknown>(
    ...
    decode: (
      ...
      if (patternIndex.result === 0) {
        const result: { readonly result: data; readonly nextIndex: number } =
...
export const TypePartId: {
   ...
   * 文字列から変換する
   */
  readonly fromString: (a: string) => TypePartId;
} = {
  ...
  fromString: (str: string): TypePartId => str as TypePartId,
};
...
export const Result: {
  ...
  codec: <ok extends unknown, error extends unknown>(
    ...
    decode: (
      ...
      if (patternIndex.result === 0) {
        const result: { readonly result: ok; readonly nextIndex: number } =
      ...
      if (patternIndex.result === 1) {
        const result: { readonly result: error; readonly nextIndex: number } =
...
export const Statement: {
  ...
  codec: {
    ...
    decode: (
      ...
      if (patternIndex.result === 0) {
        const result: { readonly result: TsExpr; readonly nextIndex: number } =
...
export const ImportedVariable: {
  ...
  codec: {
    encode: (value: ImportedVariable): ReadonlyArray<number> =>
      String.codec
        .encode(value.moduleName)
        .concat(TsIdentifier.codec.encode(value.name)),
    decode: (
      index: number,
      binary: Uint8Array
      ...
      const nameAndNextIndex: {
        readonly result: TsIdentifier;
        readonly nextIndex: number;
      } = TsIdentifier.codec.decode(moduleNameAndNextIndex.nextIndex, binary);
      return {
        result: {
          moduleName: moduleNameAndNextIndex.result,
          name: nameAndNextIndex.result,
  ...
  codec: {
    encode: (value: TypePart): ReadonlyArray<number> =>
      String.codec
        ...
        .concat(
          List.codec(DataTypeParameter.codec).encode(
            value.dataTypeParameterList
          )
        )
        .concat(TypePartBody.codec.encode(value.body))
        .concat(TypePartId.codec.encode(value.id)),
    decode: (
      index: number,
      binary: Uint8Array
      ...
      const dataTypeParameterListAndNextIndex: {
        readonly result: List<DataTypeParameter>;
        readonly nextIndex: number;
      } = List.codec(DataTypeParameter.codec).decode(
      ...
      const bodyAndNextIndex: {
        ...
        dataTypeParameterListAndNextIndex.nextIndex,
        binary
      );
      const idAndNextIndex: {
        readonly result: TypePartId;
        readonly nextIndex: number;
      } = TypePartId.codec.decode(bodyAndNextIndex.nextIndex, binary);
      return {
        result: {
          name: nameAndNextIndex.result,
          ...
          dataTypeParameterList: dataTypeParameterListAndNextIndex.result,
...
export const ProjectDataFile: {
   ...
   * 型を合わせる上で便利なヘルパー関数
   */
  readonly helper: (a: ProjectDataFile) => ProjectDataFile;
} = {
  typePartId: "8aa41233812aab908b1d71d11ad97375" as TypePartId,
  helper: (projectDataFile: ProjectDataFile): ProjectDataFile =>
    projectDataFile,
  codec: {
    encode: (value: ProjectDataFile): ReadonlyArray<number> =>
      ProjectId.codec
        .encode(value.id)
        .concat(String.codec.encode(value.name))
        .concat(List.codec(TypePart.codec).encode(value.typePartList))
        .concat(List.codec(Part.codec).encode(value.partList)),
    decode: (
      index: number,
      binary: Uint8Array
    ): { readonly result: ProjectDataFile; readonly nextIndex: number } => {
      const idAndNextIndex: {
        readonly result: ProjectId;
        readonly nextIndex: number;
      ...
      const typePartListAndNextIndex: {
        readonly result: List<TypePart>;
        readonly nextIndex: number;
      } = List.codec(TypePart.codec).decode(nameAndNextIndex.nextIndex, binary);
      const partListAndNextIndex: {
        readonly result: List<Part>;
        readonly nextIndex: number;
      } = List.codec(Part.codec).decode(
...
export const TsExpr: {
  ...
  Variable: (tsIdentifier: TsIdentifier): TsExpr => ({
    _: "Variable",
    tsIdentifier,
  }),
  GlobalObjects: (tsIdentifier: TsIdentifier): TsExpr => ({
    _: "GlobalObjects",
    tsIdentifier,
  }),
  ...
  codec: {
    ...
    decode: (
      ...
      if (patternIndex.result === 0) {
        const result: { readonly result: Int32; readonly nextIndex: number } =
      ...
      if (patternIndex.result === 2) {
        const result: { readonly result: Bool; readonly nextIndex: number } =
      ...
      if (patternIndex.result === 14) {
        const result: { readonly result: GetExpr; readonly nextIndex: number } =
  ...
  codec: {
    encode: (value: Project): ReadonlyArray<number> =>
      String.codec
        ...
        .concat(ProjectId.codec.encode(value.id)),
    decode: (
      index: number,
      binary: Uint8Array
      ...
      const idAndNextIndex: {
        readonly result: ProjectId;
        readonly nextIndex: number;
      } = ProjectId.codec.decode(updateTimeAndNextIndex.nextIndex, binary);
      return {
        result: {
          name: nameAndNextIndex.result,
...
export const ElmExpr: {
  ...
  codec: {
    ...
    decode: (
      ...
      if (patternIndex.result === 6) {
        const result: { readonly result: ElmExpr; readonly nextIndex: number } =
...
export const FunctionType: {
  ...
  codec: {
    ...
    decode: (
      ...
      const typeParameterListAndNextIndex: {
        readonly result: List<TsIdentifier>;
        readonly nextIndex: number;
      } = List.codec(TsIdentifier.codec).decode(index, binary);
...
export const Tuple2: {
   ...
   * 独自のバイナリ形式の変換処理ができるコーデック
   */
  readonly codec: <first extends unknown, second extends unknown>(
    a: Codec<first>,
    b: Codec<second>
  ) => Codec<Tuple2<first, second>>;
  /**
   * 型を合わせる上で便利なヘルパー関数
   */
  readonly helper: <first extends unknown, second extends unknown>(
    a: Tuple2<first, second>
  ) => Tuple2<first, second>;
} = {
  typePartId: "9b55e2a5ed07246355fbeba998eaf5fe" as TypePartId,
  helper: <first extends unknown, second extends unknown>(
    tuple2: Tuple2<first, second>
  ): Tuple2<first, second> => tuple2,
  codec: <first extends unknown, second extends unknown>(
    firstCodec: Codec<first>,
    secondCodec: Codec<second>
  ): Codec<Tuple2<first, second>> => ({
    encode: (value: Tuple2<first, second>): ReadonlyArray<number> =>
      firstCodec.encode(value.first).concat(secondCodec.encode(value.second)),
    decode: (
      index: number,
      binary: Uint8Array
    ): {
      readonly result: Tuple2<first, second>;
      readonly nextIndex: number;
    } => {
      const firstAndNextIndex: {
        readonly result: first;
        readonly nextIndex: number;
      } = firstCodec.decode(index, binary);
      const secondAndNextIndex: {
        readonly result: second;
        readonly nextIndex: number;
      } = secondCodec.decode(firstAndNextIndex.nextIndex, binary);
      return {
        result: {
          first: firstAndNextIndex.result,
          second: secondAndNextIndex.result,
...
export const AccountTokenHash: {
   ...
   * 文字列から変換する
   */
  readonly fromString: (a: string) => AccountTokenHash;
} = {
  ...
  fromString: (str: string): AccountTokenHash => str as AccountTokenHash,
};
...
export const ProjectDataFileHashValue: {
   ...
   * 文字列から変換する
   */
  readonly fromString: (a: string) => ProjectDataFileHashValue;
} = {
  typePartId: "b8bf6c22e275c06c7dc42300c332b47d" as TypePartId,
  codec: {
    encode: (value: ProjectDataFileHashValue): ReadonlyArray<number> =>
      encodeToken(value),
    decode: (
      index: number,
      binary: Uint8Array
    ): {
      readonly result: ProjectDataFileHashValue;
      readonly nextIndex: number;
    } =>
      decodeToken(index, binary) as {
        readonly result: ProjectDataFileHashValue;
  ...
  fromString: (str: string): ProjectDataFileHashValue =>
    str as ProjectDataFileHashValue,
};
...
export const Location: {
  ...
  Part: (partId: PartId): Location => ({ _: "Part", partId }),
  LocalProject: { _: "LocalProject" },
    ...
    decode: (
      ...
      if (patternIndex.result === 7) {
        const result: { readonly result: PartId; readonly nextIndex: number } =
          PartId.codec.decode(patternIndex.nextIndex, binary);
        return {
          result: Location.Part(result.result),
          nextIndex: result.nextIndex,
        };
      }
      if (patternIndex.result === 8) {
        return {
          result: Location.LocalProject,
          nextIndex: patternIndex.nextIndex,
        };
      }
      throw new Error("存在しないパターンを指定された 型を更新してください");
...
export const TypeAlias: {
  ...
  codec: {
    encode: (value: TypeAlias): ReadonlyArray<number> =>
      TsIdentifier.codec
        .encode(value.name)
        .concat(List.codec(TsIdentifier.codec).encode(value.typeParameterList))
        .concat(String.codec.encode(value.document))
        .concat(TsType.codec.encode(value.type)),
    decode: (
      index: number,
      ...
      const typeParameterListAndNextIndex: {
        readonly result: List<TsIdentifier>;
        readonly nextIndex: number;
      } = List.codec(TsIdentifier.codec).decode(
        nameAndNextIndex.nextIndex,
        binary
      );
      const documentAndNextIndex: {
...
export const AccountId: {
   ...
   * 文字列から変換する
   */
  readonly fromString: (a: string) => AccountId;
} = {
  ...
  fromString: (str: string): AccountId => str as AccountId,
};
  ...
  codec: {
    encode: (value: LogInState): ReadonlyArray<number> => {
      switch (value._) {
        ...
        case "LoggedIn": {
          return [5].concat(
            AccountTokenAccountId.codec.encode(value.accountTokenAccountId)
          );
        }
      }
    },
    decode: (
      ...
      if (patternIndex.result === 3) {
        return {
          result: LogInState.JumpingToLogInPage,
          nextIndex: patternIndex.nextIndex,
        };
      }
      if (patternIndex.result === 4) {
      ...
      if (patternIndex.result === 5) {
        const result: {
          readonly result: AccountTokenAccountId;
          readonly nextIndex: number;
        } = AccountTokenAccountId.codec.decode(patternIndex.nextIndex, binary);
        return {
  ...
  codec: {
    encode: (value: Part): ReadonlyArray<number> =>
      String.codec
        ...
        .concat(ProjectId.codec.encode(value.projectId))
        .concat(PartId.codec.encode(value.id)),
    decode: (
      index: number,
      binary: Uint8Array
      ...
      const idAndNextIndex: {
        readonly result: PartId;
        readonly nextIndex: number;
      } = PartId.codec.decode(projectIdAndNextIndex.nextIndex, binary);
      return {
        result: {
          name: nameAndNextIndex.result,
          description: descriptionAndNextIndex.result,
  ...
  codec: {
    encode: (value: SetTypePartParameter): ReadonlyArray<number> =>
      AccountToken.codec
        ...
        .concat(Maybe.codec(TypeAttribute.codec).encode(value.attribute))
        .concat(
          List.codec(DataTypeParameter.codec).encode(value.typeParameterList)
        )
        .concat(TypePartBody.codec.encode(value.body)),
    decode: (
      index: number,
...
export const AccountToken: {
   ...
   * 文字列から変換する
   */
  readonly fromString: (a: string) => AccountToken;
} = {
  ...
  fromString: (str: string): AccountToken => str as AccountToken,
};
...
export const ImageHash: {
   ...
   * 文字列から変換する
   */
  readonly fromString: (a: string) => ImageHash;
} = {
  ...
  fromString: (str: string): ImageHash => str as ImageHash,
};
...
export const Type: {
  ...
  codec: {
    encode: (value: Type): ReadonlyArray<number> =>
      Maybe.codec(DataTypeOrDataTypeParameter.codec)
        .encode(value.input)
        .concat(DataTypeOrDataTypeParameter.codec.encode(value.output)),
    decode: (
      index: number,
      binary: Uint8Array
    ): { readonly result: Type; readonly nextIndex: number } => {
      const inputAndNextIndex: {
        readonly result: Maybe<DataTypeOrDataTypeParameter>;
        readonly nextIndex: number;
      } = Maybe.codec(DataTypeOrDataTypeParameter.codec).decode(index, binary);
      const outputAndNextIndex: {
        readonly result: DataTypeOrDataTypeParameter;
        readonly nextIndex: number;
      } = DataTypeOrDataTypeParameter.codec.decode(
        inputAndNextIndex.nextIndex,
        binary
      );
      return {
        result: {
...
export const DataTypeParameter: {
  ...
  helper: (dataTypeParameter: DataTypeParameter): DataTypeParameter =>
    dataTypeParameter,
  codec: {
    encode: (value: DataTypeParameter): ReadonlyArray<number> =>
      String.codec
        .encode(value.name)
        .concat(String.codec.encode(value.description)),
    decode: (
      index: number,
      binary: Uint8Array
    ): { readonly result: DataTypeParameter; readonly nextIndex: number } => {
      const nameAndNextIndex: {
        readonly result: String;
        readonly nextIndex: number;
      } = String.codec.decode(index, binary);
...
export const DataType: {
   ...
   * 型を合わせる上で便利なヘルパー関数
   */
  readonly helper: (a: DataType) => DataType;
} = {
  typePartId: "a9c4fac6168c374e3a4e1579d588bf99" as TypePartId,
  helper: (dataType: DataType): DataType => dataType,
  codec: {
    encode: (value: DataType): ReadonlyArray<number> =>
      TypePartId.codec
        .encode(value.typePartId)
        .concat(
          List.codec(DataTypeOrDataTypeParameter.codec).encode(value.arguments)
        ),
    decode: (
      index: number,
      binary: Uint8Array
    ): { readonly result: DataType; readonly nextIndex: number } => {
      const typePartIdAndNextIndex: {
        readonly result: TypePartId;
        readonly nextIndex: number;
      } = TypePartId.codec.decode(index, binary);
      const argumentsAndNextIndex: {
        readonly result: List<DataTypeOrDataTypeParameter>;
        readonly nextIndex: number;
      } = List.codec(DataTypeOrDataTypeParameter.codec).decode(
      ...
      return {
        result: {
          typePartId: typePartIdAndNextIndex.result,
          arguments: argumentsAndNextIndex.result,
        },
        nextIndex: argumentsAndNextIndex.nextIndex,
      };
    },
  },
};
...
export const DataTypeOrDataTypeParameter: {
   ...
   */
  readonly DataTypeParameter: (a: Int32) => DataTypeOrDataTypeParameter;
} = {
  DataType: (dataType: DataType): DataTypeOrDataTypeParameter => ({
    _: "DataType",
    dataType,
  }),
  DataTypeParameter: (int32: Int32): DataTypeOrDataTypeParameter => ({
    _: "DataTypeParameter",
    int32,
  }),
  typePartId: "b4c160bb8b69e290abf7b60faca0856b" as TypePartId,
  codec: {
    encode: (value: DataTypeOrDataTypeParameter): ReadonlyArray<number> => {
      switch (value._) {
        case "DataType": {
    ...
    decode: (
      ...
      if (patternIndex.result === 0) {
        const result: {
          readonly result: DataType;
          readonly nextIndex: number;
        } = DataType.codec.decode(patternIndex.nextIndex, binary);
        return {
          result: DataTypeOrDataTypeParameter.DataType(result.result),
          nextIndex: result.nextIndex,
        };
      }
      if (patternIndex.result === 1) {
        const result: { readonly result: Int32; readonly nextIndex: number } =
          Int32.codec.decode(patternIndex.nextIndex, binary);
        return {
          result: DataTypeOrDataTypeParameter.DataTypeParameter(result.result),
          nextIndex: result.nextIndex,
        };
      }
      throw new Error("存在しないパターンを指定された 型を更新してください");
