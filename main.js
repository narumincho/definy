...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ce: 'hidden', b4: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ce: 'mozHidden', b4: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ce: 'msHidden', b4: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ce: 'webkitHidden', b4: 'webkitvisibilitychange' }
		: { ce: 'hidden', b4: 'visibilitychange' };
}
	...
	switch (emit.$) {
		...
		case 3:
			return _Utils_Tuple2(
				...
				_List_fromArray(
					[
						author$project$Model$focusTextArea(0)
					]));
		case 4:
			var idString = emit.a;
			return _Utils_Tuple2(
				...
				_List_fromArray(
					[
						author$project$Model$setClickEventListenerInCapturePhase(idString)
					]));
		case 5:
			var msg = emit.a;
			return _Utils_Tuple2(
				_List_fromArray(
					[
						author$project$Model$ProjectMsg(msg)
					]),
				_List_Nil);
		default:
			var id = emit.a;
			return _Utils_Tuple2(
				...
				_List_fromArray(
					[
						author$project$Model$elementScrollIntoView(id)
					]));
	}
};
var author$project$Compiler$FailureAll = {$: 2};
...
var author$project$Compiler$DefToSafeExpr$termToSafeTerm = function (term) {
	switch (term.$) {
		...
		case 1:
			...
			var index = _n1;
			return elm$core$Maybe$Just(
				author$project$Compiler$SafeExpr$Part(index));
		case 2:
			var expr = term.a;
...
var author$project$Compiler$DefToSafeExpr$convert = function (def) {
	return author$project$Compiler$DefToSafeExpr$exprToSafeExpr(
		author$project$Project$Source$Module$PartDef$getExpr(def));
};
...
var author$project$Compiler$OptToBinary$I32Add = {$: 2};
var author$project$Compiler$OptToBinary$I32Const = function (a) {
	return {$: 0, a: a};
};
var author$project$Compiler$OptToBinary$I32Mul = {$: 4};
var author$project$Compiler$OptToBinary$I32Sub = {$: 3};
...
var author$project$Compiler$SafeExprToNoOp$convertLoop = function (_n0) {
	...
	while (true) {
		...
		var right = _n0.V;
		if (!right.b) {
			return {Q: centerOp, T: left, V: leftCandidate};
		} else {
			var _n2 = right.a;
			var op = _n2.a;
			var term = _n2.b;
...
var author$project$Compiler$SafeExprToNoOp$convert = function (_n1) {
	...
	if (!others.b) {
		...
		return A3(
			...
			author$project$Compiler$SafeExprToNoOp$convert(a.T),
			author$project$Compiler$SafeExprToNoOp$convert(a.V));
	}
};
...
var author$project$Project$Source$ModuleWithCache$MsgReceiveCompileResult = F2(
	function (a, b) {
		return {$: 6, a: a, b: b};
	});
...
var author$project$Project$Source$Module$getPartDefAndData = F2(
	function (_n0, _n1) {
		var defIndex = _n0;
...
var author$project$Project$Source$ModuleWithCache$getPartDef = function (index) {
	return A2(
		...
		author$project$Project$Source$ModuleWithCache$getPartDefAndResult(index),
...
var author$project$Model$compileCmd = F3(
	function (source, moduleRef, partDefIndex) {
		var targetPartDefMaybe = A2(
			author$project$Project$Source$ModuleWithCache$getPartDef,
			partDefIndex,
...
var author$project$Model$run = _Platform_outgoingPort(
	'run',
	function ($) {
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'index',
					elm$json$Json$Encode$int($.aJ)),
					_Utils_Tuple2(
					'ref',
					elm$json$Json$Encode$list(elm$json$Json$Encode$int)($.aU)),
					_Utils_Tuple2(
					'wasm',
					elm$json$Json$Encode$list(elm$json$Json$Encode$int)($.bZ))
				]));
	});
...
var author$project$Model$runCmd = F3(
	function (moduleRef, partDefIndex, wasm) {
...
var author$project$Model$sourceEmitToMsgAndCmd = F2(
	function (source, emit) {
		...
		switch (moduleEmit.$) {
			case 0:
				...
				return _Utils_Tuple2(
					_List_Nil,
					A3(author$project$Model$compileCmd, source, moduleIndex, partDefIndex));
			case 1:
				var partDefIndex = moduleEmit.a;
				var binary = moduleEmit.b;
				return _Utils_Tuple2(
					_List_Nil,
					A3(author$project$Model$runCmd, moduleIndex, partDefIndex, binary));
			case 2:
...
var author$project$Model$projectEmitToMsgAndCmd = F2(
	function (project, emit) {
		var sourceEmit = emit;
		return A2(
			author$project$Model$sourceEmitToMsgAndCmd,
...
var author$project$Model$projectUpdateReturnToProjectAndMsgListAndCmd = function (_n0) {
	...
	return _Utils_Tuple2(
		...
		A2(
			...
			author$project$Utility$ListExtra$listTupleListToTupleList(
				A2(
					elm$core$List$map,
					A2(
						elm$core$Basics$composeR,
						author$project$Model$projectEmitToMsgAndCmd(project),
		...
		case 4:
			...
			return author$project$Panel$EditorTypeRef$EditorProject(
				author$project$Project$Module(
					author$project$Panel$Editor$Module$getTargetModuleIndex(editorModel)));
		default:
...
var author$project$Panel$Editor$Module$MsgActiveLeft = {$: 2};
var author$project$Panel$Editor$Module$MsgActiveRight = {$: 3};
var author$project$Panel$Editor$Module$MsgActiveToFirstChild = {$: 6};
var author$project$Panel$Editor$Module$MsgActiveToLastChild = {$: 7};
var author$project$Panel$Editor$Module$MsgConfirmMultiLineTextField = {$: 15};
var author$project$Panel$Editor$Module$MsgConfirmSingleLineTextFieldOrSelectParent = {$: 17};
var author$project$Panel$Editor$Module$MsgDecreaseValue = {$: 21};
var author$project$Panel$Editor$Module$MsgIncreaseValue = {$: 20};
var author$project$Panel$Editor$Module$MsgSuggestionNextOrSelectDown = {$: 11};
var author$project$Panel$Editor$Module$MsgSuggestionPrevOrSelectUp = {$: 12};
		...
		if (_n1.a) {
			if ((!_n1.b) && (!_n1.c)) {
				switch (key) {
					case 79:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$MsgActiveToLastChild]);
					case 80:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$MsgActiveToFirstChild]);
					case 53:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$MsgConfirmMultiLineTextField]);
					default:
						return _List_Nil;
				}
			} else {
			...
			if (!_n1.b) {
				if (!_n1.c) {
					switch (key) {
						case 79:
							return _List_fromArray(
								[author$project$Panel$Editor$Module$MsgActiveLeft]);
						case 80:
							return _List_fromArray(
								[author$project$Panel$Editor$Module$MsgActiveRight]);
						case 81:
							return _List_fromArray(
								[author$project$Panel$Editor$Module$MsgSuggestionPrevOrSelectUp]);
						case 78:
							return _List_fromArray(
								[author$project$Panel$Editor$Module$MsgSuggestionNextOrSelectDown]);
						case 55:
							return _List_fromArray(
								[author$project$Panel$Editor$Module$MsgActiveToFirstChild]);
						case 53:
							return _List_fromArray(
								[author$project$Panel$Editor$Module$MsgConfirmSingleLineTextFieldOrSelectParent]);
						default:
							return _List_Nil;
					}
				} else {
					switch (key) {
						case 81:
							return _List_fromArray(
								[author$project$Panel$Editor$Module$MsgIncreaseValue]);
						case 78:
							return _List_fromArray(
								[author$project$Panel$Editor$Module$MsgDecreaseValue]);
						default:
							return _List_Nil;
					}
				}
...
var author$project$Model$editorGroupPanelKeyDown = function (key) {
	return A2(
		elm$core$List$map,
		A2(elm$core$Basics$composeR, author$project$Panel$EditorGroup$ModuleEditorMsg, author$project$Panel$EditorGroup$EditorItemMsgToActive),
		author$project$Model$moduleEditorKeyMsg(key));
};
...
var author$project$Model$keyDownEachPanel = F2(
	function (key, model) {
		var _n0 = author$project$Model$getFocus(model);
		if (!_n0) {
			return A2(
				...
				author$project$Model$treePanelKeyDown(key));
		} else {
			return A2(
				elm$core$List$map,
				author$project$Model$EditorPanelMsg,
				author$project$Model$editorGroupPanelKeyDown(key));
		}
	});
...
var author$project$Model$keyDown = F2(
	function (keyMaybe, model) {
		if (!keyMaybe.$) {
			var key = keyMaybe.a;
			var _n1 = A2(
				author$project$Model$editorReservedKey,
				...
				case 0:
					...
					return A2(
						...
						A2(
							...
							author$project$Model$getWindowSize(model).B,
							x),
						model);
				case 1:
					var gutter = _n1.a.a;
...
var author$project$Panel$Editor$EditorKeyConfig$initModel = {a0: 0, aW: elm$core$Maybe$Nothing};
...
var author$project$Model$preventDefaultBeforeKeyEvent = _Platform_outgoingPort(
...
var author$project$Model$CloseSidePanel = {$: 7};
...
var author$project$Panel$EditorGroup$Blur = {$: 11};
var author$project$Panel$EditorGroup$FireClickEventInCapturePhase = function (a) {
	return {$: 5, a: a};
};
var author$project$Panel$EditorGroup$Focus = {$: 10};
...
var author$project$Panel$Editor$Module$MsgBlurThisEditor = {$: 24};
var author$project$Panel$Editor$Module$EmitMsgToSource = function (a) {
	return {$: 0, a: a};
};
var author$project$Panel$Editor$Module$MsgActiveDown = {$: 5};
var author$project$Panel$Editor$Module$MsgActiveUp = {$: 4};
...
var author$project$Panel$Editor$Module$ActiveTypeDefListSelf = {$: 0};
...
var author$project$Panel$Editor$Module$TermOpSelf = {$: 0};
var author$project$Panel$Editor$Module$TermOpTerm = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var author$project$Panel$Editor$Module$termOpPosDown = F2(
	function (expr, termOpPos) {
		switch (termOpPos.$) {
			...
			case 2:
				...
				return elm$core$Maybe$Just(
					A2(author$project$Panel$Editor$Module$TermOpTerm, _int, termType));
			default:
				return elm$core$Maybe$Just(author$project$Panel$Editor$Module$TermOpSelf);
		}
	});
var author$project$Panel$Editor$Module$partDefActiveDown = F2(
	function (partDef, partDefActive) {
		switch (partDefActive.$) {
			...
			default:
				...
				var _n1 = A2(
					author$project$Panel$Editor$Module$termOpPosDown,
					author$project$Project$Source$Module$PartDef$getExpr(partDef),
					termOpPos);
				if (!_n1.$) {
...
var author$project$Project$Source$Module$PartDef$Expr$ExprTermOp = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var author$project$Project$Source$Module$PartDef$Expr$None = {$: 3};
...
var author$project$Project$Source$Module$PartDef$Name$NoName = {$: 0};
var author$project$Project$Source$Module$PartDef$Name$noName = author$project$Project$Source$Module$PartDef$Name$NoName;
var author$project$Project$Source$Module$PartDef$Type$Empty = {$: 1};
var author$project$Project$Source$Module$PartDef$Type$empty = author$project$Project$Source$Module$PartDef$Type$Empty;
var author$project$Project$Source$Module$PartDef$empty = {aG: author$project$Project$Source$Module$PartDef$Expr$empty, aS: author$project$Project$Source$Module$PartDef$Name$noName, ai: author$project$Project$Source$Module$PartDef$Type$empty};
...
var author$project$Panel$Editor$Module$partDefListActiveDown = F2(
	function (targetModule, partDefListActive) {
		if (!partDefListActive.$) {
			...
			var _n2 = A2(
				author$project$Panel$Editor$Module$partDefActiveDown,
				A2(
					elm$core$Maybe$withDefault,
					author$project$Project$Source$Module$PartDef$empty,
					A2(author$project$Project$Source$ModuleWithCache$getPartDef, index, targetModule)),
				partDefActive);
			if (!_n2.$) {
				var movedPartDefActive = _n2.a;
				return elm$core$Maybe$Just(
					author$project$Panel$Editor$Module$ActivePartDef(
						_Utils_Tuple2(index, movedPartDefActive)));
			} else {
				return (_Utils_cmp(
					index + 1,
					author$project$Project$Source$ModuleWithCache$getPartDefNum(targetModule)) < 0) ? elm$core$Maybe$Just(
					author$project$Panel$Editor$Module$ActivePartDef(
						_Utils_Tuple2(index + 1, author$project$Panel$Editor$Module$ActivePartDefSelf))) : elm$core$Maybe$Nothing;
			}
		}
	});
...
var author$project$Panel$Editor$Module$ActiveTypeDefSelf = {$: 0};
...
var author$project$Panel$Editor$Module$LabelEditSelect = {$: 0};
...
var author$project$Panel$Editor$Module$typeDefActiveDown = function (typeDefActive) {
	switch (typeDefActive.$) {
		...
		case 1:
			return elm$core$Maybe$Just(
				author$project$Panel$Editor$Module$ActiveTypeDefTagList(
					_Utils_Tuple2(
						0,
						author$project$Panel$Editor$Module$ActiveTypeDefTagName(author$project$Panel$Editor$Module$LabelEditSelect))));
		default:
			...
			if (!_n2.$) {
				...
				return elm$core$Maybe$Just(
					author$project$Panel$Editor$Module$ActiveTypeDefTagList(
						_Utils_Tuple2(index, movedTypeDefTagActive)));
			} else {
				return elm$core$Maybe$Just(
					author$project$Panel$Editor$Module$ActiveTypeDefTagList(
						_Utils_Tuple2(
...
var author$project$Panel$Editor$Module$typeDefListActiveDown = function (typeDefListActive) {
	if (!typeDefListActive.$) {
		...
		if (!_n2.$) {
			...
			return elm$core$Maybe$Just(
				author$project$Panel$Editor$Module$ActiveTypeDef(
					_Utils_Tuple2(index, movedTypeDefActive)));
		} else {
			return elm$core$Maybe$Just(
				author$project$Panel$Editor$Module$ActiveTypeDef(
					_Utils_Tuple2(index + 1, author$project$Panel$Editor$Module$ActiveTypeDefSelf)));
		}
	}
};
var author$project$Panel$Editor$Module$activeDown = F2(
	function (targetModule, active) {
		switch (active.$) {
			case 0:
...
var author$project$Panel$Editor$Module$NameEditSelect = {$: 0};
var author$project$Panel$Editor$Module$TypeEditSelect = 0;
var author$project$Panel$Editor$Module$Branch = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var author$project$Panel$Editor$Module$BranchHead = {$: 1};
var author$project$Panel$Editor$Module$BranchSelf = {$: 0};
var author$project$Panel$Editor$Module$Expr = function (a) {
	return {$: 3, a: a};
};
var author$project$Panel$Editor$Module$ExprEditSelect = {$: 0};
var author$project$Panel$Editor$Module$Guard = {$: 2};
var author$project$Panel$Editor$Module$LambdaSelf = {$: 0};
var author$project$Panel$Editor$Module$Pattern = {$: 1};
		...
		default:
			if (!lambdaPos.a) {
				...
				if (!_n5.$) {
					...
					return elm$core$Maybe$Just(
						A2(author$project$Panel$Editor$Module$Branch, 0, movedBranchPos));
				} else {
				...
				if (!_n6.$) {
					...
					return elm$core$Maybe$Just(
						A2(author$project$Panel$Editor$Module$Branch, branchIndex, movedBranchPos));
				} else {
					return elm$core$Maybe$Just(author$project$Panel$Editor$Module$BranchHead);
				}
			}
		...
		default:
			...
			return elm$core$Maybe$Just(
				A2(
					...
					opIndex,
					author$project$Panel$Editor$Module$TypeNoChildren(author$project$Panel$Editor$Module$ExprEditSelect)));
	}
};
	...
	if (!partDefListActive.$) {
		...
		switch (partDefListActive.a.b.$) {
			...
			case 1:
				...
				var index = _n3.a;
				return author$project$Panel$Editor$Module$ActivePartDef(
			...
			case 2:
				...
				return author$project$Panel$Editor$Module$ActivePartDef(
					_Utils_Tuple2(
						index,
						author$project$Panel$Editor$Module$ActivePartDefName(author$project$Panel$Editor$Module$NameEditSelect)));
			default:
...
var author$project$Panel$Editor$Module$typeDefListActiveLeft = function (typeDefListActive) {
	if (!typeDefListActive.$) {
		...
		if (!_n2.$) {
			var movedTypeDefActive = _n2.a;
			return author$project$Panel$Editor$Module$ActiveTypeDef(
				_Utils_Tuple2(index, movedTypeDefActive));
		} else {
			return author$project$Panel$Editor$Module$ActiveTypeDefListSelf;
		}
...
var author$project$Panel$Editor$Module$activeLeft = F2(
	function (targetModule, active) {
		switch (active.$) {
			case 0:
				return author$project$Panel$Editor$Module$ActivePartDefList(author$project$Panel$Editor$Module$ActivePartDefListSelf);
			case 1:
				var readMeActive = active.a;
				return author$project$Panel$Editor$Module$ActiveReadMe(
					author$project$Panel$Editor$Module$readMeActiveLeft(readMeActive));
			case 2:
				var typeDefListActive = active.a;
				return author$project$Panel$Editor$Module$ActiveTypeDefList(
					author$project$Panel$Editor$Module$typeDefListActiveLeft(typeDefListActive));
			default:
				var activePartDefList = active.a;
				return author$project$Panel$Editor$Module$ActivePartDefList(
					author$project$Panel$Editor$Module$partDefListActiveLeft(activePartDefList));
		}
	});
...
var author$project$Panel$Editor$Module$lambdaPosRight = function (lambdaPos) {
	switch (lambdaPos.$) {
		...
		case 1:
			return elm$core$Maybe$Just(
				A2(author$project$Panel$Editor$Module$Branch, 0, author$project$Panel$Editor$Module$BranchSelf));
		default:
			var branchIndex = lambdaPos.a;
			var branchPos = lambdaPos.b;
			...
			if (!_n1.$) {
				...
				return elm$core$Maybe$Just(
					A2(author$project$Panel$Editor$Module$Branch, branchIndex + 1, author$project$Panel$Editor$Module$BranchSelf));
			}
	}
};
...
var author$project$Project$Source$Module$PartDef$Expr$getTermFromIndex = F2(
	function (index, expr) {
		return (!index) ? elm$core$Maybe$Just(
			author$project$Project$Source$Module$PartDef$Expr$getHead(expr)) : A2(
			elm$core$Maybe$map,
			elm$core$Tuple$second,
			A2(
				author$project$Utility$ListExtra$getAt,
				index - 1,
				author$project$Project$Source$Module$PartDef$Expr$getOthers(expr)));
	});
				...
				case 2:
					...
					if (_Utils_cmp(termCount, termIndex) < 0) {
						...
						var _n3 = A2(
							...
							A2(author$project$Project$Source$Module$PartDef$Expr$getTermFromIndex, termIndex, expr),
							termType);
						if (!_n3.$) {
							var movedTermType = _n3.a;
							return elm$core$Maybe$Just(
...
var author$project$Project$Source$Module$getPartDef = F2(
	function (_n0, _n1) {
		var defIndex = _n0;
		var partDefAndDataList = _n1.p;
		return A2(
			...
			A2(elm$core$Array$get, defIndex, partDefAndDataList));
	});
var author$project$Panel$Editor$Module$partDefListActiveRight = F2(
	function (targetModule, partDefListActive) {
		if (!partDefListActive.$) {
			return author$project$Panel$Editor$Module$ActivePartDef(
			...
			switch (partDefListActive.a.b.$) {
				...
				case 1:
					...
					return author$project$Panel$Editor$Module$ActivePartDef(
						_Utils_Tuple2(
							index,
							author$project$Panel$Editor$Module$ActivePartDefType(0)));
				case 2:
					var _n4 = partDefListActive.a;
					var index = _n4.a;
					return author$project$Panel$Editor$Module$ActivePartDef(
				...
				default:
					if (!partDefListActive.a.b.a.$) {
						...
						var exprMaybe = A2(
							elm$core$Maybe$map,
							author$project$Project$Source$Module$PartDef$getExpr,
							A2(author$project$Project$Source$Module$getPartDef, index, targetModule));
...
var author$project$Panel$Editor$Module$ActiveTypeDefTagParameter = {$: 1};
	...
	switch (typeDefActive.$) {
		...
		default:
			...
			return author$project$Panel$Editor$Module$ActiveTypeDefTagList(
				_Utils_Tuple2(
					index,
					author$project$Panel$Editor$Module$typeDefTagListActiveRight(typeDefTagActive)));
	}
};
var author$project$Panel$Editor$Module$typeDefListActiveRight = function (typeDefListActive) {
	if (!typeDefListActive.$) {
		return author$project$Panel$Editor$Module$ActiveTypeDef(
			_Utils_Tuple2(0, author$project$Panel$Editor$Module$ActiveTypeDefSelf));
	} else {
		var _n1 = typeDefListActive.a;
		var index = _n1.a;
		var typeDefActive = _n1.b;
		return author$project$Panel$Editor$Module$ActiveTypeDef(
			_Utils_Tuple2(
				index,
				author$project$Panel$Editor$Module$typeDefActiveRight(typeDefActive)));
	}
};
var author$project$Panel$Editor$Module$activeRight = F2(
	function (targetModule, active) {
		switch (active.$) {
			case 0:
				return author$project$Panel$Editor$Module$ActiveReadMe(0);
			case 1:
				var readMeActive = active.a;
				return author$project$Panel$Editor$Module$ActiveReadMe(
					author$project$Panel$Editor$Module$readMeActiveRight(readMeActive));
			case 2:
				var typeDefListActive = active.a;
				return author$project$Panel$Editor$Module$ActiveTypeDefList(
					author$project$Panel$Editor$Module$typeDefListActiveRight(typeDefListActive));
			default:
				var partDefListActive = active.a;
				return author$project$Panel$Editor$Module$ActivePartDefList(
					A2(author$project$Panel$Editor$Module$partDefListActiveRight, targetModule, partDefListActive));
		}
	});
var author$project$Panel$Editor$Module$termOpPosToFirstChild = F2(
	function (expr, termOpPos) {
		switch (termOpPos.$) {
			case 0:
				return A2(
			...
			case 2:
				...
				return A2(
					...
					termIndex,
					A2(
						author$project$Panel$Editor$Module$termTypeFirstChild,
						A2(author$project$Project$Source$Module$PartDef$Expr$getTermFromIndex, termIndex, expr),
						termType));
			default:
				var opIndex = termOpPos.a;
...
var author$project$Panel$Editor$Module$termTypeFirstChild = F2(
	function (termMaybe, termType) {
		var _n0 = _Utils_Tuple2(termMaybe, termType);
		if ((!_n0.a.$) && (_n0.a.a.$ === 2)) {
			if (_n0.b.$ === 1) {
				...
				return author$project$Panel$Editor$Module$TypeParentheses(
					A2(author$project$Panel$Editor$Module$termOpPosToFirstChild, expr, termOpPos));
			} else {
				var expr = _n0.a.a.a;
				return author$project$Panel$Editor$Module$TypeParentheses(
					A2(author$project$Panel$Editor$Module$termOpPosToFirstChild, expr, author$project$Panel$Editor$Module$TermOpSelf));
			}
		} else {
			return termType;
		}
	});
var author$project$Panel$Editor$Module$partDefActiveToFirstChild = F2(
	function (partDef, partDefActive) {
		switch (partDefActive.$) {
			case 0:
			...
			default:
				var termOpPos = partDefActive.a;
				return author$project$Panel$Editor$Module$ActivePartDefExpr(
					A2(
						author$project$Panel$Editor$Module$termOpPosToFirstChild,
						author$project$Project$Source$Module$PartDef$getExpr(partDef),
						termOpPos));
		}
	});
var author$project$Panel$Editor$Module$partDefListActiveToFirstChild = F2(
	function (targetModule, partDefListActive) {
		if (!partDefListActive.$) {
			return author$project$Panel$Editor$Module$ActivePartDef(
				_Utils_Tuple2(0, author$project$Panel$Editor$Module$ActivePartDefSelf));
			...
			return author$project$Panel$Editor$Module$ActivePartDef(
				_Utils_Tuple2(
					partDefIndex,
					A2(
						author$project$Panel$Editor$Module$partDefActiveToFirstChild,
						A2(
							elm$core$Maybe$withDefault,
							author$project$Project$Source$Module$PartDef$empty,
							A2(author$project$Project$Source$ModuleWithCache$getPartDef, partDefIndex, targetModule)),
						partDefActive)));
		}
	});
	...
	switch (typeDefActive.$) {
		...
		default:
			...
			return author$project$Panel$Editor$Module$ActiveTypeDefTagList(
				_Utils_Tuple2(
					index,
					author$project$Panel$Editor$Module$typeDefTagListActiveToFirstChild(typeDefTagActive)));
	}
};
var author$project$Panel$Editor$Module$typeDefListActiveToFirstChild = function (typeDefListActive) {
	if (!typeDefListActive.$) {
		...
		return author$project$Panel$Editor$Module$ActiveTypeDef(
			_Utils_Tuple2(
				typeDefIndex,
				author$project$Panel$Editor$Module$typeDefActiveToFirstChild(typeDefActive)));
	}
};
var author$project$Panel$Editor$Module$activeToFirstChild = F2(
	function (targetModule, active) {
		switch (active.$) {
			case 0:
				return author$project$Panel$Editor$Module$ActiveReadMe(0);
			case 1:
				var readMeActive = active.a;
				return author$project$Panel$Editor$Module$ActiveReadMe(
					author$project$Panel$Editor$Module$readMeActiveToFirstChild(readMeActive));
			case 2:
				var typeDefListActive = active.a;
				return author$project$Panel$Editor$Module$ActiveTypeDefList(
					author$project$Panel$Editor$Module$typeDefListActiveToFirstChild(typeDefListActive));
			default:
				var partDefListActive = active.a;
				return author$project$Panel$Editor$Module$ActivePartDefList(
					A2(author$project$Panel$Editor$Module$partDefListActiveToFirstChild, targetModule, partDefListActive));
		}
	});
var author$project$Panel$Editor$Module$termOpPosToLastChild = F2(
	function (exprMaybe, termOpPos) {
		var lastTermIndex = elm$core$List$length(
			author$project$Project$Source$Module$PartDef$Expr$getOthers(exprMaybe));
		switch (termOpPos.$) {
			case 0:
				return A2(
					author$project$Panel$Editor$Module$TermOpTerm,
			...
			if ((!_n0.a.$) && (_n0.a.a.$ === 2)) {
				switch (_n0.b.$) {
					case 1:
						...
						var termOpPos = _n0.b.a;
						return author$project$Panel$Editor$Module$TypeParentheses(
							A2(author$project$Panel$Editor$Module$termOpPosToLastChild, expr, termOpPos));
					case 0:
						var expr = _n0.a.a.a;
						return author$project$Panel$Editor$Module$TypeParentheses(
							A2(author$project$Panel$Editor$Module$termOpPosToLastChild, expr, author$project$Panel$Editor$Module$TermOpSelf));
					default:
						break _n0$2;
				}
			} else {
...
var author$project$Panel$Editor$Module$partDefActiveToLastChild = F2(
	function (partDef, partDefActive) {
		switch (partDefActive.$) {
			case 0:
			...
			default:
				...
				return author$project$Panel$Editor$Module$ActivePartDefExpr(
					A2(
						author$project$Panel$Editor$Module$termOpPosToLastChild,
						author$project$Project$Source$Module$PartDef$getExpr(partDef),
						termOpPos));
		}
	});
var author$project$Panel$Editor$Module$partDefListActiveToLastChild = F2(
	function (targetModule, partDefListActive) {
		if (!partDefListActive.$) {
			return author$project$Panel$Editor$Module$ActivePartDef(
				_Utils_Tuple2(
					author$project$Project$Source$ModuleWithCache$getPartDefNum(targetModule) - 1,
			...
			return author$project$Panel$Editor$Module$ActivePartDef(
				_Utils_Tuple2(
					partDefIndex,
					A2(
						author$project$Panel$Editor$Module$partDefActiveToLastChild,
						A2(
							elm$core$Maybe$withDefault,
							author$project$Project$Source$Module$PartDef$empty,
							A2(author$project$Project$Source$ModuleWithCache$getPartDef, partDefIndex, targetModule)),
...
var author$project$Panel$Editor$Module$typeDefActiveToLastChild = F2(
	function (typeDefMaybe, typeDefActive) {
		switch (typeDefActive.$) {
			case 0:
				return author$project$Panel$Editor$Module$ActiveTypeDefTagList(
					_Utils_Tuple2(
						A2(
							elm$core$Maybe$withDefault,
							1,
							A2(elm$core$Maybe$map, author$project$Project$Source$Module$TypeDef$getTagNum, typeDefMaybe)),
						author$project$Panel$Editor$Module$ActiveTypeDefTagName(author$project$Panel$Editor$Module$LabelEditSelect)));
			case 1:
				var labelEdit = typeDefActive.a;
				return author$project$Panel$Editor$Module$ActiveTypeDefName(labelEdit);
			default:
				...
				var typeDefTagActive = _n1.b;
				return author$project$Panel$Editor$Module$ActiveTypeDefTagList(
					_Utils_Tuple2(typeDefTagIndex, typeDefTagActive));
		}
	});
var author$project$Project$Source$Module$getTypeDef = F2(
	function (_n0, _n1) {
		var index = _n0;
...
var author$project$Panel$Editor$Module$typeDefListActiveToLastChild = F2(
	function (targetModule, typeDefListActive) {
		if (!typeDefListActive.$) {
			return author$project$Panel$Editor$Module$ActiveTypeDef(
				_Utils_Tuple2(
					author$project$Project$Source$ModuleWithCache$getTypeDefNum(targetModule) - 1,
					author$project$Panel$Editor$Module$ActiveTypeDefSelf));
		} else {
			var _n1 = typeDefListActive.a;
			var typeDefIndex = _n1.a;
			var typeDefActive = _n1.b;
			return author$project$Panel$Editor$Module$ActiveTypeDef(
				_Utils_Tuple2(
					typeDefIndex,
					A2(
						author$project$Panel$Editor$Module$typeDefActiveToLastChild,
						A2(author$project$Project$Source$ModuleWithCache$getTypeDef, typeDefIndex, targetModule),
						typeDefActive)));
		}
	});
var author$project$Panel$Editor$Module$activeToLastChild = F2(
	function (targetModule, active) {
		switch (active.$) {
			case 0:
				return author$project$Panel$Editor$Module$ActivePartDefList(author$project$Panel$Editor$Module$ActivePartDefListSelf);
			case 1:
				var readMeActive = active.a;
				return author$project$Panel$Editor$Module$ActiveReadMe(
					author$project$Panel$Editor$Module$readMeActiveToLastChild(readMeActive));
			case 2:
				var typeDefListActive = active.a;
				return author$project$Panel$Editor$Module$ActiveTypeDefList(
					A2(author$project$Panel$Editor$Module$typeDefListActiveToLastChild, targetModule, typeDefListActive));
			default:
				var partDefListActive = active.a;
				return author$project$Panel$Editor$Module$ActivePartDefList(
					A2(author$project$Panel$Editor$Module$partDefListActiveToLastChild, targetModule, partDefListActive));
		}
	});
...
var author$project$Panel$Editor$Module$lambdaPosToParent = function (lambdaPos) {
	switch (lambdaPos.$) {
		...
		default:
			...
			return A2(
				elm$core$Maybe$map,
				author$project$Panel$Editor$Module$Branch(index),
				author$project$Panel$Editor$Module$branchPosToParent(branchPos));
	}
};
	...
	switch (termType.$) {
		...
		case 1:
			...
			return A2(
				elm$core$Maybe$map,
				author$project$Panel$Editor$Module$TypeParentheses,
				author$project$Panel$Editor$Module$termOpPosToParent(termOpPos));
		default:
			var lambdaPos = termType.a;
			return A2(
				elm$core$Maybe$map,
				author$project$Panel$Editor$Module$TypeLambda,
				author$project$Panel$Editor$Module$lambdaPosToParent(lambdaPos));
	}
};
	...
	switch (partDefActive.$) {
		...
		default:
			...
			if (!_n1.$) {
				var moved = _n1.a;
				return elm$core$Maybe$Just(
					author$project$Panel$Editor$Module$ActivePartDefExpr(moved));
			} else {
				return elm$core$Maybe$Just(author$project$Panel$Editor$Module$ActivePartDefSelf);
			}
	}
...
var author$project$Panel$Editor$Module$partDefListActiveToParent = function (typeDefListActive) {
	if (!typeDefListActive.$) {
		...
		if (!_n2.$) {
			...
			return elm$core$Maybe$Just(
				author$project$Panel$Editor$Module$ActivePartDef(
					_Utils_Tuple2(partDefIndex, moved)));
		} else {
	...
	switch (typeDefActive.$) {
		...
		default:
			...
			if (!_n2.$) {
				...
				return elm$core$Maybe$Just(
					author$project$Panel$Editor$Module$ActiveTypeDefTagList(
						_Utils_Tuple2(typeDefTagIndex, movedTagActive)));
			} else {
				return elm$core$Maybe$Just(author$project$Panel$Editor$Module$ActiveTypeDefSelf);
			}
	}
...
var author$project$Panel$Editor$Module$typeDefListActiveToParent = function (typeDefListActive) {
	if (!typeDefListActive.$) {
		...
		if (!_n2.$) {
			...
			return elm$core$Maybe$Just(
				author$project$Panel$Editor$Module$ActiveTypeDef(
					_Utils_Tuple2(typeDefIndex, movedTypeDefActive)));
		} else {
			return elm$core$Maybe$Just(author$project$Panel$Editor$Module$ActiveTypeDefListSelf);
		}
	}
};
var author$project$Panel$Editor$Module$activeToParent = F2(
	function (targetModule, active) {
		switch (active.$) {
			case 0:
	...
	switch (typeDefActive.$) {
		...
		default:
			...
			if (!_n2.$) {
				...
				return elm$core$Maybe$Just(
					author$project$Panel$Editor$Module$ActiveTypeDefTagList(
						_Utils_Tuple2(index, movedTagList)));
			} else {
				return (index <= 0) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(
					author$project$Panel$Editor$Module$ActiveTypeDefTagList(
						_Utils_Tuple2(
							index - 1,
							author$project$Panel$Editor$Module$ActiveTypeDefTagName(author$project$Panel$Editor$Module$LabelEditSelect))));
...
var author$project$Panel$Editor$Module$typeDefListActiveUp = function (typeDefListActive) {
	if (!typeDefListActive.$) {
		...
		if (!_n2.$) {
			...
			return (typeDefIndex <= 0) ? elm$core$Maybe$Just(author$project$Panel$Editor$Module$ActiveTypeDefListSelf) : elm$core$Maybe$Just(
				author$project$Panel$Editor$Module$ActiveTypeDef(
					_Utils_Tuple2(typeDefIndex - 1, author$project$Panel$Editor$Module$ActiveTypeDefSelf)));
		}
	}
};
var author$project$Panel$Editor$Module$activeUp = F2(
...
var author$project$Utility$ArrayExtra$setLength = F3(
	function (length, fillElement, array) {
		setLength:
		while (true) {
			if (_Utils_cmp(
				length,
				elm$core$Array$length(array)) < 0) {
...
var author$project$Panel$Editor$Module$changeResultVisible = F4(
	function (partDefNum, _n0, resultVisivle, _n1) {
		var index = _n0;
		var rec = _n1;
		return _Utils_Tuple2(
			_Utils_update(
				rec,
				{
					aV: A3(
						...
						index,
						resultVisivle,
						A3(author$project$Utility$ArrayExtra$setLength, partDefNum, 0, rec.aV))
				}),
			_List_Nil);
	});
	...
	switch (termOpPos.$) {
		...
		default:
			...
			return A2(
				author$project$Panel$Editor$Module$TermOpTerm,
				termIndex,
				author$project$Panel$Editor$Module$confirmTermType(termType));
	}
};
var author$project$Panel$Editor$Module$confirmTermType = function (termType) {
	switch (termType.$) {
		...
		case 1:
			var termOpPos = termType.a;
			return author$project$Panel$Editor$Module$TypeParentheses(
				author$project$Panel$Editor$Module$confirmTermOpPos(termOpPos));
		default:
			var lambdaPos = termType.a;
...
var author$project$Panel$Editor$Module$confirmSingleLineTextFieldOrSelectParent = F2(
	function (targetModule, active) {
...
var author$project$Project$Source$Module$PartDef$Expr$mapTermAt = F3(
	function (index, f, _n0) {
		var head = _n0.a;
		var others = _n0.b;
		return (!index) ? A2(
			author$project$Project$Source$Module$PartDef$Expr$ExprTermOp,
			f(head),
			others) : A2(
			author$project$Project$Source$Module$PartDef$Expr$ExprTermOp,
			head,
			A2(
				...
				F2(
					function (i, _n1) {
						...
						return _Utils_Tuple2(
							op,
							_Utils_eq(i, index - 1) ? f(term) : term);
					}),
				others));
	});
var author$project$Panel$Editor$Module$termOpPosDecreaseValue = F2(
	function (termOpPos, expr) {
		switch (termOpPos.$) {
			case 0:
				return expr;
			case 1:
			...
			case 2:
				...
				var termType = termOpPos.b;
				return A3(
					author$project$Project$Source$Module$PartDef$Expr$mapTermAt,
					index,
					author$project$Panel$Editor$Module$termTypeDecreaseValue(termType),
					expr);
			default:
				var _int = termOpPos.a;
				return expr;
...
var author$project$Panel$Editor$Module$termTypeDecreaseValue = F2(
		...
		switch (term.$) {
			...
			case 2:
				...
				switch (termType.$) {
					...
					case 1:
						var termOpPos = termType.a;
						return author$project$Project$Source$Module$PartDef$Expr$Parentheses(
							A2(author$project$Panel$Editor$Module$termOpPosDecreaseValue, termOpPos, expr));
					default:
						return term;
				}
			default:
...
var author$project$Project$Source$ModuleWithCache$MsgSetExpr = F2(
	function (a, b) {
		return {$: 5, a: a, b: b};
	});
var author$project$Panel$Editor$Module$decreaseValue = F2(
	function (targetModule, model) {
				...
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$EmitMsgToSource(
						{
							...
							bC: A2(
								author$project$Project$Source$ModuleWithCache$MsgSetExpr,
								partDefIndex,
								A2(
									author$project$Panel$Editor$Module$termOpPosDecreaseValue,
									termOpPos,
									A2(
										elm$core$Maybe$withDefault,
										author$project$Project$Source$Module$PartDef$Expr$empty,
										A2(
											elm$core$Maybe$map,
											author$project$Project$Source$Module$PartDef$getExpr,
											A2(author$project$Project$Source$ModuleWithCache$getPartDef, partDefIndex, targetModule)))))
...
var author$project$Panel$Editor$Module$termOpPosIncreaseValue = F2(
	function (termOpPos, expr) {
		switch (termOpPos.$) {
			case 0:
				return expr;
			...
			case 2:
				...
				return A3(
					author$project$Project$Source$Module$PartDef$Expr$mapTermAt,
					index,
					author$project$Panel$Editor$Module$termTypeIncreaseValue(termType),
					expr);
			default:
				var _int = termOpPos.a;
				return expr;
...
var author$project$Panel$Editor$Module$termTypeIncreaseValue = F2(
	function (termType, term) {
		switch (term.$) {
			case 0:
				var _int = term.a;
			...
			case 2:
				...
				switch (termType.$) {
					...
					case 1:
						var termOpPos = termType.a;
						return author$project$Project$Source$Module$PartDef$Expr$Parentheses(
							A2(author$project$Panel$Editor$Module$termOpPosIncreaseValue, termOpPos, expr));
					default:
						return term;
				}
			default:
...
var author$project$Panel$Editor$Module$increaseValue = F2(
	function (targetModule, model) {
		var _n0 = author$project$Panel$Editor$Module$getActive(model);
		if (((_n0.$ === 3) && (_n0.a.$ === 1)) && (_n0.a.a.b.$ === 3)) {
			var _n1 = _n0.a.a;
					...
					[
						author$project$Panel$Editor$Module$EmitMsgToSource(
						{
							...
							bC: A2(
								...
								partDefIndex,
								A2(
									author$project$Panel$Editor$Module$termOpPosIncreaseValue,
									termOpPos,
									A2(
										elm$core$Maybe$withDefault,
										author$project$Project$Source$Module$PartDef$Expr$empty,
...
var author$project$Panel$Editor$Module$NameEditText = {$: 1};
var author$project$Panel$Editor$Module$emitSetExpr = F3(
	function (moduleIndex, partDefIndex, expr) {
...
var author$project$Project$Source$ModuleWithCache$MsgSetName = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var author$project$Panel$Editor$Module$emitSetName = F3(
	function (moduleIndex, partDefIndex, name) {
		return author$project$Panel$Editor$Module$EmitMsgToSource(
			{
				a2: moduleIndex,
...
var author$project$Project$Source$ModuleWithCache$MsgSetType = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
var author$project$Panel$Editor$Module$emitSetType = F3(
	function (moduleIndex, partDefIndex, type_) {
		return author$project$Panel$Editor$Module$EmitMsgToSource(
			{
				a2: moduleIndex,
						...
						return author$project$Parser$Expr$Rest(
							{
								...
								f: _List_fromArray(
									[
										...
										A3(author$project$Parser$Expr$TermWithParenthesis, leftParenthesis, author$project$Project$Source$Module$PartDef$Expr$None, 0))
									])
							});
					case 1:
						var _n2 = rest.a;
								...
								f: _List_fromArray(
									[
										...
										A3(
											...
											leftParenthesis,
											author$project$Project$Source$Module$PartDef$Expr$Int32Literal(
							...
							author$project$Parser$Expr$Rest(
								{
									...
									f: _List_fromArray(
										[
											author$project$Parser$Expr$Op(13)
										])
								}));
					} else {
						var _n21 = list.a;
							...
							author$project$Parser$Expr$Rest(
								{
									...
									f: _List_fromArray(
										[
											author$project$Parser$Expr$Op(0)
										])
								}));
					}
				case 26:
						...
						author$project$Parser$Expr$Rest(
							{
								...
								f: _List_fromArray(
									[
										author$project$Parser$Expr$Op(1)
									])
							}));
				case 4:
					var _n25 = list.a;
						...
						author$project$Parser$Expr$Rest(
							{
								...
								f: _List_fromArray(
									[
										author$project$Parser$Expr$Op(2)
									])
							}));
				case 16:
					var _n27 = list.a;
						...
						author$project$Parser$Expr$Rest(
							{
								...
								f: _List_fromArray(
									[
										author$project$Parser$Expr$Op(3)
									])
							}));
				case 15:
					if (list.b.b) {
								...
								author$project$Parser$Expr$Rest(
									{
										...
										f: _List_fromArray(
											[
												author$project$Parser$Expr$Op(6)
											])
									}));
						} else {
							var _n31 = list.a;
								...
								author$project$Parser$Expr$Rest(
									{
										...
										f: _List_fromArray(
											[
												author$project$Parser$Expr$Op(5)
											])
									}));
						}
					} else {
								...
								author$project$Parser$Expr$Rest(
									{
										...
										f: _List_fromArray(
											[
												author$project$Parser$Expr$Op(7)
											])
									}));
						} else {
							var _n35 = list.a;
								...
								author$project$Parser$Expr$Rest(
									{
										...
										f: _List_fromArray(
											[
												author$project$Parser$Expr$Op(8)
											])
									}));
						}
					} else {
						...
						author$project$Parser$Expr$Rest(
							{
								...
								f: _List_fromArray(
									[
										author$project$Parser$Expr$Op(9)
									])
							}));
				case 8:
					var _n39 = list.a;
						...
						author$project$Parser$Expr$Rest(
							{
								...
								f: _List_fromArray(
									[
										author$project$Parser$Expr$Op(10)
									])
							}));
				case 13:
					if (list.b.b) {
								...
								author$project$Parser$Expr$Rest(
									{
										...
										f: _List_fromArray(
											[
												author$project$Parser$Expr$Op(4)
											])
									}));
						} else {
							var _n43 = list.a;
								...
								author$project$Parser$Expr$Rest(
									{
										...
										f: _List_fromArray(
											[
												author$project$Parser$Expr$Op(11)
											])
									}));
						}
					} else {
						...
						author$project$Parser$Expr$Rest(
							{
								...
								f: _List_fromArray(
									[
										author$project$Parser$Expr$Op(12)
									])
							}));
				default:
					break _n0$17;
			...
			if ((((((list.b && (!list.a.$)) && list.b.b) && (list.b.a.$ === 1)) && (list.b.a.a === 11)) && list.b.b.b) && (list.b.b.a.$ === 4)) {
				...
				if (!_n7.$) {
					...
					if (list.b) {
						...
						return author$project$Parser$Expr$End(
							{
								f: (!leftParenthesis) ? _List_Nil : _List_fromArray(
									[
										author$project$Parser$Expr$Term(
										A3(author$project$Parser$Expr$TermWithParenthesis, leftParenthesis, author$project$Project$Source$Module$PartDef$Expr$None, 0))
									]),
...
var author$project$Parser$Expr$concatParseTermResult = function (_n0) {
	...
	if (!lastMaybe.$) {
		...
		return author$project$Parser$Expr$TermLastOp(
			{w: head, ab: last, x: others, u: textAreaValue});
	} else {
		return author$project$Parser$Expr$TermLastTerm(
			{w: head, x: others, u: textAreaValue});
	}
};
...
var author$project$Parser$Expr$termOrOpListToParseTermResultNeedOp = function (termOrOpList) {
	if (termOrOpList.b) {
		...
		return {g: elm$core$Maybe$Nothing, x: _List_Nil};
	}
};
					...
					x: _Utils_ap(
						_List_fromArray(
							[
								_Utils_Tuple2(
								operator,
								A3(author$project$Parser$Expr$TermWithParenthesis, 0, author$project$Project$Source$Module$PartDef$Expr$None, 0))
							]),
						others)
				};
			}
	...
	if (list.b) {
		if (!list.a.$) {
			...
			return author$project$Parser$Expr$concatParseTermResult(
				{w: term, g: lastMaybe, x: others, u: textAreaValue});
		} else {
			var op = list.a.a;
			var listOthers = list.b;
...
var author$project$Parser$Name$maybeLabelToName = function (mLabel) {
	if (!mLabel.$) {
		var label = mLabel.a;
		return author$project$Project$Source$Module$PartDef$Name$SafeName(
			author$project$Project$Source$Module$PartDef$Name$safeNameFromLabel(label));
	} else {
		...
		while (true) {
			if (rest.b) {
					...
					case 1:
						if (rest.a.a === 16) {
							...
							if (!label.$) {
								...
								return author$project$Parser$Type$TypeToExpr(
									{bQ: others, ai: author$project$Project$Source$Module$PartDef$Type$empty});
							}
						} else {
							var _n5 = rest.a;
							var _char = _n5.b;
				...
				if (!label.$) {
					...
					return author$project$Parser$Type$TypeEnd(
						{u: textAreaValue, ai: author$project$Project$Source$Module$PartDef$Type$empty});
				}
			}
		}
	});
var author$project$Parser$Type$parse = function (list) {
	...
	while (true) {
		if (list.b) {
			...
			return author$project$Parser$Type$TypeEnd(
				{u: _List_Nil, ai: author$project$Project$Source$Module$PartDef$Type$empty});
		}
	}
};
		...
		case 1:
			...
			if (!_n1.$) {
				...
				return author$project$Parser$BeginWithNameEndType(
					{aS: name, u: textAreaValue, ai: type_});
			} else {
				var type_ = _n1.a.ai;
				var rest = _n1.a.bQ;
...
var author$project$Parser$SimpleChar$LeftCurlyBracket = 25;
...
var author$project$Parser$SimpleChar$RightCurlyBracket = 27;
...
var author$project$Parser$SimpleChar$VerticalLine = 26;
...
var author$project$Parser$SimpleChar$fromChar = function (_char) {
	...
	return f(author$project$Parser$SimpleChar$meaningLessCharString) ? elm$core$Maybe$Nothing : (f(author$project$Parser$SimpleChar$spaceCharString) ? elm$core$Maybe$Just(author$project$Parser$SimpleChar$ASpace) : (f('!！') ? elm$core$Maybe$Just(
		...
		A2(author$project$Parser$SimpleChar$ASymbol, 27, _char)) : (f('aａ') ? elm$core$Maybe$Just(
...
var author$project$Project$Source$Module$PartDef$Expr$mapOthers = F2(
	function (f, _n0) {
		var head = _n0.a;
		var others = _n0.b;
		return A2(
...
var author$project$Project$Source$Module$PartDef$Expr$removeSetBlankOpNoneTermLoop = F2(
	function (rest, expr) {
...
var author$project$Project$Source$Module$PartDef$Expr$removeBlankOpNoneTerm = function (_n0) {
	...
	var others = _n0.b;
	return A2(
		author$project$Project$Source$Module$PartDef$Expr$removeSetBlankOpNoneTermLoop,
		others,
		A2(author$project$Project$Source$Module$PartDef$Expr$ExprTermOp, head, _List_Nil));
};
var author$project$Project$Source$Module$PartDef$Expr$make = F2(
	function (head, others) {
		return author$project$Project$Source$Module$PartDef$Expr$removeBlankOpNoneTerm(
			A2(author$project$Project$Source$Module$PartDef$Expr$ExprTermOp, head, others));
	});
...
var author$project$Panel$Editor$Module$parserBeginWithName = F3(
	function (string, partDefIndex, moduleRef) {
				...
				return _Utils_Tuple2(
					author$project$Panel$Editor$Module$ActivePartDefList(
						author$project$Panel$Editor$Module$ActivePartDef(
							_Utils_Tuple2(
								partDefIndex,
								author$project$Panel$Editor$Module$ActivePartDefName(author$project$Panel$Editor$Module$NameEditText)))),
					_List_fromArray(
						[
							A3(author$project$Panel$Editor$Module$emitSetName, moduleRef, partDefIndex, name)
						]));
			case 1:
				var name = _n0.a.aS;
				var type_ = _n0.a.ai;
				var textAreaValue = _n0.a.u;
				return author$project$Project$Source$Module$PartDef$Type$isEmpty(type_) ? _Utils_Tuple2(
					author$project$Panel$Editor$Module$ActivePartDefList(
						author$project$Panel$Editor$Module$ActivePartDef(
							_Utils_Tuple2(
								partDefIndex,
					...
					_List_fromArray(
						[
							A3(author$project$Panel$Editor$Module$emitSetName, moduleRef, partDefIndex, name),
							A3(author$project$Panel$Editor$Module$emitSetType, moduleRef, partDefIndex, type_),
			...
			case 2:
				...
				return _Utils_Tuple2(
					author$project$Panel$Editor$Module$ActivePartDefList(
						author$project$Panel$Editor$Module$ActivePartDef(
							_Utils_Tuple2(
								partDefIndex,
								author$project$Panel$Editor$Module$ActivePartDefExpr(
									(_Utils_eq(headTerm, author$project$Project$Source$Module$PartDef$Expr$None) && _Utils_eq(opAndTermList, _List_Nil)) ? author$project$Panel$Editor$Module$TermOpSelf : A2(
										author$project$Panel$Editor$Module$TermOpTerm,
					...
					_Utils_ap(
						...
						_Utils_ap(
							author$project$Project$Source$Module$PartDef$Type$isEmpty(type_) ? _List_Nil : _List_fromArray(
								[
									A3(author$project$Panel$Editor$Module$emitSetType, moduleRef, partDefIndex, type_)
								]),
							_List_fromArray(
								[
									A3(
									author$project$Panel$Editor$Module$emitSetExpr,
									moduleRef,
									partDefIndex,
									A2(author$project$Project$Source$Module$PartDef$Expr$make, headTerm, opAndTermList))
								]))));
			default:
				var name = _n0.a.aS;
				var type_ = _n0.a.ai;
				...
				return _Utils_Tuple2(
					...
					_List_fromArray(
						[
							...
							partDefIndex,
							A2(
								author$project$Project$Source$Module$PartDef$Expr$make,
								headTerm,
								_Utils_ap(
									opAndTermList,
									_List_fromArray(
										[
											_Utils_Tuple2(lastOp, author$project$Project$Source$Module$PartDef$Expr$None)
										])))),
							author$project$Panel$Editor$Module$textAreaValueToSetTextEmit(textAreaValue)
						]));
		}
	...
	if (list.b) {
		if (!list.a.$) {
			...
			return author$project$Parser$Expr$concatParseOpResult(
				{w: 15, g: lastMaybe, x: others, u: textAreaValue});
		} else {
			var op = list.a.a;
			var listOthers = list.b;
			...
			var lastMaybe = _n3.g;
			return author$project$Parser$Expr$concatParseOpResult(
				{w: op, g: lastMaybe, x: others, u: textAreaValue});
		}
	} else {
		return author$project$Parser$Expr$OpLastOp(
			{w: 15, x: _List_Nil, u: textAreaValue});
	}
};
...
var author$project$Project$Source$Module$PartDef$Expr$getTermAt = F2(
	function (index, _n0) {
		var others = _n0.b;
		return A2(
			elm$core$Maybe$map,
...
var author$project$Project$Source$Module$PartDef$Expr$offsetTermOpList = F2(
...
var author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertOpLastOp = F4(
	function (index, headOp, termOpList, expr) {
		var targetTerm = A2(
			elm$core$Maybe$withDefault,
			author$project$Project$Source$Module$PartDef$Expr$None,
			A2(author$project$Project$Source$Module$PartDef$Expr$getTermAt, index, expr));
		var replaceAndInsertElement = function () {
			...
			if (_n0.$ === 1) {
				...
				return {
					aa: _Utils_ap(
						A2(author$project$Project$Source$Module$PartDef$Expr$offsetTermOpList, _List_Nil, termOpList),
						_List_fromArray(
							[
		...
		return A2(
			author$project$Project$Source$Module$PartDef$Expr$mapOthers,
			A2(
				elm$core$Basics$composeR,
				A2(author$project$Utility$ListExtra$setAt, index, replaceAndInsertElement.ae),
				A2(author$project$Utility$ListExtra$insertList, index + 1, replaceAndInsertElement.aa)),
			expr);
	});
var author$project$Panel$Editor$Module$parserBeginWithOp = F5(
	function (string, partDefIndex, moduleRef, opIndex, expr) {
		var _n0 = A2(
					...
					[
						author$project$Panel$Editor$Module$EmitMsgToSource(
						{
							...
							bC: A2(
								author$project$Project$Source$ModuleWithCache$MsgSetExpr,
								partDefIndex,
								A4(author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertOpLastOp, opIndex, headOp, termAndOpList, expr))
						}),
						author$project$Panel$Editor$Module$textAreaValueToSetTextEmit(textAreaValue)
					]));
		} else {
...
var author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertHeadLastOp = F4(
...
var author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertHeadLastTerm = F3(
...
var author$project$Project$Source$Module$PartDef$Expr$getOperatorAt = F2(
	function (index, _n0) {
		var others = _n0.b;
		return A2(
			elm$core$Maybe$map,
...
var author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertTermLastOp = F5(
	function (index, headTerm, opTermList, lastOp, expr) {
		var targetOp = A2(
			elm$core$Maybe$withDefault,
			15,
			A2(author$project$Project$Source$Module$PartDef$Expr$getOperatorAt, index, expr));
		return author$project$Project$Source$Module$PartDef$Expr$removeBlankOpNoneTerm(
			A2(
				author$project$Project$Source$Module$PartDef$Expr$mapOthers,
				A2(
...
var author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertTermLastTerm = F4(
...
var author$project$Panel$Editor$Module$parserBeginWithTerm = F5(
	function (string, partDefIndex, moduleRef, termIndex, expr) {
		var _n0 = A2(
						...
						[
							author$project$Panel$Editor$Module$EmitMsgToSource(
							{
								...
								bC: A2(
									author$project$Project$Source$ModuleWithCache$MsgSetExpr,
									partDefIndex,
									((!termIndex) ? A2(author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertHeadLastTerm, headTerm, opAndTermList) : A3(author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertTermLastTerm, termIndex - 1, headTerm, opAndTermList))(expr))
							})
						]),
					...
					[
						author$project$Panel$Editor$Module$EmitMsgToSource(
						{
							...
							bC: A2(
								author$project$Project$Source$ModuleWithCache$MsgSetExpr,
								partDefIndex,
								((!termIndex) ? A3(author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertHeadLastOp, headTerm, opAndTermList, lastOp) : A4(author$project$Project$Source$Module$PartDef$Expr$replaceAndInsertTermLastOp, termIndex, headTerm, opAndTermList, lastOp))(expr))
						}),
						author$project$Panel$Editor$Module$textAreaValueToSetTextEmit(textAreaValue)
					]));
		}
...
var author$project$Panel$Editor$Module$EmitFocusEditTextAea = {$: 2};
...
var author$project$Panel$Editor$Module$suggestionNameList = A2(
	elm$core$List$map,
	elm$core$Tuple$mapFirst(author$project$Project$Source$Module$PartDef$Name$safeNameFromLabel),
	_List_fromArray(
		[
			_Utils_Tuple2(
			A2(
...
var author$project$Panel$Editor$Module$setActivePartDefList = function (partDefListActive) {
	if (!partDefListActive.$) {
		return _List_fromArray(
			[
				author$project$Panel$Editor$Module$EmitElementScrollIntoView(author$project$Panel$Editor$Module$partDefinitionId)
			]);
	} else {
		switch (partDefListActive.a.b.$) {
			case 0:
				...
				return _List_fromArray(
					[
						author$project$Panel$Editor$Module$EmitElementScrollIntoView(
						author$project$Panel$Editor$Module$partDefId(partDefIndex))
					]);
			case 1:
				switch (partDefListActive.a.b.a.$) {
					case 0:
					...
					default:
						...
						var name = A2(
							...
							A2(
								elm$core$Maybe$map,
								A2(elm$core$Basics$composeR, elm$core$Tuple$first, author$project$Project$Source$Module$PartDef$Name$safeNameToString),
								A2(author$project$Utility$ListExtra$getAt, index, author$project$Panel$Editor$Module$suggestionNameList)));
						return _List_fromArray(
							[
								author$project$Panel$Editor$Module$EmitFocusEditTextAea,
								author$project$Panel$Editor$Module$EmitSetTextAreaValue(name),
								author$project$Panel$Editor$Module$EmitElementScrollIntoView(
								author$project$Panel$Editor$Module$partDefId(partDefIndex))
							]);
				}
			...
			default:
				...
				return _Utils_ap(
					...
					author$project$Panel$Editor$Module$setActiveTermOpPos(termOpPos));
		}
	}
};
var author$project$Panel$Editor$Module$typeDefId = 'moduleEditor-typeDef';
var author$project$Panel$Editor$Module$setActive = F3(
	function (project, active, _n0) {
		var rec = _n0;
		var targetModule = A2(
			author$project$Project$Source$getModule,
			author$project$Panel$Editor$Module$getTargetModuleIndex(rec),
			author$project$Project$getSource(project));
		return _Utils_Tuple2(
			_Utils_update(
				rec,
					...
					switch (active.$) {
						...
						case 1:
							if (!active.a) {
								...
								return _List_fromArray(
									[
										author$project$Panel$Editor$Module$EmitElementScrollIntoView(author$project$Panel$Editor$Module$readMeId)
									]);
							} else {
								var _n3 = active.a;
								return _List_fromArray(
						...
						case 2:
							return _List_fromArray(
								[
									author$project$Panel$Editor$Module$EmitElementScrollIntoView(author$project$Panel$Editor$Module$typeDefId)
								]);
						default:
							var partDefListActive = active.a;
...
var author$project$Panel$Editor$Module$inputInPartDefList = F5(
	function (string, project, targetModule, partDefListActive, model) {
		var _n0 = function () {
			if (!partDefListActive.$) {
				return _Utils_Tuple2(
					author$project$Panel$Editor$Module$getActive(model),
					_List_Nil);
			} else {
				switch (partDefListActive.a.b.$) {
					case 1:
						...
						var index = _n2.a;
						return A3(
							author$project$Panel$Editor$Module$parserBeginWithName,
							string,
							index,
							author$project$Panel$Editor$Module$getTargetModuleIndex(model));
					case 2:
						var _n3 = partDefListActive.a;
						var index = _n3.a;
						return A3(
							author$project$Panel$Editor$Module$parserBeginWithType,
							string,
							index,
							author$project$Panel$Editor$Module$getTargetModuleIndex(model));
					case 3:
						switch (partDefListActive.a.b.a.$) {
							case 0:
								...
								var _n5 = _n4.b.a;
								return A3(
									author$project$Panel$Editor$Module$parserInExpr,
									string,
									index,
									author$project$Panel$Editor$Module$getTargetModuleIndex(model));
							case 1:
		...
		return _Utils_Tuple2(
			newModel,
			_Utils_ap(emitList, activeEmitList));
	});
var author$project$Project$Source$ModuleWithCache$MsgSetReadMe = function (a) {
	return {$: 0, a: a};
};
var author$project$Panel$Editor$Module$inputInReadMe = F3(
	function (string, readMeActive, model) {
		if (readMeActive === 1) {
			return _Utils_Tuple2(
				model,
				_List_fromArray(
...
var author$project$Panel$Editor$Module$input = F4(
	function (string, project, targetModule, model) {
		var _n0 = author$project$Panel$Editor$Module$getActive(model);
		switch (_n0.$) {
			case 0:
				return _Utils_Tuple2(model, _List_Nil);
...
var author$project$Panel$Editor$Module$nameEditSuggestionToEditText = F4(
	function (partDefIndex, searchName, project, model) {
		var _n0 = A3(
			author$project$Panel$Editor$Module$setActive,
			project,
			author$project$Panel$Editor$Module$ActivePartDefList(
				author$project$Panel$Editor$Module$ActivePartDef(
					_Utils_Tuple2(
...
var author$project$Panel$Editor$Module$suggestionSelectChangedThenNameChangeEmit = F3(
	function (suggestIndex, partDefIndex, moduleRef) {
			...
			return _List_fromArray(
				[
					author$project$Panel$Editor$Module$EmitMsgToSource(
					{
						a2: moduleRef,
						bC: A2(
							author$project$Project$Source$ModuleWithCache$MsgSetName,
							partDefIndex,
							author$project$Project$Source$Module$PartDef$Name$SafeName(suggestName))
					})
				]);
		} else {
			return _List_Nil;
...
var author$project$Panel$Editor$Module$suggestionNext = F3(
	function (targetModule, project, model) {
		var _n0 = author$project$Panel$Editor$Module$getActive(model);
		_n0$2:
		while (true) {
			if (((_n0.$ === 3) && (_n0.a.$ === 1)) && (_n0.a.a.b.$ === 1)) {
				switch (_n0.a.a.b.a.$) {
					case 2:
						...
						if (_Utils_cmp(
							elm$core$List$length(author$project$Panel$Editor$Module$suggestionNameList) - 1,
							index + 1) < 0) {
									...
									author$project$Panel$Editor$Module$ActivePartDef(
										_Utils_Tuple2(
											...
											author$project$Panel$Editor$Module$ActivePartDefName(
												author$project$Panel$Editor$Module$NameEditSuggestionSelect(
													{
														aJ: A2(
															elm$core$Basics$min,
															elm$core$List$length(author$project$Panel$Editor$Module$suggestionNameList) - 1,
							...
							return _Utils_Tuple2(
								...
								_Utils_ap(
									A3(
										author$project$Panel$Editor$Module$suggestionSelectChangedThenNameChangeEmit,
										A2(
											elm$core$Basics$min,
											elm$core$List$length(author$project$Panel$Editor$Module$suggestionNameList) - 1,
											index + 1),
										partDefIndex,
										author$project$Panel$Editor$Module$getTargetModuleIndex(newModel)),
									emitList));
						}
					case 1:
						var _n3 = _n0.a.a;
						...
						var searchName = A2(
							elm$core$Maybe$withDefault,
							author$project$Project$Source$Module$PartDef$Name$NoName,
							A2(
								elm$core$Maybe$map,
								author$project$Project$Source$Module$PartDef$getName,
								A2(author$project$Project$Source$ModuleWithCache$getPartDef, partDefIndex, targetModule)));
						var _n5 = A3(
							author$project$Panel$Editor$Module$setActive,
							project,
...
var author$project$Panel$Editor$Module$suggestionPrev = F3(
	function (targetModule, project, model) {
		var _n0 = author$project$Panel$Editor$Module$getActive(model);
		_n0$2:
		while (true) {
...
var author$project$Project$Source$ModuleWithCache$MsgAddPartDef = {$: 1};
var author$project$Project$Source$ModuleWithCache$MsgAddTypeDef = {$: 2};
var author$project$Panel$Editor$Module$suggestionNextOrSelectDown = F3(
	function (targetModule, project, model) {
		return function () {
		...
		switch (msg.$) {
			...
			case 2:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$activeLeft, targetModule, active),
					model);
			case 3:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$activeRight, targetModule, active),
					model);
			case 4:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$activeUp, targetModule, active),
					model);
			case 5:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$activeDown, targetModule, active),
					model);
			case 6:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$activeToFirstChild, targetModule, active),
					model);
			case 7:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$activeToLastChild, targetModule, active),
					model);
			case 8:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$activeToParent, targetModule, active),
					model);
			case 9:
			...
			case 15:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					author$project$Panel$Editor$Module$confirmMultiLineTextField(active),
					model);
			case 16:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					author$project$Panel$Editor$Module$confirmSingleLineTextField(active),
					model);
			case 17:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$confirmSingleLineTextFieldOrSelectParent, targetModule, active),
					model);
			case 18:
				return _Utils_Tuple2(
					model,
			...
			case 22:
				...
				return A4(
					author$project$Panel$Editor$Module$changeResultVisible,
					author$project$Project$Source$ModuleWithCache$getPartDefNum(targetModule),
					partDefIndex,
					resultVisible,
					model);
			case 23:
...
var author$project$Panel$EditorGroup$EmitFocusEditTextAea = {$: 3};
...
var author$project$Panel$EditorGroup$editorIndexAllValue = _List_fromArray(
	[
		_Utils_Tuple2(0, 0),
		_Utils_Tuple2(0, 1),
		_Utils_Tuple2(1, 0),
...
var author$project$Utility$ListExtra$getFirstSatisfyElement = F2(
	function (f, list) {
		getFirstSatisfyElement:
		while (true) {
			if (list.b) {
				var x = list.a;
				var xs = list.b;
...
var author$project$Panel$EditorGroup$editorIndexFromIdString = function (idString) {
	return A2(
		author$project$Utility$ListExtra$getFirstSatisfyElement,
		function (x) {
			return _Utils_eq(
				author$project$Panel$EditorGroup$editorIndexToIdString(x),
				idString);
		},
...
var author$project$Panel$EditorGroup$fireClickEventInCapturePhase = F2(
...
var author$project$Panel$Editor$Module$MsgFocusThisEditor = {$: 23};
		...
		switch (msg.$) {
			...
			case 1:
				...
				return _Utils_Tuple2(
					...
					_List_fromArray(
						[
							author$project$Panel$EditorGroup$EmitSetClickEventListenerInCapturePhase(
							author$project$Panel$EditorGroup$editorIndexToIdString(newActiveEditorIndex))
						]));
			case 2:
			...
			case 5:
				var idString = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Panel$EditorGroup$fireClickEventInCapturePhase, idString, model),
					_List_Nil);
			case 9:
				var gutter = msg.a;
				return _Utils_Tuple2(
			...
			case 6:
				...
				return _Utils_Tuple2(
					A2(
						author$project$Panel$EditorGroup$mapGroup,
						A2(author$project$Panel$EditorGroup$setEditorItem, rec.aU, newEditorItem),
						model),
					emit);
			case 7:
...
var author$project$Panel$Tree$EmitCloseSidePanel = {$: 2};
...
var author$project$NSvg$polygon = F3(
	function (points, strokeStyle, fillStyle) {
		return author$project$NSvg$Polygon(
			{Y: elm$core$Maybe$Nothing, z: fillStyle, ap: points, t: strokeStyle});
	});
...
var author$project$NSvg$rect = F3(
	function (_n0, strokeStyle, fillStyle) {
		...
		return author$project$NSvg$Rect(
			{Y: elm$core$Maybe$Nothing, z: fillStyle, C: height, t: strokeStyle, B: width, b_: 0, b$: 0});
	});
		...
		switch (nSvgElement.$) {
			case 0:
				...
				return author$project$NSvg$Rect(
					_Utils_update(
						rec,
						{b_: rec.b_ + x, b$: rec.b$ + y}));
			case 1:
				var rec = nSvgElement.a;
				return author$project$NSvg$Circle(
					_Utils_update(
						rec,
						{aC: rec.aC + x, aD: rec.aD + y}));
			case 2:
				var rec = nSvgElement.a;
				return author$project$NSvg$Polygon(
					_Utils_update(
			...
			default:
				...
				return author$project$NSvg$Line(
					_Utils_update(
						rec,
						{aw: rec.aw + x, ax: rec.ax + x, ay: rec.ay + y, az: rec.az + y}));
		}
	});
...
var author$project$NSvg$circle = F3(
	function (r, strokeStyle, fillStyle) {
		return author$project$NSvg$Circle(
			{aC: 0, aD: 0, z: fillStyle, bN: r, t: strokeStyle});
	});
		...
		switch (msg.$) {
			...
			case 6:
				return _Utils_Tuple2(
					model,
					_List_fromArray(
						[author$project$Panel$Tree$EmitFocusToEditorGroup]));
			case 7:
			...
			default:
				return _Utils_Tuple2(
					model,
					_List_fromArray(
						[author$project$Panel$Tree$EmitCloseSidePanel]));
		}
	});
...
var author$project$Project$Source$Module$addEmptyPartDefAndData = F2(
	function (a, _n0) {
		var rec = _n0;
		return (_Utils_cmp(
			author$project$Project$Source$Module$partDefMaxNum,
			elm$core$Array$length(rec.p)) < 1) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(
			_Utils_Tuple2(
				_Utils_update(
					rec,
					{
						p: A2(
							...
							elm$core$Array$fromList(
								_List_fromArray(
									[
										_Utils_Tuple2(author$project$Project$Source$Module$PartDef$empty, a)
									])))
					}),
				elm$core$Array$length(rec.p)));
	});
var author$project$Project$Source$Module$getData = F2(
	function (_n0, _n1) {
		var defIndex = _n0;
		var partDefAndDataList = _n1.p;
		return A2(
...
var author$project$Project$Source$Module$existPartDefName = F2(
	function (passIndex, name) {
		if (name.$ === 1) {
			var safeName = name.a;
			return A2(
				elm$core$Basics$composeR,
				author$project$Project$Source$Module$getPartDefAndDataList,
				A2(
					elm$core$Basics$composeR,
					elm$core$List$indexedMap(
						F2(
					...
					elm$core$List$member(
						author$project$Project$Source$Module$PartDef$Name$SafeName(safeName))));
		} else {
			return elm$core$Basics$always(false);
		}
	});
var author$project$Project$Source$Module$setPartDefAndData = F3(
	function (_n0, _n1, _n2) {
		var defIndex = _n0;
		var partDef = _n1.a;
		var data = _n1.b;
		var rec = _n2;
		return A3(
			author$project$Project$Source$Module$existPartDefName,
			defIndex,
			author$project$Project$Source$Module$PartDef$getName(partDef),
			rec) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(
			_Utils_update(
				rec,
				{
					p: A3(
						elm$core$Array$set,
						defIndex,
						_Utils_Tuple2(partDef, data),
						rec.p)
				}));
	});
var author$project$Project$Source$Module$setData = F3(
	function (_n0, data, _n1) {
		var defIndex = _n0;
		var rec = _n1;
		...
		if (!_n2.$) {
			...
			return A2(
				...
				rec,
				A3(
					author$project$Project$Source$Module$setPartDefAndData,
					defIndex,
					_Utils_Tuple2(partDef, data),
					rec));
		} else {
...
var author$project$Project$Source$Module$PartDef$setExpr = F2(
	function (expr, _n0) {
		var rec = _n0;
		return _Utils_update(
			rec,
...
var author$project$Project$Source$Module$setPartDefExpr = F3(
	function (partDefIndex, expr, module_) {
		...
		if (!_n0.$) {
			...
			return A2(
				...
				A3(
					...
					partDefIndex,
					_Utils_Tuple2(
						A2(author$project$Project$Source$Module$PartDef$setExpr, expr, partDef),
						data),
					module_));
		} else {
			return module_;
...
var author$project$Project$Source$Module$PartDef$setName = F2(
	function (name, _n0) {
		var rec = _n0;
		return _Utils_update(
			rec,
...
var author$project$Project$Source$Module$setPartDefName = F3(
	function (partDefIndex, name, module_) {
		var _n0 = A2(author$project$Project$Source$Module$getPartDefAndData, partDefIndex, module_);
		if (!_n0.$) {
			var _n1 = _n0.a;
			var partDef = _n1.a;
			...
			return A3(
				...
				partDefIndex,
				_Utils_Tuple2(
					A2(author$project$Project$Source$Module$PartDef$setName, name, partDef),
					data),
				module_);
		} else {
...
var author$project$Project$Source$Module$PartDef$setType = F2(
	function (type_, _n0) {
		var rec = _n0;
		return _Utils_update(
			rec,
...
var author$project$Project$Source$Module$setPartDefType = F3(
	function (partDefIndex, type_, module_) {
		var _n0 = A2(author$project$Project$Source$Module$getPartDefAndData, partDefIndex, module_);
		if (!_n0.$) {
			var _n1 = _n0.a;
			var partDef = _n1.a;
			...
			return A2(
				...
				A3(
					...
					partDefIndex,
					_Utils_Tuple2(
						A2(author$project$Project$Source$Module$PartDef$setType, type_, partDef),
						data),
					module_));
		} else {
			return module_;
...
var author$project$Project$Source$Module$setReadMe = F2(
	function (string, _n0) {
		var rec = _n0;
		return _Utils_update(
			rec,
...
var author$project$Project$Source$ModuleWithCache$EmitRun = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
...
var author$project$Project$Source$ModuleWithCache$ErrorOverPartCountLimit = {$: 2};
var author$project$Project$Source$Module$TypeDef$getName = function (_n0) {
	var name = _n0.aS;
	return name;
};
var author$project$Project$Source$Module$existTypeDefName = F2(
	function (passIndexMaybe, name) {
		if (!passIndexMaybe.$) {
			var passIndex = passIndexMaybe.a;
			return A2(
				elm$core$Basics$composeR,
				author$project$Project$Source$Module$getTypeDefList,
				A2(
					elm$core$Basics$composeR,
					elm$core$List$indexedMap(
						F2(
							function (i, typeDef) {
								return _Utils_eq(i, passIndex) ? _List_Nil : _List_fromArray(
									[
										author$project$Project$Source$Module$TypeDef$getName(typeDef)
									]);
							})),
					A2(
						elm$core$Basics$composeR,
			...
			return A2(
				...
				A2(
					elm$core$Basics$composeR,
					elm$core$List$map(author$project$Project$Source$Module$TypeDef$getName),
					elm$core$List$member(name)));
		}
	});
...
var author$project$Project$Source$Module$addTypeDef = F2(
	function (nameLabel, _n0) {
		var rec = _n0;
		return (_Utils_cmp(
			author$project$Project$Source$Module$typeDefMaxNum,
			elm$core$Array$length(rec.bm)) < 1) ? elm$core$Maybe$Nothing : (A3(author$project$Project$Source$Module$existTypeDefName, elm$core$Maybe$Nothing, nameLabel, rec) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(
			_Utils_update(
				rec,
				{
					bm: A2(
						...
						elm$core$Array$fromList(
							_List_fromArray(
								[
									author$project$Project$Source$Module$TypeDef$make(nameLabel)
								])))
				})));
	});
var author$project$Project$Source$ModuleWithCache$addTypeDefLoop = F2(
	function (labelList, moduleWithResult) {
		addTypeDefLoop:
		while (true) {
			if (labelList.b) {
				var x = labelList.a;
...
var author$project$Project$Source$ModuleWithCache$typeDefDefaultName = _List_fromArray(
	[
		A2(author$project$Project$Label$make, author$project$Project$Label$ha, _List_Nil),
		A2(author$project$Project$Label$make, author$project$Project$Label$hb, _List_Nil),
		A2(author$project$Project$Label$make, author$project$Project$Label$hc, _List_Nil),
		A2(author$project$Project$Label$make, author$project$Project$Label$hd, _List_Nil)
	]);
...
var author$project$Project$Source$ModuleWithCache$emptyCompileAndRunResult = {aX: elm$core$Maybe$Nothing, bd: elm$core$Maybe$Nothing};
var author$project$Project$Source$ModuleWithCache$update = F2(
	function (msg, moduleWithResult) {
		switch (msg.$) {
			case 0:
				var readMe = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Project$Source$Module$setReadMe, readMe, moduleWithResult),
					_List_Nil);
			case 1:
				...
				if (!_n1.$) {
					...
					return _Utils_Tuple2(
						...
						_List_fromArray(
							[
								author$project$Project$Source$ModuleWithCache$EmitCompile(newIndex)
							]));
				} else {
					return _Utils_Tuple2(
						moduleWithResult,
						_List_fromArray(
							[author$project$Project$Source$ModuleWithCache$ErrorOverPartCountLimit]));
				}
			case 2:
				return _Utils_Tuple2(
					author$project$Project$Source$ModuleWithCache$addTypeDef(moduleWithResult),
					_List_Nil);
			case 3:
				var partDefIndex = msg.a;
				var name = msg.b;
				...
				if (!_n3.$) {
					...
					return _Utils_Tuple2(
						...
						_List_fromArray(
							[
								author$project$Project$Source$ModuleWithCache$ErrorDuplicatePartDefName(partDefIndex)
							]));
				}
			case 4:
				var partDefIndex = msg.a;
				var type_ = msg.b;
				return _Utils_Tuple2(
					A3(author$project$Project$Source$Module$setPartDefType, partDefIndex, type_, moduleWithResult),
					_List_fromArray(
						[
							author$project$Project$Source$ModuleWithCache$EmitCompile(partDefIndex)
						]));
			case 5:
				var partDefIndex = msg.a;
				var expr = msg.b;
				return _Utils_Tuple2(
					A3(author$project$Project$Source$Module$setPartDefExpr, partDefIndex, expr, moduleWithResult),
					_List_fromArray(
						[
							author$project$Project$Source$ModuleWithCache$EmitCompile(partDefIndex)
						]));
			case 6:
				...
				if (!_n4.$) {
					...
					return _Utils_Tuple2(
						A3(
							author$project$Project$Source$Module$setData,
							partDefIndex,
							_Utils_update(
								rec,
								{
						...
						function () {
							...
							if (!_n5.$) {
								...
								return _List_fromArray(
									[
										A2(author$project$Project$Source$ModuleWithCache$EmitRun, partDefIndex, binary)
									]);
							} else {
								return _List_Nil;
							}
...
var author$project$Project$Source$update = F2(
	function (msg, source) {
		var moduleIndex = msg.a2;
		var moduleMsg = msg.bC;
		var _n1 = A2(
			author$project$Project$Source$ModuleWithCache$update,
			moduleMsg,
			A2(author$project$Project$Source$getModule, moduleIndex, source));
		var newModule = _n1.a;
		var emitList = _n1.b;
		return _Utils_Tuple2(
			A3(author$project$Project$Source$setModule, moduleIndex, newModule, source),
			A2(
				elm$core$List$map,
				function (e) {
					return {cj: e, a2: moduleIndex};
				},
				emitList));
	});
var author$project$Project$update = F2(
	function (msg, project) {
		var sourceMsg = msg;
		var _n1 = A2(
			author$project$Project$Source$update,
			sourceMsg,
			author$project$Project$getSource(project));
		var newSource = _n1.a;
		var emitList = _n1.b;
		return _Utils_Tuple2(
			A2(author$project$Project$setSource, newSource, project),
			A2(elm$core$List$map, elm$core$Basics$identity, emitList));
	});
var author$project$Project$Source$ModuleWithCache$MsgReceiveRunResult = F2(
	function (a, b) {
		return {$: 7, a: a, b: b};
	});
...
var author$project$Model$editorPanelUpdate = F2(
	function (msg, model) {
		...
		var emitMsg = _n12.b;
		var _n13 = author$project$Utility$ListExtra$listTupleListToTupleList(
		...
		return A2(
			...
			A2(
				author$project$Model$updateFromList,
				nextMsg,
				A2(author$project$Model$setEditorGroupPanelModel, editorPanelModel, model)));
	});
var author$project$Model$projectUpdate = F2(
	function (msg, model) {
		var _n10 = author$project$Model$projectUpdateReturnToProjectAndMsgListAndCmd(
			A2(
				author$project$Project$update,
				msg,
				author$project$Model$getProject(model)));
...
var author$project$Model$receiveResultValue = F2(
	function (_n8, model) {
		var ref = _n8.aU;
		var index = _n8.aJ;
		var result = _n8.bR;
		...
		if (!_n9.$) {
			...
			return A2(
				author$project$Model$projectUpdate,
				{
					a2: moduleIndex,
...
var author$project$Model$setFocus = F2(
	function (focus, _n6) {
		...
		if (!focus) {
			return A2(
				author$project$Model$editorPanelUpdate,
...
var author$project$Model$treePanelUpdate = F2(
	function (msg, model) {
		...
		return A2(
			author$project$Model$updateFromList,
			A2(elm$core$List$map, author$project$Model$treePanelEmitToMsg, emitMsg),
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				if (!_n3.b) {
					...
					return _Utils_Tuple2(
						...
						author$project$Model$preventDefaultBeforeKeyEvent(0));
				}
			case 1:
			...
			case 4:
				...
				return A2(
					author$project$Model$editorPanelUpdate,
					author$project$Panel$EditorGroup$FireClickEventInCapturePhase(idString),
					model);
			case 5:
				var data = msg.a;
			...
			case 7:
				return _Utils_Tuple2(
					A2(author$project$Model$setTreePanelWidth, 0, model),
					elm$core$Platform$Cmd$none);
			case 8:
				var focus = msg.a;
...
var author$project$Model$updateFromList = F2(
		...
		aI: author$project$Panel$EditorGroup$RowOne(
			{
				T: author$project$Panel$EditorGroup$ColumnOne(
					{
						h: author$project$Panel$EditorGroup$ModuleEditor(
	...
	return A2(
		...
		A2(
			...
			elm$core$List$length(
				author$project$Project$Source$Module$getPartDefAndDataList(module_))));
};
var author$project$Project$Source$Module$deletePartDefAndDataWithDuplicateName = A2(
	elm$core$Basics$composeR,
	A2(
		elm$core$List$foldl,
		F2(
			function (_n0, _n1) {
				...
				return A2(elm$core$List$member, name, nameList) ? _Utils_Tuple2(nameList, noDupPratDefAndDataList) : _Utils_Tuple2(
					A2(elm$core$List$cons, name, nameList),
					_Utils_ap(
						noDupPratDefAndDataList,
						_List_fromArray(
							[
								_Utils_Tuple2(partDef, result)
							])));
			}),
		_Utils_Tuple2(_List_Nil, _List_Nil)),
	elm$core$Tuple$second);
var author$project$Project$Source$Module$deleteTypeDefWithDuplicateName = A2(
	elm$core$Basics$composeR,
	A2(
		elm$core$List$foldl,
		F2(
			function (typeDef, _n0) {
				var nameList = _n0.a;
				var noDupTypeDefList = _n0.b;
				var name = author$project$Project$Source$Module$TypeDef$getName(typeDef);
				return A2(elm$core$List$member, name, nameList) ? _Utils_Tuple2(nameList, noDupTypeDefList) : _Utils_Tuple2(
					A2(elm$core$List$cons, name, nameList),
					_Utils_ap(
						noDupTypeDefList,
						_List_fromArray(
	...
	return {
		...
		p: elm$core$Array$fromList(
			A2(
				elm$core$List$take,
				author$project$Project$Source$Module$partDefMaxNum,
				author$project$Project$Source$Module$deletePartDefAndDataWithDuplicateName(partDefAndDataList))),
		bb: readMe,
		bm: elm$core$Array$fromList(
			A2(
				elm$core$List$take,
				author$project$Project$Source$Module$typeDefMaxNum,
				author$project$Project$Source$Module$deleteTypeDefWithDuplicateName(typeDefList)))
	};
};
var author$project$Project$Source$ModuleWithCache$init = function (_n0) {
	...
	return _Utils_Tuple2(
		...
		A2(
			elm$core$List$map,
			author$project$Project$Source$ModuleWithCache$EmitCompile,
			author$project$Project$Source$Module$allPartDefIndex(module_)));
};
var author$project$Project$Source$initCore = A2(
	elm$core$Tuple$mapSecond,
	elm$core$List$map(
		function (moduleEmit) {
			return {cj: moduleEmit, a2: 0};
		}),
			...
			a8: _List_fromArray(
				[
					author$project$Project$Source$Module$PartDef$make(
					{
						...
						aS: author$project$Project$Source$Module$PartDef$Name$fromLabel(
							A2(
								author$project$Project$Label$make,
...
var author$project$Project$Source$initCoreInt32 = A2(
	elm$core$Tuple$mapSecond,
	elm$core$List$map(
		function (moduleEmit) {
			return {cj: moduleEmit, a2: 1};
		}),
	author$project$Project$Source$ModuleWithCache$init(
		{
			aS: A2(
			...
			a8: _List_fromArray(
				[
					author$project$Project$Source$Module$PartDef$make(
					{
						aG: A2(
							author$project$Project$Source$Module$PartDef$Expr$make,
							author$project$Project$Source$Module$PartDef$Expr$Int32Literal(1),
							_List_fromArray(
								[
									_Utils_Tuple2(
									8,
									author$project$Project$Source$Module$PartDef$Expr$Int32Literal(2))
								])),
						aS: author$project$Project$Source$Module$PartDef$Name$fromLabel(
							A2(
								author$project$Project$Label$make,
			...
			bm: _List_fromArray(
				[author$project$Project$Source$Module$TypeDef$typeDefInt])
		}));
...
var author$project$Project$Source$initSampleModule = A2(
	elm$core$Tuple$mapSecond,
	elm$core$List$map(
		function (moduleEmit) {
			return {cj: moduleEmit, a2: 2};
		}),
	author$project$Project$Source$ModuleWithCache$init(
		{
						...
						aG: A2(
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
									8,
									author$project$Project$Source$Module$PartDef$Expr$Parentheses(
										A2(
											author$project$Project$Source$Module$PartDef$Expr$make,
											author$project$Project$Source$Module$PartDef$Expr$Int32Literal(3),
											_List_fromArray(
												[
													_Utils_Tuple2(
													8,
													author$project$Project$Source$Module$PartDef$Expr$Int32Literal(4)),
													_Utils_Tuple2(
													8,
													author$project$Project$Source$Module$PartDef$Expr$Parentheses(
														A2(
															author$project$Project$Source$Module$PartDef$Expr$make,
															author$project$Project$Source$Module$PartDef$Expr$Int32Literal(5),
															_List_fromArray(
																[
																	_Utils_Tuple2(
																	8,
																	author$project$Project$Source$Module$PartDef$Expr$Parentheses(
																		A2(
																			...
																			author$project$Project$Source$Module$PartDef$Expr$Parentheses(
																				A2(
																					author$project$Project$Source$Module$PartDef$Expr$make,
																					author$project$Project$Source$Module$PartDef$Expr$Int32Literal(6),
																					_List_Nil)),
																			_List_fromArray(
																				[
																					_Utils_Tuple2(
																					8,
																					author$project$Project$Source$Module$PartDef$Expr$Int32Literal(7))
																				]))))
																])))),
													_Utils_Tuple2(
													8,
													author$project$Project$Source$Module$PartDef$Expr$Int32Literal(8))
												])))),
									_Utils_Tuple2(
									8,
									author$project$Project$Source$Module$PartDef$Expr$Int32Literal(9))
								])),
						aS: author$project$Project$Source$Module$PartDef$Name$fromLabel(
							A2(
								author$project$Project$Label$make,
...
var author$project$Project$Source$init = function () {
	...
	var coreEmit = _n2.b;
	return _Utils_Tuple2(
		{aY: core, aZ: coreInt32, be: sampleModule},
		_Utils_ap(
			coreEmit,
			_Utils_ap(coreInt32Emit, sampleModuleEmit)));
}();
var author$project$Project$init = function () {
	...
	return _Utils_Tuple2(
		{bq: author$project$Project$projectAuthor, b5: author$project$Project$Config$init, b6: author$project$Project$Document$init, aS: author$project$Project$projectName, bg: source},
...
var author$project$Model$init = function () {
	...
	var _n3 = author$project$Utility$ListExtra$listTupleListToTupleList(
		A2(elm$core$List$map, author$project$Model$editorPanelEmitToMsg, emitListFromEditorGroupPanel));
			...
			return elm$core$Platform$Cmd$batch(
				_Utils_ap(
					_List_fromArray(
						[cmdFromProject]),
					_Utils_ap(
						cmdFromEditorGroupPanel,
						_List_fromArray(
							[c]))));
		},
		A2(
			author$project$Model$updateFromList,
			_Utils_ap(msgListFromProject, msgFromEditorGroupPanel),
			model));
}();
...
var author$project$Key$fromKeyAndCodeAndModifierKeys = F5(
	function (keyString, codeString, ctrl, shift, alt) {
		...
		if (!_n0.$) {
			var key = _n0.a;
			return elm$core$Maybe$Just(
				{bp: alt, bt: ctrl, bB: key, bT: shift});
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
...
var author$project$Model$keyPrevented = _Platform_incomingPort(
	'keyPrevented',
...
var author$project$Model$runResult = _Platform_incomingPort(
	'runResult',
	A2(
...
var author$project$Model$windowResize = _Platform_incomingPort(
	'windowResize',
	A2(
		elm$json$Json$Decode$andThen,
		function (width) {
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {by: fragment, bA: host, bG: path, bI: port_, bL: protocol, bM: query};
	});
	...
	return A3(
		...
		A2(
			...
			A2(
				elm$json$Json$Decode$field,
				'target',
				A2(elm$json$Json$Decode$field, info.ce, elm$json$Json$Decode$bool))));
};
...
var author$project$Model$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_Utils_ap(
			_List_fromArray(
				[
					author$project$Model$keyPressed(
					A2(elm$core$Basics$composeR, author$project$Key$fromKeyEventObject, author$project$Model$KeyPressed)),
					author$project$Model$keyPrevented(
					elm$core$Basics$always(author$project$Model$KeyPrevented)),
					author$project$Model$windowResize(author$project$Model$WindowResize),
					author$project$Model$runResult(author$project$Model$ReceiveRunResult),
					author$project$Model$fireClickEventInCapturePhase(author$project$Model$FireClickEventInCapturePhase)
				]),
...
var author$project$NSvg$line = F3(
	function (_n0, _n1, strokeStyle) {
		...
		var y1 = _n1.b;
		return author$project$NSvg$Line(
			{t: strokeStyle, aw: x0, ax: x1, ay: y0, az: y1});
	});
var author$project$NSvg$strokeWidth = function (width) {
	return author$project$NSvg$Stroke(
		{R: elm$core$Maybe$Nothing, ar: 0, B: width});
};
				...
				if (!color.$) {
					...
					return _List_fromArray(
						[
							...
							tesk9$palette$Color$toHexString(c))
						]);
				} else {
					return _List_Nil;
				}
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2(1, 1),
						_Utils_Tuple2(11, 11),
						author$project$NSvg$strokeWidth(2)),
						A3(
						author$project$NSvg$line,
						_Utils_Tuple2(11, 1),
						_Utils_Tuple2(1, 11),
...
var author$project$Panel$Editor$EditorKeyConfig$inputSourceTab = function (selectedDevice) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('editor-tab'),
				A2(elm$html$Html$Attributes$style, 'grid-template-columns', '1fr 1fr 1fr 1fr')
			]),
		A2(
			elm$core$List$map,
			function (_n0) {
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_Utils_eq(device, selectedDevice) ? 'editor-tab-item-select' : 'editor-tab-item'),
							elm$html$Html$Events$onClick(
...
var author$project$Panel$Editor$EditorKeyConfig$selectFrame = function (oneKey) {
	...
	return A2(
		author$project$NSvg$translate,
		{b_: shapeData.a.a * 100, b$: shapeData.a.b * 100},
		A3(
...
var author$project$Panel$Editor$Module$MsgChangeResultVisible = F2(
	function (a, b) {
		return {$: 22, a: a, b: b};
	});
...
var author$project$Panel$Editor$Module$MsgNone = {$: 0};
var author$project$Panel$Editor$Module$MsgAddPartDef = {$: 18};
...
var author$project$Panel$Editor$Module$addPartDefButton = A2(
	...
	_List_fromArray(
		[
			...
			elm$json$Json$Decode$succeed(
				_Utils_Tuple2(author$project$Panel$Editor$Module$MsgAddPartDef, true))),
			author$project$Panel$Editor$Module$subClass('defList-addButton')
		]),
	_List_fromArray(
		[
			elm$html$Html$text('+ 新しいパーツ定義')
		]));
...
var author$project$Panel$Editor$Module$partDefResultView = F2(
	function (resultVisible, compileAndRunResult) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
							...
							[
								...
								function () {
									if (!resultVisible) {
										return _List_fromArray(
											[
												elm$html$Html$Attributes$class('editor-tab-item-select')
											]);
									} else {
										return _List_fromArray(
											[
												elm$html$Html$Attributes$class('editor-tab-item'),
												A2(
												elm$html$Html$Events$stopPropagationOn,
												'click',
												elm$json$Json$Decode$succeed(
					...
					if (!resultVisible) {
						return _List_fromArray(
							[
								...
								_List_fromArray(
									[
										author$project$Panel$Editor$Module$subClass('partDef-resultArea-resultValue')
									]),
								_List_fromArray(
									[
										elm$html$Html$text(
										A2(
											...
											A2(
												...
												author$project$Project$Source$ModuleWithCache$compileAndRunResultGetRunResult(compileAndRunResult))))
									]))
							]);
					} else {
						return _List_fromArray(
								...
								_List_fromArray(
									[
										...
										A2(
											...
											A2(
												elm$core$Maybe$map,
												author$project$Compiler$compileResultToString,
												author$project$Project$Source$ModuleWithCache$compileAndRunResultGetCompileResult(compileAndRunResult))))
									]))
							]);
					}
				}()));
	});
var author$project$Project$Source$Module$PartDef$Expr$O0 = 0;
var author$project$Project$Source$Module$PartDef$Expr$O1 = 1;
var author$project$Project$Source$Module$PartDef$Expr$O2 = 2;
var author$project$Project$Source$Module$PartDef$Expr$O3 = 3;
var author$project$Project$Source$Module$PartDef$Expr$O4 = 4;
var author$project$Project$Source$Module$PartDef$Expr$O5 = 5;
var author$project$Project$Source$Module$PartDef$Expr$O6 = 6;
var author$project$Project$Source$Module$PartDef$Expr$O7 = 7;
var author$project$Project$Source$Module$PartDef$Expr$toBindingOrder = function (op) {
	switch (op) {
		case 0:
			return 0;
		case 1:
...
var author$project$Panel$Editor$Module$opPaddingLength = function (op) {
	return function () {
		var _n0 = author$project$Project$Source$Module$PartDef$Expr$toBindingOrder(op);
		switch (_n0) {
			case 0:
				return 7;
			case 1:
...
var author$project$Panel$Editor$Module$opLength = function (op) {
	return (author$project$Panel$Editor$Module$opPaddingLength(op) * 2) + (function () {
		switch (op) {
			case 0:
				return 1;
			case 1:
...
var author$project$Panel$Editor$Module$parenthesisWidth = 9;
var elm$core$List$sum = function (numbers) {
	return A3(elm$core$List$foldl, elm$core$Basics$add, 0, numbers);
};
var author$project$Panel$Editor$Module$exprLength = function (expr) {
	return author$project$Panel$Editor$Module$termLength(
		author$project$Project$Source$Module$PartDef$Expr$getHead(expr)) + elm$core$List$sum(
		A2(
			elm$core$List$map,
			function (_n1) {
				var op = _n1.a;
				var term = _n1.b;
				return author$project$Panel$Editor$Module$opLength(op) + author$project$Panel$Editor$Module$termLength(term);
			},
			author$project$Project$Source$Module$PartDef$Expr$getOthers(expr)));
};
var author$project$Panel$Editor$Module$termLength = function (term) {
	switch (term.$) {
		case 0:
			var _int = term.a;
			return ((!_int) ? 1 : ((_int < 0) ? (elm$core$Basics$floor(
				A2(elm$core$Basics$logBase, 10, -_int)) + 2) : (elm$core$Basics$floor(
				A2(elm$core$Basics$logBase, 10, _int)) + 1))) * 9;
		case 1:
			return 18;
		case 2:
			var expr = term.a;
			return author$project$Panel$Editor$Module$exprLength(expr) + (author$project$Panel$Editor$Module$parenthesisWidth * 2);
		default:
			return 36;
	}
};
var author$project$Panel$Editor$Module$exprLengthView = function (expr) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				author$project$Panel$Editor$Module$subClass('partDef-exprArea-width')
			]),
		_List_fromArray(
			[
				elm$html$Html$text(
				elm$core$String$fromInt(
					author$project$Panel$Editor$Module$exprLength(expr)))
			]));
};
...
var author$project$Panel$Editor$Module$hideInputElement = A2(
	elm$html$Html$input,
	_List_fromArray(
		[
			author$project$Panel$Editor$Module$subClass('partDef-hideTextArea'),
			elm$html$Html$Attributes$id('edit'),
			elm$html$Html$Events$onInput(author$project$Panel$Editor$Module$PartDefInput)
		]),
	_List_Nil);
...
var author$project$Panel$Editor$Module$newOpView = function (op) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					...
					'width',
					elm$core$String$fromInt(
						author$project$Panel$Editor$Module$opLength(op)) + 'px'),
					A2(
					elm$html$Html$Attributes$style,
					'padding',
					'0 ' + (elm$core$String$fromInt(
						author$project$Panel$Editor$Module$opPaddingLength(op)) + 'px'))
				]),
			_List_fromArray(
				[
					elm$html$Html$text(
					author$project$Project$Source$Module$PartDef$Expr$opToString(op))
				]))
		]);
};
var author$project$Panel$Editor$Module$parenthesesLeftView = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			A2(
			elm$html$Html$Attributes$style,
			'width',
			elm$core$String$fromInt(author$project$Panel$Editor$Module$parenthesisWidth) + 'px')
		]),
	_List_fromArray(
		[
			elm$html$Html$text('(')
		]));
var author$project$Panel$Editor$Module$parenthesesRightView = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			A2(
...
var author$project$Project$Source$Module$PartDef$Expr$toString = function (_n0) {
	...
	var others = _n0.b;
	return _Utils_ap(
		author$project$Project$Source$Module$PartDef$Expr$termToString(head),
		elm$core$String$concat(
			A2(
				...
				function (_n1) {
					...
					return _Utils_ap(
						author$project$Project$Source$Module$PartDef$Expr$opToString(op),
						author$project$Project$Source$Module$PartDef$Expr$termToString(term));
				},
				others)));
};
var elm$virtual_dom$VirtualDom$map = _VirtualDom_map;
var elm$html$Html$map = elm$virtual_dom$VirtualDom$map;
var author$project$Panel$Editor$Module$newTermOpHeadView = function (term) {
	return A2(
		elm$core$List$map,
		elm$html$Html$map(
			function (m) {
				return A2(author$project$Panel$Editor$Module$TermOpTerm, 0, m);
			}),
		author$project$Panel$Editor$Module$newTermView(term));
};
var author$project$Panel$Editor$Module$newTermOpOthersView = function (others) {
	return elm$core$List$concat(
		elm$core$List$concat(
			A2(
				elm$core$List$indexedMap,
					...
					function (index, _n3) {
						...
						return _List_fromArray(
							[
								...
								author$project$Panel$Editor$Module$newOpView(op)),
								A2(
								elm$core$List$map,
								elm$html$Html$map(
									function (m) {
...
var author$project$Panel$Editor$Module$newTermOpView = F2(
	function (termOpPosMaybe, expr) {
		return _Utils_ap(
			function () {
			...
			_Utils_ap(
				author$project$Panel$Editor$Module$newTermOpHeadView(
					author$project$Project$Source$Module$PartDef$Expr$getHead(expr)),
				author$project$Panel$Editor$Module$newTermOpOthersView(
					author$project$Project$Source$Module$PartDef$Expr$getOthers(expr))));
	});
var author$project$Panel$Editor$Module$newTermView = function (term) {
	switch (term.$) {
		case 0:
			var _int = term.a;
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$Panel$Editor$Module$subClass('partDef-newTerm'),
							A2(
							elm$html$Html$Attributes$style,
							'width',
							elm$core$String$fromInt(
								author$project$Panel$Editor$Module$termLength(term)) + 'px')
						]),
					_List_fromArray(
						[
							elm$html$Html$text(
		...
		case 1:
			var partIndex = term.a;
			return _List_Nil;
		case 2:
			var expr = term.a;
			return _Utils_ap(
				_List_fromArray(
					[author$project$Panel$Editor$Module$parenthesesLeftView]),
				_Utils_ap(
					A2(
						elm$core$List$map,
						elm$html$Html$map(author$project$Panel$Editor$Module$TypeParentheses),
						A2(author$project$Panel$Editor$Module$newTermOpView, elm$core$Maybe$Nothing, expr)),
					_List_fromArray(
						[author$project$Panel$Editor$Module$parenthesesRightView])));
		default:
			return _List_Nil;
	}
};
...
var author$project$Panel$Editor$Module$partDefViewTermOpList = F2(
	function (termOpList, termOpPosMaybe) {
		return elm$core$List$concat(
			A2(
				elm$core$List$indexedMap,
				F2(
							...
							[
								...
								function () {
									if ((!termOpPosMaybe.$) && (termOpPosMaybe.a.$ === 2)) {
										...
										var i = _n8.a;
										var termOpPos = _n8.b;
										return _Utils_eq(i, index + 1) ? A2(
											author$project$Panel$Editor$Module$termViewOutput,
											term,
											elm$core$Maybe$Just(termOpPos)) : ((_Utils_eq(
											index,
											elm$core$List$length(termOpList) - 1) && (_Utils_cmp(index, i) < 0)) ? A2(
											author$project$Panel$Editor$Module$termViewOutput,
											term,
											elm$core$Maybe$Just(termOpPos)) : A2(author$project$Panel$Editor$Module$termViewOutput, term, elm$core$Maybe$Nothing));
									} else {
...
var author$project$Panel$Editor$Module$termOpView = F2(
	function (termOpPosMaybe, expr) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
...
var author$project$Panel$Editor$Module$partDefViewExpr = F3(
	function (width, expr, termOpPosMaybe) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$subClass('partDef-exprArea')
					]),
				function () {
					if ((!termOpPosMaybe.$) && (!termOpPosMaybe.a.$)) {
						...
						return _List_fromArray(
							[
								...
								elm$json$Json$Decode$succeed(
									_Utils_Tuple2(
										author$project$Panel$Editor$Module$PartDefActiveTo(
											author$project$Panel$Editor$Module$ActivePartDefExpr(author$project$Panel$Editor$Module$TermOpSelf)),
										true)))
							]);
					}
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								elm$html$Html$map,
								function (m) {
									return author$project$Panel$Editor$Module$PartDefActiveTo(
										author$project$Panel$Editor$Module$ActivePartDefExpr(m));
								},
								A2(author$project$Panel$Editor$Module$termOpView, termOpPosMaybe, expr)),
								author$project$Panel$Editor$Module$exprLengthView(expr),
								A2(
								elm$html$Html$div,
								_List_fromArray(
									[
										author$project$Panel$Editor$Module$subClass('partDef-expr-line')
									]),
								A2(
									elm$core$List$map,
									elm$html$Html$map(
									...
									A2(author$project$Panel$Editor$Module$newTermOpView, termOpPosMaybe, expr)))
							]),
						function () {
							if (!termOpPosMaybe.$) {
								return _List_fromArray(
									[author$project$Panel$Editor$Module$hideInputElement]);
							} else {
								return _List_Nil;
							}
						}()))
...
var author$project$Panel$Editor$Module$PartDefNone = {$: 3};
...
var author$project$Panel$Editor$Module$suggestNameItem = F3(
	function (mainText, subText, isSelect) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			_Utils_ap(
				...
				_Utils_ap(
					(subText === '') ? _List_Nil : _List_fromArray(
						[
							A2(
							elm$html$Html$div,
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											_Utils_Tuple2('partDef-suggestion-item-subText', true),
											_Utils_Tuple2('partDef-suggestion-item-subText-select', isSelect)
										]))
								]),
							_List_fromArray(
								[
					...
					isSelect ? _List_fromArray(
						[author$project$Panel$Editor$Module$enterIcon]) : _List_Nil)));
	});
var author$project$Panel$Editor$Module$suggestionName = F2(
	function (name, suggestSelectDataMaybe) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					...
					return _Utils_ap(
						_List_fromArray(
							[
								...
								author$project$Panel$Editor$Module$nameToEditorStyleString(searchName),
								'',
								false)
							]),
						A2(
							...
							F2(
								function (i, _n1) {
									...
									return A3(
										author$project$Panel$Editor$Module$suggestNameItem,
										author$project$Project$Source$Module$PartDef$Name$safeNameToString(safeName),
										subText,
										_Utils_eq(i, index));
								}),
					...
					return _Utils_ap(
						_List_fromArray(
							[
								A3(
								author$project$Panel$Editor$Module$suggestNameItem,
								author$project$Panel$Editor$Module$nameToEditorStyleString(name),
								'',
								true)
							]),
						A2(
					...
					A2(
						...
						_List_fromArray(
							[
								...
								'click',
								elm$json$Json$Decode$succeed(
									_Utils_Tuple2(author$project$Panel$Editor$Module$PartDefNone, true)))
							]),
						_List_Nil)),
					_Utils_Tuple2(
					'suggest',
					A2(author$project$Panel$Editor$Module$suggestionName, name, suggestSelectDataMaybe))
				]));
	});
		...
		if (!nameEditMaybe.$) {
			switch (nameEditMaybe.a.$) {
				...
				case 2:
					...
					return A2(
						author$project$Panel$Editor$Module$partDefNameEditView,
						name,
						elm$core$Maybe$Just(suggestSelectData));
				default:
...
var author$project$Panel$Editor$Module$partDefTypeNormalView = function (type_) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Panel$Editor$Module$subClass('partDef-typeContainer'),
				A2(
				elm$html$Html$Events$stopPropagationOn,
				'click',
				elm$json$Json$Decode$succeed(
			...
			[
				...
				if (!_n0.$) {
					...
					return A2(
						...
						_List_fromArray(
							[
								author$project$Panel$Editor$Module$subClass('partDef-typeText')
							]),
						_List_fromArray(
							[
					...
					return A2(
						...
						_List_fromArray(
							[
								author$project$Panel$Editor$Module$subClass('partDef-typeTextNone')
							]),
						_List_fromArray(
							[
...
var author$project$Panel$Editor$Module$partDefView = F7(
	function (width, resultVisible, isFocus, index, partDef, compileAndRunResult, partDefActiveMaybe) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
				_List_fromArray(
					[
						...
						elm$json$Json$Decode$succeed(
							_Utils_Tuple2(
								author$project$Panel$Editor$Module$PartDefActiveTo(author$project$Panel$Editor$Module$ActivePartDefSelf),
								isFocus)))
					]),
				...
				[
					...
					_List_fromArray(
						[
							...
							author$project$Project$Source$Module$PartDef$getName(partDef),
							author$project$Project$Source$Module$PartDef$getType(partDef),
							partDefActiveMaybe),
							A3(
					...
					A2(
					elm$html$Html$map,
					author$project$Panel$Editor$Module$PartDefChangeResultVisible,
					A2(author$project$Panel$Editor$Module$partDefResultView, resultVisible, compileAndRunResult))
				]));
	});
var author$project$Panel$Editor$Module$partDefListView = F5(
	function (width, resultVisibleList, isFocus, defAndResultList, partDefActiveWithIndexMaybe) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					author$project$Panel$Editor$Module$subClass('defList')
				]),
			_Utils_ap(
				A2(
					elm$core$List$indexedMap,
							...
							return A2(
								...
								function (m) {
									switch (m.$) {
										case 0:
											var ref = m.a;
											return author$project$Panel$Editor$Module$MsgActiveTo(
												author$project$Panel$Editor$Module$ActivePartDefList(
													author$project$Panel$Editor$Module$ActivePartDef(
								...
								A7(
									...
									A2(
										elm$core$Maybe$withDefault,
										0,
										A2(elm$core$Array$get, index, resultVisibleList)),
									isFocus,
									index,
									partDef,
									result,
					...
					defAndResultList),
				_List_fromArray(
					[author$project$Panel$Editor$Module$addPartDefButton])));
	});
var author$project$Panel$Editor$Module$partDefinitionsViewTitle = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			author$project$Panel$Editor$Module$subClass('section-title')
		]),
	_List_fromArray(
		[
			elm$html$Html$text('Part Definitions')
		]));
var author$project$Panel$Editor$Module$partDefinitionsView = F5(
	function (width, resultVisibleList, isFocus, partDefListActiveMaybe, partDefAndResultList) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$subClass('section')
					]),
				_Utils_ap(
					function () {
						if ((!partDefListActiveMaybe.$) && (!partDefListActiveMaybe.a.$)) {
							...
							return _List_fromArray(
								[
									author$project$Panel$Editor$Module$subClass('section-active')
								]);
						} else {
							return _List_fromArray(
								[
									elm$html$Html$Events$onClick(
									author$project$Panel$Editor$Module$MsgActiveTo(
					...
					isFocus ? _List_fromArray(
						[
							elm$html$Html$Attributes$id(author$project$Panel$Editor$Module$partDefinitionId)
						]) : _List_Nil)),
			_List_fromArray(
				[
...
var author$project$Panel$Editor$Module$readMeViewMeasure = function (readMe) {
	...
	return A2(
		...
		_List_fromArray(
			[
				author$project$Panel$Editor$Module$subClass('readMe-measure')
			]),
		_Utils_ap(
			A2(
...
var author$project$Panel$Editor$Module$readMeTextClickEvent = A2(
	elm$html$Html$Events$stopPropagationOn,
	'click',
	elm$json$Json$Decode$succeed(
		_Utils_Tuple2(
			author$project$Panel$Editor$Module$MsgActiveTo(
				author$project$Panel$Editor$Module$ActiveReadMe(1)),
			true)));
...
var author$project$Panel$Editor$Module$readMeViewTextArea = F3(
	function (readMe, isFocus, isActive) {
		return A2(
			elm$html$Html$textarea,
			_Utils_ap(
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$subClass('readMe-textarea')
					]),
				isActive ? _Utils_ap(
					_List_fromArray(
						[
							elm$html$Html$Events$onInput(author$project$Panel$Editor$Module$MsgInput),
							author$project$Panel$Editor$Module$subClass('readMe-textarea-focus'),
							A2(
							elm$html$Html$Attributes$property,
							'value',
							elm$json$Json$Encode$string(readMe)),
							A2(
							elm$html$Html$Events$stopPropagationOn,
							'click',
							elm$json$Json$Decode$succeed(
								_Utils_Tuple2(author$project$Panel$Editor$Module$MsgNone, true)))
						]),
					isFocus ? _List_fromArray(
						[
							elm$html$Html$Attributes$id('edit')
					...
					[
						...
						'value',
						elm$json$Json$Encode$string(readMe)),
						author$project$Panel$Editor$Module$readMeTextClickEvent
					])),
			_List_Nil);
	});
var author$project$Panel$Editor$Module$readMeViewInputArea = F3(
	function (readMe, isFocus, isActive) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('readMe-inputArea', true),
							_Utils_Tuple2('readMe-inputArea-active', isActive)
						]))
				]),
			_List_fromArray(
				[
					author$project$Panel$Editor$Module$readMeViewMeasure(readMe),
					A3(author$project$Panel$Editor$Module$readMeViewTextArea, readMe, isFocus, isActive)
				]));
	});
var elm$html$Html$h2 = _VirtualDom_node('h2');
var author$project$Panel$Editor$Module$readMeViewTitle = A2(
	elm$html$Html$h2,
	_List_fromArray(
		[
			author$project$Panel$Editor$Module$subClass('section-title')
...
var author$project$Panel$Editor$Module$readMeView = F3(
	function (isFocus, readMeActiveMaybe, readMe) {
						...
						if ((!readMeActiveMaybe.$) && (!readMeActiveMaybe.a)) {
							...
							return _List_fromArray(
								[
									elm$html$Html$Events$onClick(
									author$project$Panel$Editor$Module$MsgActiveTo(
										author$project$Panel$Editor$Module$ActiveReadMe(0)))
								]);
						}
					}(),
					isFocus ? _List_fromArray(
						[
							elm$html$Html$Attributes$id(author$project$Panel$Editor$Module$readMeId)
						]) : _List_Nil)),
			_List_fromArray(
				[
					author$project$Panel$Editor$Module$readMeViewTitle,
					A3(
					author$project$Panel$Editor$Module$readMeViewInputArea,
					readMe,
					isFocus,
					_Utils_eq(
						readMeActiveMaybe,
...
var author$project$Panel$Editor$Module$MsgAddTypeDef = {$: 19};
var author$project$Panel$Editor$Module$addTypeDefButton = A2(
	elm$html$Html$button,
	_List_fromArray(
		[
			A2(
			...
			'click',
			elm$json$Json$Decode$succeed(
				_Utils_Tuple2(author$project$Panel$Editor$Module$MsgAddTypeDef, true))),
			author$project$Panel$Editor$Module$subClass('defList-addButton')
		]),
	_List_fromArray(
		[
			elm$html$Html$text('+ 新しい型定義')
		]));
var author$project$Project$Source$Module$TypeDef$tagToString = function (_n0) {
	var name = _n0.aS;
	var parameter = _n0.cp;
	return _Utils_ap(
		author$project$Project$Label$toCapitalString(name),
		function () {
			if (!parameter.$) {
				return '';
			} else {
...
var author$project$Project$Source$Module$TypeDef$tagOrKernelToString = function (tagOrKernel) {
	if (!tagOrKernel.$) {
		...
		return A2(
			elm$core$String$join,
			'|',
			A2(elm$core$List$map, author$project$Project$Source$Module$TypeDef$tagToString, list));
	} else {
...
var author$project$Panel$Editor$Module$typeDefView = F2(
	function (typeDefActive, typeDef) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$subClass('typeDef')
					]),
				function () {
					if ((!typeDefActive.$) && (!typeDefActive.a.$)) {
						...
						return _List_fromArray(
							[
								author$project$Panel$Editor$Module$subClass('typeDef-active')
							]);
					} else {
						return _List_fromArray(
							[
								...
								'click',
								elm$json$Json$Decode$succeed(
									_Utils_Tuple2(author$project$Panel$Editor$Module$ActiveTypeDefSelf, true)))
							]);
					}
				}()),
			_List_fromArray(
				[
					elm$html$Html$text(
					author$project$Project$Source$Module$TypeDef$toString(typeDef))
				]));
	});
var author$project$Panel$Editor$Module$typeDefListView = F2(
	function (typeDefIndexAndActive, typeDefList) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			_Utils_ap(
				A2(
					elm$core$List$indexedMap,
					F2(
						function (index, typeDef) {
							return A2(
								elm$html$Html$map,
								function (m) {
									return author$project$Panel$Editor$Module$MsgActiveTo(
										author$project$Panel$Editor$Module$ActiveTypeDefList(
											author$project$Panel$Editor$Module$ActiveTypeDef(
												_Utils_Tuple2(index, m))));
								},
								A2(
									author$project$Panel$Editor$Module$typeDefView,
									function () {
					...
					typeDefList),
				_List_fromArray(
					[author$project$Panel$Editor$Module$addTypeDefButton])));
	});
var author$project$Panel$Editor$Module$typeDefinitionsViewTitle = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			author$project$Panel$Editor$Module$subClass('section-title')
	...
	_List_fromArray(
		[
			elm$html$Html$text('Type Definitions')
		]));
var author$project$Panel$Editor$Module$typeDefinitionsView = F3(
	function (isFocus, typeDefListActiveMaybe, typeDefList) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
				_List_fromArray(
						...
						if ((!typeDefListActiveMaybe.$) && (!typeDefListActiveMaybe.a.$)) {
							...
							return _List_fromArray(
								[
									elm$html$Html$Events$onClick(
									author$project$Panel$Editor$Module$MsgActiveTo(
										author$project$Panel$Editor$Module$ActiveTypeDefList(author$project$Panel$Editor$Module$ActiveTypeDefListSelf)))
								]);
						}
					}(),
					isFocus ? _List_fromArray(
						[
							elm$html$Html$Attributes$id(author$project$Panel$Editor$Module$typeDefId)
						]) : _List_Nil)),
			_List_fromArray(
				[
					author$project$Panel$Editor$Module$typeDefinitionsViewTitle,
					A2(
					author$project$Panel$Editor$Module$typeDefListView,
					function () {
...
var author$project$Panel$Editor$Module$view = F4(
	function (width, project, isFocus, _n0) {
		var moduleRef = _n0.a3;
		var active = _n0.X;
		...
		return {
			b2: _List_fromArray(
				[
					...
					A3(
					author$project$Panel$Editor$Module$readMeView,
					isFocus,
					function () {
						if (active.$ === 1) {
							var readMeActive = active.a;
					...
					A3(
					author$project$Panel$Editor$Module$typeDefinitionsView,
					isFocus,
					function () {
						if (active.$ === 2) {
							var typeDefListActive = active.a;
					...
					author$project$Project$Source$ModuleWithCache$getTypeDefList(targetModule)),
					A5(
			...
			cu: author$project$Project$Label$toCapitalString(
...
var author$project$Panel$EditorGroup$editorTitleAndBody = F5(
	function (width, editorIndex, isActive, project, editorItem) {
		switch (editorItem.$) {
			case 0:
			...
			case 4:
				...
				var viewItem = A4(author$project$Panel$Editor$Module$view, width, project, isActive, moduleEditorModel);
				return {
					b2: A2(
						elm$core$List$map,
						elm$html$Html$map(
...
var author$project$Panel$EditorGroup$editorItemView = function (_n0) {
	...
	var isActive = _n0.aK;
	var isOne = _n0.aM;
	var _n1 = A5(author$project$Panel$EditorGroup$editorTitleAndBody, width, editorIndex, isActive, project, editorItem);
	var title = _n1.cu;
	var body = _n1.b2;
	return A2(
		elm$html$Html$div,
		_Utils_ap(
			_List_fromArray(
				[
					author$project$Panel$EditorGroup$subClassList(
					_List_fromArray(
						[
							_Utils_Tuple2('editor', true),
							_Utils_Tuple2('editor--active', isActive)
						])),
					A2(
					elm$html$Html$Attributes$style,
					'width',
					...
					elm$html$Html$Attributes$id(
					author$project$Panel$EditorGroup$editorIndexToIdString(editorIndex))
				]),
			isActive ? _List_Nil : _List_fromArray(
				[
					elm$html$Html$Events$onClick(
					author$project$Panel$EditorGroup$ChangeActiveEditor(editorIndex))
				])),
		_List_fromArray(
			[
				A3(author$project$Panel$EditorGroup$editorTitle, title, editorIndex, isOne),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						author$project$Panel$EditorGroup$subClass('editorBody')
					]),
				body)
			]));
};
...
var author$project$Panel$EditorGroup$editorColumn = F8(
	function (project, columnGroup, _n0, openEditorPosition, activeEditorIndexColumnMaybe, editorRefRow, isGutterActive, isOne) {
		var width = _n0.B;
		var height = _n0.C;
		return A2(
			elm$html$Html$div,
					...
					return _List_fromArray(
						[
							...
							author$project$Panel$EditorGroup$editorItemView(
							{
								...
								aF: bottom,
								C: (((height - 2) * (1000 - topHeight)) / 1000) | 0,
								aK: _Utils_eq(
									elm$core$Maybe$Just(1),
									activeEditorIndexColumnMaybe),
								aM: false,
					...
					case 0:
						...
						return _List_fromArray(
							[
								...
								{C: height, B: width - 2},
								1,
								elm$core$Maybe$Just(activeEditorColumn),
								0,
								_Utils_eq(
									gutter,
									elm$core$Maybe$Just(
					...
					case 1:
						...
						return _List_fromArray(
							[
								...
								project,
								left,
								{C: height, B: (((width - 4) * leftWidth) / 1000) | 0},
								1,
								function () {
									if (!activeEditorRow) {
								...
								project,
								center,
								{C: height, B: (((width - 4) * (1000 - leftWidth)) / 1000) | 0},
								2,
								function () {
									if (!activeEditorRow) {
										return elm$core$Maybe$Nothing;
					...
					default:
						...
						return _List_fromArray(
							[
								...
								project,
								center,
								{C: height, B: (((width - 4) * centerWidth) / 1000) | 0},
								2,
								function () {
									switch (activeEditorRow) {
										case 0:
								...
								project,
								right,
								{C: height, B: (((width - 4) * ((1000 - leftWidth) - centerWidth)) / 1000) | 0},
								3,
								function () {
									switch (activeEditorRow) {
										case 0:
		...
		_Utils_ap(
			...
			_Utils_ap(
				author$project$Model$isFocusEditorGroupPanel(model) ? _List_Nil : _List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Model$focusToEditorGroupPanel)
					]),
...
var author$project$Panel$Tree$CloseSidePanel = {$: 9};
...
var author$project$Panel$Tree$viewTitle = A2(
	...
	_List_fromArray(
		[
			author$project$Panel$Tree$treePanelClass('title-area')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Events$onClick(author$project$Panel$Tree$CloseSidePanel),
					author$project$Panel$Tree$treePanelClass('closeButton')
				]),
			_List_fromArray(
				[
					elm$html$Html$text('◀')
...
var author$project$Panel$Tree$viewTypeToClass = F2(
	function (focus, viewType) {
		return _Utils_ap(
			focus ? _List_fromArray(
				[
					author$project$Panel$Tree$treePanelClass('item--focus')
				]) : _List_Nil,
			function () {
				switch (viewType) {
					case 0:
...
var author$project$Panel$Tree$viewCloseChildrenItem = F6(
	function (focus, icon, label, editorRef, viewType, optionList) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
				_List_fromArray(
				...
				A2(author$project$Panel$Tree$viewTypeToClass, focus, viewType)),
			_Utils_ap(
				_List_fromArray(
					[
...
var author$project$Panel$Tree$viewNoChildrenItem = F6(
	function (focus, icon, label, editorRef, viewType, optionList) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
...
var author$project$Panel$Tree$viewOpenChildrenItem = F7(
	function (focus, icon, label, editorRef, viewType, optionList, _n3) {
		var headTree = _n3.a;
		var restTree = _n3.b;
		return A2(
			elm$html$Html$div,
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							A2(
								elm$core$List$cons,
								A2(author$project$Panel$Tree$viewTreeItem, focus, headTree),
								A2(
									elm$core$List$map,
									author$project$Panel$Tree$viewTreeItem(focus),
									restTree)))
						]))));
	});
var author$project$Panel$Tree$viewTreeItem = F2(
	function (focus, _n0) {
		var icon = _n0.r;
		var label = _n0.s;
		var editorRef = _n0.j;
...
var author$project$Panel$Tree$view = function (_n0) {
	...
	return (100 < width) ? _Utils_ap(
		...
		A2(
			...
			{j: editorRef, aH: focus, ba: project, B: width},
			model)) : _List_Nil;
};
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('treePanel', true),
							_Utils_Tuple2(
							'treePanel-focus',
							author$project$Model$isFocusTreePanel(model))
						])),
					A2(
					elm$html$Html$Attributes$style,
					'width',
			...
			_Utils_ap(
				author$project$Model$isFocusTreePanel(model) ? _List_Nil : _List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Model$focusToTreePanel)
					]),
				author$project$Utility$ListExtra$fromMaybe(
					A2(
						elm$core$Maybe$map,
...
var author$project$View$view = function (model) {
	return {
		...
		cu: 'Definy 0 - ' + author$project$Project$Label$toCapitalString(
