...
var author$project$Panel$EditorGroup$initModel = {
	...
	ax: author$project$Panel$EditorGroup$RowOne(
		{
...
var author$project$Project$Source$ModuleWithCache$make = function (_n0) {
	...
	var readMe = _n0.aV;
	return {
		aJ: A2(elm$core$List$take, 65535, defList),
		aP: name,
		aV: readMe,
		b4: _List_Nil
	};
			...
			aJ: _List_fromArray(
				[
					...
					author$project$Project$Source$Module$Def$make(
						{
							aL: author$project$Project$Source$Module$Def$Expr$empty,
...
var author$project$Model$initModel = {
	aK: author$project$Panel$EditorGroup$initModel,
	aw: 1,
	ai: _List_Nil,
	aU: author$project$Project$init,
	L: author$project$Model$SubModeNone,
	...
	function (keyString, codeString, ctrl, shift, alt) {
		...
		if (!_n0.$) {
			...
			return elm$core$Maybe$Just(
				{a3: alt, a7: ctrl, bf: key, bv: shift});
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bc: fragment, be: host, bj: path, bl: port_, bo: protocol, bp: query};
	});
...
var author$project$Model$getEditorGroupPanelModel = function (_n0) {
	var editorGroupPanelModel = _n0.aK;
...
var author$project$Project$Source$Module$Def$empty = {aL: author$project$Project$Source$Module$Def$Expr$empty, aP: author$project$Project$Source$Module$Def$Name$noName, a0: author$project$Project$Source$Module$Def$Type$empty};
var author$project$Project$Source$ModuleWithCache$addDef = F2(
	function (def, _n0) {
		...
		return _Utils_update(
			rec,
			{
				aJ: (65535 <= elm$core$List$length(rec.aJ)) ? rec.aJ : _Utils_ap(
					rec.aJ,
					_List_fromArray(
						[
...
var author$project$Project$Source$ModuleWithCache$setDefListAt = F3(
	function (index, def, _n0) {
		...
		return _Utils_update(
			rec,
			{
				aJ: A3(author$project$Utility$ListExtra$setAt, index, def, rec.aJ)
			});
	});
				...
				if (!_n0.a.$) {
					if (!_n0.b.a.$) {
						...
						var $temp$intermediate = author$project$Parser$Expr$TermLastOp(
							{bP: head, Y: op, b$: others, v: textAreaValue}),
							$temp$list = listOthers;
						intermediate = $temp$intermediate;
						list = $temp$list;
						continue batchTermResultLoop;
			...
			if (!list.a.$) {
				...
				return A2(
					...
					author$project$Parser$Expr$TermLastTerm(
						{bP: term, b$: _List_Nil, v: textAreaValue}),
					others);
			} else {
				var op = list.a.a;
				var others = list.b;
				return A2(
					...
					author$project$Parser$Expr$TermLastOp(
						{bP: author$project$Project$Source$Module$Def$Expr$Term$none, Y: op, b$: _List_Nil, v: textAreaValue}),
					others);
			}
		} else {
			return author$project$Parser$Expr$TermLastTerm(
				{bP: author$project$Project$Source$Module$Def$Expr$Term$none, b$: _List_Nil, v: _List_Nil});
		}
	});
				...
				case 1:
					switch (list.a.a) {
						case 17:
							if ((list.b.b && (list.b.a.$ === 1)) && (list.b.a.a === 17)) {
								...
								return author$project$Parser$Expr$OneOpAndRest(
									{i: author$project$Project$Source$Module$Def$Expr$Operator$compose, bt: others});
							} else {
								var _n28 = list.a;
								var _n29 = _n28.a;
								var others = list.b;
								return author$project$Parser$Expr$OneOpAndRest(
									{i: author$project$Project$Source$Module$Def$Expr$Operator$pipe, bt: others});
							}
						case 27:
							var _n30 = list.a;
							var _n31 = _n30.a;
							var others = list.b;
							return author$project$Parser$Expr$OneOpAndRest(
								{i: author$project$Project$Source$Module$Def$Expr$Operator$or, bt: others});
						case 4:
							var _n32 = list.a;
							var _n33 = _n32.a;
							var others = list.b;
							return author$project$Parser$Expr$OneOpAndRest(
								{i: author$project$Project$Source$Module$Def$Expr$Operator$and, bt: others});
						case 16:
							var _n34 = list.a;
							var _n35 = _n34.a;
							var others = list.b;
							return author$project$Parser$Expr$OneOpAndRest(
								{i: author$project$Project$Source$Module$Def$Expr$Operator$equal, bt: others});
						case 15:
							if (list.b.b) {
								if ((list.b.a.$ === 1) && (list.b.a.a === 16)) {
									...
									var others = _n15.b;
									return author$project$Parser$Expr$OneOpAndRest(
										{i: author$project$Project$Source$Module$Def$Expr$Operator$lessThanOrEqual, bt: others});
								} else {
									var _n38 = list.a;
									var _n39 = _n38.a;
									var others = list.b;
									return author$project$Parser$Expr$OneOpAndRest(
										{i: author$project$Project$Source$Module$Def$Expr$Operator$lessThan, bt: others});
								}
							} else {
								var _n36 = list.a;
								var _n37 = _n36.a;
						...
						case 9:
							if (list.b.b) {
								if ((list.b.a.$ === 1) && (list.b.a.a === 9)) {
									...
									var others = _n20.b;
									return author$project$Parser$Expr$OneOpAndRest(
										{i: author$project$Project$Source$Module$Def$Expr$Operator$concat, bt: others});
								} else {
									var _n42 = list.a;
									var _n43 = _n42.a;
									var others = list.b;
									return author$project$Parser$Expr$OneOpAndRest(
										{i: author$project$Project$Source$Module$Def$Expr$Operator$add, bt: others});
								}
							} else {
								var _n40 = list.a;
								var _n41 = _n40.a;
						...
						case 11:
							...
							var others = list.b;
							return author$project$Parser$Expr$OneOpAndRest(
								{i: author$project$Project$Source$Module$Def$Expr$Operator$sub, bt: others});
						case 8:
							var _n46 = list.a;
							var _n47 = _n46.a;
							var others = list.b;
							return author$project$Parser$Expr$OneOpAndRest(
								{i: author$project$Project$Source$Module$Def$Expr$Operator$mul, bt: others});
						case 13:
							if (list.b.b) {
								if ((list.b.a.$ === 1) && (list.b.a.a === 16)) {
									var _n8 = list.a;
									...
									var others = _n10.b;
									return author$project$Parser$Expr$OneOpAndRest(
										{i: author$project$Project$Source$Module$Def$Expr$Operator$notEqual, bt: others});
								} else {
									var _n50 = list.a;
									var _n51 = _n50.a;
									var others = list.b;
									return author$project$Parser$Expr$OneOpAndRest(
										{i: author$project$Project$Source$Module$Def$Expr$Operator$div, bt: others});
								}
							} else {
								var _n48 = list.a;
								var _n49 = _n48.a;
						...
						case 23:
							...
							var others = list.b;
							return author$project$Parser$Expr$OneOpAndRest(
								{i: author$project$Project$Source$Module$Def$Expr$Operator$factorial, bt: others});
						default:
							var _n54 = list.a;
							var _char = _n54.b;
							var others = list.b;
		...
		while (true) {
			if (rest.b) {
					...
					case 1:
						if (rest.a.a === 16) {
							...
							if (!label.$) {
								...
								return author$project$Parser$Type$TypeToExpr(
									{bt: others, a0: author$project$Project$Source$Module$Def$Type$empty});
							}
						} else {
							var _n5 = rest.a;
							var _char = _n5.b;
				...
				if (!label.$) {
					...
					return author$project$Parser$Type$TypeEnd(
						{v: textAreaValue, a0: author$project$Project$Source$Module$Def$Type$empty});
				}
			}
		}
	});
var author$project$Parser$Type$parse = function (list) {
	...
	while (true) {
		if (list.b) {
			...
			return author$project$Parser$Type$TypeEnd(
				{v: _List_Nil, a0: author$project$Project$Source$Module$Def$Type$empty});
		}
	}
};
		...
		case 1:
			...
			if (!_n1.$) {
				...
				return author$project$Parser$BeginWithNameEndType(
					{aP: name, v: textAreaValue, a0: type_});
			} else {
				var type_ = _n1.a.a0;
				var rest = _n1.a.bt;
				...
				if (!_n2.$) {
					...
					return author$project$Parser$BeginWithNameEndExprTerm(
						{H: head, aP: name, K: others, v: textAreaValue, a0: type_});
				} else {
					var head = _n2.a.bP;
					var others = _n2.a.b$;
					var last = _n2.a.Y;
					...
					return author$project$Parser$BeginWithNameEndExprOp(
						{H: head, aB: last, aP: name, K: others, v: textAreaValue, a0: type_});
				}
			}
		default:
			var name = _n0.a;
			...
			if (!_n3.$) {
				...
				return author$project$Parser$BeginWithNameEndExprTerm(
					{H: head, aP: name, K: others, v: textAreaValue, a0: author$project$Project$Source$Module$Def$Type$empty});
			} else {
				var head = _n3.a.bP;
				var others = _n3.a.b$;
				var last = _n3.a.Y;
				var textAreaValue = _n3.a.v;
				return author$project$Parser$BeginWithNameEndExprOp(
					{H: head, aB: last, aP: name, K: others, v: textAreaValue, a0: author$project$Project$Source$Module$Def$Type$empty});
			}
	}
};
						...
						_Utils_ap(
							...
							_List_fromArray(
								[
									...
									{
										aL: A2(author$project$Project$Source$Module$Def$Expr$make, headTerm, opAndTermList),
										B: index,
										p: moduleRef
									})
								]))));
			...
			if (_n0.b.b) {
				if (_n0.a.$ === 1) {
					...
					if (!_n0.b.a.$) {
						...
						var listOthers = _n3.b;
						var $temp$intermediate = author$project$Parser$Expr$OpLastTerm(
							{bP: head, Y: term, b$: others, v: textAreaValue}),
							$temp$list = listOthers;
						intermediate = $temp$intermediate;
						list = $temp$list;
						continue batchOpResultLoop;
			...
			if (!list.a.$) {
				...
				return A2(
					...
					author$project$Parser$Expr$OpLastTerm(
						{bP: author$project$Project$Source$Module$Def$Expr$Operator$blank, Y: term, b$: _List_Nil, v: textAreaValue}),
					others);
			} else {
				var op = list.a.a;
				var others = list.b;
				return A2(
					...
					author$project$Parser$Expr$OpLastOp(
						{bP: op, b$: _List_Nil, v: textAreaValue}),
					others);
			}
		} else {
			return author$project$Parser$Expr$OpLastOp(
				{bP: author$project$Project$Source$Module$Def$Expr$Operator$blank, b$: _List_Nil, v: textAreaValue});
		}
	});
...
var author$project$Parser$beginWithExprOp = function (list) {
	...
	if (_n0.$ === 1) {
		...
		return author$project$Parser$BeginWithOpEndTerm(
			{bd: head, bU: last, by: others, v: textAreaValue});
	} else {
		var head = _n0.a.bP;
		var others = _n0.a.b$;
		var textAreaValue = _n0.a.v;
		return author$project$Parser$BeginWithOpEndOp(
			{bd: head, by: others, v: textAreaValue});
	}
};
	...
	function (index, headOp, termOpList, expr) {
		...
		var replaceAndInsertElement = function () {
			...
			if (_n0.$ === 1) {
				return {
					X: _List_Nil,
					aa: _Utils_Tuple2(headOp, targetTerm)
				};
			} else {
				var _n1 = _n0.a;
				var _n2 = _n1.a;
				...
				return {
					...
					aa: _Utils_Tuple2(headOp, headTerm)
				};
			}
		}();
		return A2(
			...
			A2(
				elm$core$Basics$composeR,
				A2(author$project$Utility$ListExtra$setAt, index, replaceAndInsertElement.aa),
				A2(author$project$Utility$ListExtra$insertList, index + 1, replaceAndInsertElement.X)),
			expr);
	});
var author$project$Project$Source$Module$Def$Expr$replaceAndInsertOpLastTerm = F5(
	function (index, op, termOpList, lastTerm, expr) {
		...
		var replaceAndInsertElement = function () {
			...
			if (_n0.$ === 1) {
				return {
					X: _Utils_eq(targetTerm, author$project$Project$Source$Module$Def$Expr$Term$none) ? _List_Nil : _List_fromArray(
						[
							_Utils_Tuple2(author$project$Project$Source$Module$Def$Expr$Operator$blank, targetTerm)
						]),
					aa: _Utils_Tuple2(op, lastTerm)
				};
			} else {
				var _n1 = _n0.a;
				var _n2 = _n1.a;
...
var author$project$Panel$Editor$Module$parserBeginWithOp = F5(
	function (string, index, moduleRef, opIndex, expr) {
		...
		if (!_n0.$) {
			var headOp = _n0.a.bd;
			var termAndOpList = _n0.a.by;
			var lastTerm = _n0.a.bU;
			var textAreaValue = _n0.a.v;
			return _Utils_Tuple2(
				author$project$Panel$Editor$Module$ActivePartDefList(
					author$project$Panel$Editor$Module$ActivePartDef(
				...
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$EmitChangeExpr(
						{
							aL: A5(author$project$Project$Source$Module$Def$Expr$replaceAndInsertOpLastTerm, opIndex, headOp, termAndOpList, lastTerm, expr),
							B: index,
							p: moduleRef
						}),
						author$project$Panel$Editor$Module$textAreaValueToSetTextEmit(textAreaValue)
				...
				_Utils_ap(
					_List_fromArray(
						[
							author$project$Panel$Editor$Module$EmitChangeExpr(
							{
								aL: A4(author$project$Project$Source$Module$Def$Expr$replaceAndInsertOpLastOp, opIndex, headOp, termAndOpList, expr),
								B: index,
								p: moduleRef
							})
						]),
...
var author$project$Parser$beginWithExprTerm = function (list) {
	...
	if (!_n0.$) {
		...
		return author$project$Parser$BeginWithTermEndTerm(
			{H: head, K: others, v: textAreaValue});
	} else {
		var head = _n0.a.bP;
		var others = _n0.a.b$;
		var last = _n0.a.Y;
		...
		return author$project$Parser$BeginWithTermEndOp(
			{H: head, aB: last, K: others, v: textAreaValue});
	}
};
	...
	if (!_n0.$) {
		...
		if (!_n1.$) {
			...
			return author$project$Parser$BeginWithTypeEndExprTerm(
				{H: head, K: others, v: textAreaValue, a0: type_});
		} else {
			var head = _n1.a.bP;
			var others = _n1.a.b$;
			var last = _n1.a.Y;
			...
			return author$project$Parser$BeginWithTypeEndExprOp(
				{H: head, aB: last, K: others, v: textAreaValue, a0: type_});
		}
	}
};
...
var author$project$Panel$Editor$Module$suggestionSelcetChagnedThenNameChangeEmit = F3(
	function (suggestIndex, defIndex, moduleRef) {
		...
		if (!_n0.$) {
			...
			return _List_fromArray(
				[
					author$project$Panel$Editor$Module$EmitChangeName(
					{B: defIndex, aP: suggestName, p: moduleRef})
				]);
		} else {
			return _List_Nil;
		}
	...
	function (module_, project, _n8) {
		...
		if ((((_n9.$ === 2) && (_n9.a.$ === 1)) && (_n9.a.a.b.$ === 1)) && (!_n9.a.a.b.a.$)) {
			...
			return _Utils_Tuple2(
				...
				A3(author$project$Panel$Editor$Module$suggestionSelcetChagnedThenNameChangeEmit, suggestIndex, index, rec.t));
		} else {
				...
				if (!index.a) {
					...
					return A2(
						...
						A2(
							...
							A2(author$project$Panel$EditorGroup$closeEditorColumn, editorRefColumn, rec.Q)));
				} else {
					return group;
				}
			case 1:
					...
					case 0:
						return A2(
							...
							A2(
								...
								A2(author$project$Panel$EditorGroup$closeEditorColumn, index.b, rec.Q)));
					case 1:
						return A2(
							elm$core$Maybe$withDefault,
							author$project$Panel$EditorGroup$RowOne(
...
var author$project$Panel$EditorGroup$mouseOverAddGutter = F2(
	function (openEditorPosition, _n0) {
		...
		return _Utils_update(
			rec,
			{
				aD: elm$core$Maybe$Just(openEditorPosition)
			});
	});
			...
			return elm$core$Maybe$Just(
				author$project$Panel$EditorGroup$ColumnTwo(
					_Utils_update(
						rec,
						{
							M: A3(elm$core$Basics$clamp, 100, 900, (((mouseRelY * 1002) / editorHeight) | 0) - 1)
						})));
		}
	});
				...
				if (!gutter) {
					...
					return author$project$Panel$EditorGroup$RowThree(
						_Utils_update(
							rec,
							{
								G: A2(elm$core$Basics$max, 100, (rec.h + rec.G) - leftWidth),
								h: leftWidth
							}));
				} else {
					...
					return author$project$Panel$EditorGroup$RowThree(
						_Utils_update(
							rec,
							{
								G: A2(elm$core$Basics$max, 100, leftWidth - rec.h),
...
var author$project$Model$openCommandPalette = function (_n0) {
	...
	return _Utils_update(
		rec,
		{
			L: author$project$Model$SubModeCommandPalette(author$project$Panel$CommandPalette$initModel)
		});
};
...
var author$project$Panel$Editor$EditorKeyConfig$initModel = {aM: 0, aF: elm$core$Maybe$Nothing};
...
var author$project$Model$toGutterMode = F2(
	function (gutter, _n0) {
		...
		return _Utils_update(
			rec,
			{
				L: author$project$Model$SubModeGutter(gutter)
			});
	});
...
var author$project$Panel$Tree$isTreeOpen = F2(
	function (projectRef, _n0) {
		var isProjectRootOpen = _n0.az;
		var isSourceOpen = _n0.aA;
		var isCoreOpen = _n0.ay;
		_n1$3:
		while (true) {
			if (!projectRef.$) {
				switch (projectRef.a.$) {
...
var author$project$NSvg$polygon = F3(
	function (points, strokeStyle, fillStyle) {
		return author$project$NSvg$Polygon(
			{U: elm$core$Maybe$Nothing, y: fillStyle, aj: points, u: strokeStyle});
	});
...
var author$project$NSvg$rect = F3(
	function (_n0, strokeStyle, fillStyle) {
		...
		return author$project$NSvg$Rect(
			{U: elm$core$Maybe$Nothing, y: fillStyle, bQ: height, u: strokeStyle, b8: width, ca: 0, cb: 0});
	});
		...
		switch (nSvgElement.$) {
			...
			default:
				...
				return author$project$NSvg$Line(
					_Utils_update(
						rec,
						{ap: rec.ap + x, aq: rec.aq + x, ar: rec.ar + y, as: rec.as + y}));
		}
	});
...
var author$project$NSvg$circle = F3(
	function (r, strokeStyle, fillStyle) {
		return author$project$NSvg$Circle(
			{au: 0, av: 0, y: fillStyle, bq: r, u: strokeStyle});
	});
...
var author$project$NSvg$strokeStyleToSvgAttributes = function (strokeStyle) {
	if (!strokeStyle.$) {
		...
		var strokeLineJoin = strokeStyle.a.aG;
		return _Utils_ap(
			_List_fromArray(
				[
	...
	switch (nSvgElement.$) {
		case 0:
			...
			return A2(
				...
				_List_Nil);
		case 1:
			var cx = nSvgElement.a.au;
			var cy = nSvgElement.a.av;
			var r = nSvgElement.a.bq;
			var strokeStyle = nSvgElement.a.u;
			var fillStyle = nSvgElement.a.y;
			return A2(
				elm$svg$Svg$circle,
		...
		case 3:
			...
			return A2(
				...
				_List_Nil);
		default:
			var x0 = nSvgElement.a.ap;
			var y0 = nSvgElement.a.ar;
			var x1 = nSvgElement.a.aq;
			var y1 = nSvgElement.a.as;
			var strokeStyle = nSvgElement.a.u;
			return A2(
				elm$svg$Svg$line,
				_Utils_ap(
...
var author$project$NSvg$polygonWithClickEvent = F4(
	function (points, strokeStyle, fillStyle, cliskMsg) {
		return author$project$NSvg$Polygon(
			{
				U: elm$core$Maybe$Just(cliskMsg),
				y: fillStyle,
				aj: points,
				u: strokeStyle
			});
...
var author$project$NSvg$rectWithClickEvent = F4(
	function (_n0, strokeStyle, fillStyle, clickMsg) {
		...
		return author$project$NSvg$Rect(
			{
				U: elm$core$Maybe$Just(clickMsg),
				y: fillStyle,
				bQ: height,
				u: strokeStyle,
				b8: width,
...
var author$project$NSvg$line = F3(
	function (_n0, _n1, strokeStyle) {
		...
		var y1 = _n1.b;
		return author$project$NSvg$Line(
			{u: strokeStyle, ap: x0, aq: x1, ar: y0, as: y1});
	});
...
var author$project$Panel$Editor$EditorKeyConfig$view = function (_n0) {
	var selectedKey = _n0.aF;
	var inputDevice = _n0.aM;
	return {
		bD: _List_fromArray(
			[
				A2(
...
var author$project$Panel$EditorGroup$view = F5(
	function (project, _n0, isFocus, gutter, _n1) {
		...
		var height = _n0.bQ;
		var group = _n1.ax;
		var activeEditorIndex = _n1.at;
		var mouseOverOpenEditorPosition = _n1.aD;
		return _Utils_ap(
			function () {
				switch (group.$) {
					case 0:
...
var author$project$Panel$Tree$view = function (_n0) {
	...
	return (100 < width) ? _Utils_ap(
		...
		A2(
			...
			{j: editorRef, aw: focus, aU: project, b8: width},
			model)) : _List_Nil;
};
			...
			author$project$Panel$Tree$view(
				{
					...
					aw: author$project$Model$isFocusTreePanel(model),
