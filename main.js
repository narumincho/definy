...
{
	if (region.bb.an === region.br.an)
	{
		return 'on line ' + region.bb.an;
	}
	return 'on lines ' + region.bb.an + ' through ' + region.br.an;
}
...
var author$project$Compiler$SafeExprToNoOp$convertLoop = function (_n0) {
	...
	while (true) {
		var left = _n0.S;
		var centerOp = _n0.Q;
		var leftCandidate = _n0.aO;
		var right = _n0.U;
		if (!right.b) {
			return {Q: centerOp, S: left, U: leftCandidate};
		} else {
			var _n2 = right.a;
			var op = _n2.a;
			var term = _n2.b;
			...
			if (A2(
				...
				var $temp$_n0 = {
					...
					aO: A2(author$project$Compiler$SafeExpr$SafeExpr, term, _List_Nil),
					U: xs
				};
				_n0 = $temp$_n0;
	...
	if (!_n0.$) {
		...
		if (!_n1.$) {
			...
			return author$project$Compiler$Success(
				{
					bl: author$project$Compiler$OptToBinary$convert(opt),
					a1: noOp,
					by: opt
				});
		} else {
			...
			return A2(
				...
				function (compileResult) {
					return author$project$Model$ReceiveCompiledData(
						{bn: compileResult, b7: index, cg: moduleRef});
				},
				A2(
					elm$core$Task$andThen,
					function (def) {
...
var author$project$Panel$Editor$Module$initModel = function (moduleRef) {
	return {h: author$project$Panel$Editor$Module$ActiveNone, p: elm$core$Maybe$Nothing, r: moduleRef};
};
...
var author$project$Project$Source$Module$Def$Expr$Add = 8;
...
var author$project$Project$Source$ModuleWithCache$DefAndResult = elm$core$Basics$identity;
...
var author$project$Project$Source$ModuleWithCache$make = function (_n0) {
	...
	return {
		D: A2(
			elm$core$List$map,
			function (def) {
				return {bn: elm$core$Maybe$Nothing, ak: def, am: elm$core$Maybe$Nothing};
			},
...
var author$project$Project$Source$init = {
	aT: author$project$Project$Source$ModuleWithCache$make(
		{
			aV: _List_fromArray(
				[
					author$project$Project$Source$Module$Def$make(
					{
						aX: author$project$Project$Source$Module$Def$Expr$empty,
						a0: author$project$Project$Source$Module$Def$Name$fromLabel(
							A2(
								author$project$Project$Label$make,
								author$project$Project$Label$ha,
								_List_fromArray(
									[author$project$Project$Label$ob, author$project$Project$Label$os]))),
						bg: author$project$Project$Source$Module$Def$Type$empty
					})
				]),
			a0: A2(
				author$project$Project$Label$make,
			...
			a6: 'プログラムに最低限必要なものが含まれている標準ライブラリ。足し算引き算、論理演算などの演算や、リスト、辞書、集合などの基本データ構造を含む'
		}),
	aU: author$project$Project$Source$ModuleWithCache$make(
		{
			aV: _List_fromArray(
				[
					author$project$Project$Source$Module$Def$make(
					{
						...
						bg: author$project$Project$Source$Module$Def$Type$int
					}),
					author$project$Project$Source$Module$Def$make(
					{
						aX: author$project$Project$Source$Module$Def$Expr$empty,
			...
			a6: 'WebAssemblyでサポートされている32bit符号付き整数を扱えるようになる'
		}),
	a8: author$project$Project$Source$ModuleWithCache$make(
		{
			aV: _List_fromArray(
				[
					author$project$Project$Source$Module$Def$make(
			...
			a0: author$project$Project$Source$sampleModuleName,
			a6: ''
		})
};
var author$project$Project$init = {bk: author$project$Project$projectAuthor, bX: author$project$Project$Config$init, bY: author$project$Project$Document$init, a0: author$project$Project$projectName, ba: author$project$Project$Source$init};
var author$project$Model$initModel = {
	aW: author$project$Panel$EditorGroup$initModel,
	aG: 1,
	ap: _List_Nil,
	a5: author$project$Project$init,
	N: author$project$Model$SubModeNone,
	be: author$project$Panel$Tree$initModel,
	bf: 250,
	bh: {b4: 0, cr: 0}
};
...
var author$project$Key$fromKeyAndCodeAndModifierKeys = F5(
	function (keyString, codeString, ctrl, shift, alt) {
		...
		if (!_n0.$) {
			var key = _n0.a;
			return elm$core$Maybe$Just(
				{bj: alt, bo: ctrl, bw: key, bM: shift});
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bt: fragment, bv: host, bA: path, bC: port_, bF: protocol, bG: query};
	});
	...
	return A3(
		...
		A2(
			...
			A2(
				elm$json$Json$Decode$field,
				'target',
				A2(elm$json$Json$Decode$field, info.b5, elm$json$Json$Decode$bool))));
};
...
var author$project$Panel$Editor$Module$ConfirmMultiLineTextField = {$: 12};
var author$project$Panel$Editor$Module$ConfirmSingleLineTextFieldOrSelectParent = {$: 14};
...
var author$project$KeyConfig$moduleEditorKeyMsg = function (_n0) {
	var key = _n0.bw;
	var ctrl = _n0.bo;
	var shift = _n0.bM;
	var alt = _n0.bj;
...
var author$project$KeyConfig$editorGroupPanelKeyDown = function (key) {
	return A2(
		elm$core$List$map,
		...
		author$project$KeyConfig$moduleEditorKeyMsg(key));
};
...
var author$project$Model$getEditorGroupPanelModel = function (_n0) {
	var editorGroupPanelModel = _n0.aW;
...
var author$project$Project$Source$Module$Def$empty = {aX: author$project$Project$Source$Module$Def$Expr$empty, a0: author$project$Project$Source$Module$Def$Name$noName, bg: author$project$Project$Source$Module$Def$Type$empty};
var author$project$Project$Source$ModuleWithCache$addDef = F2(
	function (def, _n0) {
		...
		return _Utils_update(
			rec,
			{
				D: (65535 <= elm$core$List$length(rec.D)) ? A2(elm$core$List$take, 65535, rec.D) : _Utils_ap(
					rec.D,
					_List_fromArray(
						[
							{bn: elm$core$Maybe$Nothing, ak: def, am: elm$core$Maybe$Nothing}
						]))
			});
	});
...
var author$project$Panel$Editor$Module$BlurThisEditor = {$: 17};
...
var author$project$Panel$Editor$Module$ConfirmSingleLineTextField = {$: 13};
	...
	function (active, _n0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					h: active,
					p: _Utils_eq(rec.h, active) ? rec.p : elm$core$Maybe$Nothing
				}),
			function () {
				switch (active.$) {
					case 0:
...
var author$project$Panel$Editor$Module$EditStateText = {$: 0};
...
var author$project$Panel$Editor$Module$ActivePartDefName = {$: 1};
var author$project$Panel$Editor$Module$ActivePartDefType = {$: 2};
...
var author$project$Panel$Editor$Module$TypeNoChildren = {$: 0};
...
var author$project$Project$Source$Module$Def$Expr$And = 2;
var author$project$Project$Source$Module$Def$Expr$Compose = 13;
var author$project$Project$Source$Module$Def$Expr$Concat = 7;
var author$project$Project$Source$Module$Def$Expr$Div = 11;
var author$project$Project$Source$Module$Def$Expr$Equal = 3;
var author$project$Project$Source$Module$Def$Expr$Factorial = 12;
var author$project$Project$Source$Module$Def$Expr$LessThan = 5;
var author$project$Project$Source$Module$Def$Expr$LessThanOrEqual = 6;
var author$project$Project$Source$Module$Def$Expr$Mul = 10;
var author$project$Project$Source$Module$Def$Expr$NotEqual = 4;
var author$project$Project$Source$Module$Def$Expr$Or = 1;
var author$project$Project$Source$Module$Def$Expr$Pipe = 0;
var author$project$Project$Source$Module$Def$Expr$Sub = 9;
...
var author$project$Parser$Expr$parseResultAddTermOrOpList = F2(
	function (list, parseResult) {
		if (!parseResult.$) {
			...
			var termOrOpList = parseResult.a.f;
			var textAreaValue = parseResult.a.w;
			return author$project$Parser$Expr$End(
				{
					f: _Utils_ap(list, termOrOpList),
					w: textAreaValue
...
var author$project$Parser$Expr$termOrOpListToParseTermResultNeedOp = function (termOrOpList) {
	if (termOrOpList.b) {
		...
		return {g: elm$core$Maybe$Nothing, z: _List_Nil};
	}
};
	...
	if (list.b) {
		if (!list.a.$) {
			...
			return author$project$Parser$Expr$concatParseTermResult(
				{y: term, g: lastMaybe, z: others, w: textAreaValue});
		} else {
			var op = list.a.a;
			var listOthers = list.b;
			...
			return author$project$Parser$Expr$concatParseTermResult(
				{
					y: A3(author$project$Parser$Expr$TermWithParenthesis, 0, author$project$Project$Source$Module$Def$Expr$None, 0),
					g: lastMaybe,
					z: others,
					w: textAreaValue
				});
		...
		while (true) {
			if (rest.b) {
						...
						if (rest.a.a === 16) {
							...
							if (!label.$) {
								...
								return author$project$Parser$Type$TypeToExpr(
									{
										bK: others,
										bg: author$project$Project$Source$Module$Def$Type$fromLabel(l)
									});
							} else {
								return author$project$Parser$Type$TypeToExpr(
									{bK: others, bg: author$project$Project$Source$Module$Def$Type$empty});
							}
						} else {
							var _n5 = rest.a;
							var _char = _n5.b;
				...
				if (!label.$) {
					...
					return author$project$Parser$Type$TypeEnd(
						{w: textAreaValue, bg: author$project$Project$Source$Module$Def$Type$empty});
				}
			}
		}
	});
var author$project$Parser$Type$parse = function (list) {
	...
	while (true) {
		if (list.b) {
			...
			return author$project$Parser$Type$TypeEnd(
				{w: _List_Nil, bg: author$project$Project$Source$Module$Def$Type$empty});
		}
	}
};
var author$project$Parser$beginWithName = function (list) {
	...
	switch (_n0.$) {
		...
		case 1:
			...
			if (!_n1.$) {
				var type_ = _n1.a.bg;
				var textAreaValue = _n1.a.w;
				return author$project$Parser$BeginWithNameEndType(
					{a0: name, w: textAreaValue, bg: type_});
			} else {
				var type_ = _n1.a.bg;
				var rest = _n1.a.bK;
				...
				return author$project$Project$Source$Module$Def$Type$isEmpty(type_) ? _Utils_Tuple2(
					...
					_List_fromArray(
						[
							...
							{b7: index, cg: moduleRef, bg: type_}),
						...
						_Utils_ap(
							...
							_List_fromArray(
								[
									...
									{
										aX: A2(author$project$Project$Source$Module$Def$Expr$make, headTerm, opAndTermList),
										b7: index,
										cg: moduleRef
									})
								]))));
	...
	if (list.b) {
		if (!list.a.$) {
			...
			return author$project$Parser$Expr$concatParseOpResult(
				{y: 15, g: lastMaybe, z: others, w: textAreaValue});
		} else {
			var op = list.a.a;
			var listOthers = list.b;
			...
			var lastMaybe = _n3.g;
			return author$project$Parser$Expr$concatParseOpResult(
				{y: op, g: lastMaybe, z: others, w: textAreaValue});
		}
	} else {
		return author$project$Parser$Expr$OpLastOp(
			{y: 15, z: _List_Nil, w: textAreaValue});
	}
};
	...
	function (parenthesisLevel, list) {
		...
		if (_n0.$ === 1) {
			...
			return author$project$Parser$BeginWithOpEndTerm(
				{
					bu: head,
					b9: author$project$Parser$Expr$takeTerm(last),
					bP: author$project$Parser$Expr$takeTermListTO(others),
					w: textAreaValue
				});
		} else {
			var head = _n0.a.y;
...
var author$project$Project$Source$Module$Def$Expr$replaceAndInsertOpLastTerm = F5(
	function (index, op, termOpList, lastTerm, expr) {
		...
		var replaceAndInsertElement = function () {
			...
			if (_n0.$ === 1) {
				return {
					aa: _Utils_eq(targetTerm, author$project$Project$Source$Module$Def$Expr$None) ? _List_Nil : _List_fromArray(
						[
							_Utils_Tuple2(15, targetTerm)
						]),
					ae: _Utils_Tuple2(op, lastTerm)
				};
			} else {
				var _n1 = _n0.a;
				var _n2 = _n1.a;
...
var author$project$Panel$Editor$Module$parserBeginWithOp = F5(
	function (string, index, moduleRef, opIndex, expr) {
		...
		if (!_n0.$) {
			var headOp = _n0.a.bu;
			var termAndOpList = _n0.a.bP;
			var lastTerm = _n0.a.b9;
			var textAreaValue = _n0.a.w;
			return _Utils_Tuple2(
				author$project$Panel$Editor$Module$ActivePartDefList(
					author$project$Panel$Editor$Module$ActivePartDef(
				...
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$EmitChangeExpr(
						{
							aX: A5(author$project$Project$Source$Module$Def$Expr$replaceAndInsertOpLastTerm, opIndex, headOp, termAndOpList, lastTerm, expr),
							b7: index,
							cg: moduleRef
						}),
						author$project$Panel$Editor$Module$textAreaValueToSetTextEmit(textAreaValue)
				...
				_Utils_ap(
					_List_fromArray(
						[
							author$project$Panel$Editor$Module$EmitChangeExpr(
							{
								aX: A4(author$project$Project$Source$Module$Def$Expr$replaceAndInsertOpLastOp, opIndex, headOp, termAndOpList, expr),
								b7: index,
								cg: moduleRef
							})
						]),
				...
				_Utils_ap(
					_List_fromArray(
						[
							author$project$Panel$Editor$Module$EmitChangeExpr(
							{
								aX: ((!termIndex) ? A2(author$project$Project$Source$Module$Def$Expr$replaceAndInsertHeadLastTerm, headTerm, opAndTermList) : A3(author$project$Project$Source$Module$Def$Expr$replaceAndInsertTermLastTerm, termIndex - 1, headTerm, opAndTermList))(expr),
								b7: index,
								cg: moduleRef
							})
						]),
			...
			return _Utils_Tuple2(
				...
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$EmitChangeExpr(
						{
							aX: ((!termIndex) ? A3(author$project$Project$Source$Module$Def$Expr$replaceAndInsertHeadLastOp, headTerm, opAndTermList, lastOp) : A4(author$project$Project$Source$Module$Def$Expr$replaceAndInsertTermLastOp, termIndex, headTerm, opAndTermList, lastOp))(expr),
							b7: index,
							cg: moduleRef
						}),
						author$project$Panel$Editor$Module$textAreaValueToSetTextEmit(textAreaValue)
							...
							case 1:
								...
								return _Utils_Tuple2(
									_Utils_update(
										...
										{
											h: active,
											p: elm$core$Maybe$Just(author$project$Panel$Editor$Module$EditStateText)
										}),
									_Utils_ap(
										emitList,
										_List_fromArray(
...
var author$project$Panel$Editor$Module$SectionHead = {$: 1};
var author$project$Panel$Editor$Module$SectionSelf = {$: 0};
...
var author$project$Panel$Editor$Module$lambdaPosParent = function (lambdaPos) {
	switch (lambdaPos.$) {
		...
		default:
			...
			return A2(
				elm$core$Maybe$map,
				author$project$Panel$Editor$Module$Section(index),
				author$project$Panel$Editor$Module$sectionPosParent(sectionPos));
	}
};
var author$project$Panel$Editor$Module$sectionPosParent = function (sectionPos) {
	switch (sectionPos.$) {
		case 0:
			return elm$core$Maybe$Nothing;
		case 1:
		...
		default:
			var termOpPos = sectionPos.a;
			var _n4 = author$project$Panel$Editor$Module$termOpPosParent(termOpPos);
			if (!_n4.$) {
				var movedTermOpPos = _n4.a;
				return elm$core$Maybe$Just(
					author$project$Panel$Editor$Module$Expr(movedTermOpPos));
			} else {
				return elm$core$Maybe$Just(author$project$Panel$Editor$Module$SectionSelf);
					...
					if (active.a.$ === 1) {
						switch (active.a.a.b.$) {
							...
							default:
								...
								var _n9 = author$project$Panel$Editor$Module$termOpPosParent(termOpPos);
								if (!_n9.$) {
						...
						default:
							if (!active.a.a.b.a.$) {
								...
								var exprMaybe = A2(
									...
									author$project$Project$Source$Module$Def$getExpr,
									A2(author$project$Project$Source$ModuleWithCache$getDef, index, module_));
								var _n12 = A2(author$project$Panel$Editor$Module$termOpPosRight, exprMaybe, termOpPos);
								if (!_n12.$) {
									var movedTermOpPos = _n12.a;
									return author$project$Panel$Editor$Module$ActivePartDefList(
										author$project$Panel$Editor$Module$ActivePartDef(
											_Utils_Tuple2(
												index,
	...
	function (suggestIndex, defIndex, moduleRef) {
		...
		if (!_n0.$) {
			...
			return _List_fromArray(
				[
					author$project$Panel$Editor$Module$EmitChangeName(
					{b7: defIndex, a0: suggestName, cg: moduleRef})
				]);
		} else {
			return _List_Nil;
		}
...
var author$project$Panel$Editor$Module$suggestionPrevOrSelectDown = F3(
	function (module_, project, _n10) {
		var rec = _n10;
		var _n11 = rec.p;
		if (!_n11.$) {
			if (_n11.a.$ === 1) {
				var suggestIndex = _n11.a.a.V;
				var searchText = _n11.a.a.ar;
				return _Utils_Tuple2(
					_Utils_update(
						rec,
						{
							p: elm$core$Maybe$Just(
								author$project$Panel$Editor$Module$EditStateSelect(
									{ar: searchText, V: suggestIndex + 1}))
						}),
					function () {
						var _n12 = rec.h;
						if (((_n12.$ === 2) && (_n12.a.$ === 1)) && (_n12.a.a.b.$ === 1)) {
							var _n13 = _n12.a.a;
							var index = _n13.a;
							var _n14 = _n13.b;
							return A3(author$project$Panel$Editor$Module$suggestionSelectChangedThenNameChangeEmit, suggestIndex, index, rec.r);
						} else {
							return _List_Nil;
						}
					}());
				...
				return _Utils_Tuple2(
					...
					function () {
						var _n16 = rec.h;
						if (((_n16.$ === 2) && (_n16.a.$ === 1)) && (_n16.a.a.b.$ === 1)) {
							var _n17 = _n16.a.a;
							var index = _n17.a;
							var _n18 = _n17.b;
							return A3(author$project$Panel$Editor$Module$suggestionSelectChangedThenNameChangeEmit, 1, index, rec.r);
						} else {
							return _List_Nil;
						}
					}());
			...
			return A3(author$project$Panel$Editor$Module$update, author$project$Panel$Editor$Module$SelectDown, project, rec);
		}
	});
var author$project$Panel$Editor$Module$suggestionPrevOrSelectUp = F3(
	function (module_, project, _n5) {
		var rec = _n5;
		var _n6 = rec.p;
		if ((!_n6.$) && (_n6.a.$ === 1)) {
			var suggestIndex = _n6.a.a.V;
			var searchText = _n6.a.a.ar;
			return _Utils_Tuple2(
				_Utils_update(
					rec,
					{
						p: elm$core$Maybe$Just(
							author$project$Panel$Editor$Module$EditStateSelect(
								{
									ar: searchText,
									V: A2(elm$core$Basics$max, 0, suggestIndex - 1)
								}))
					}),
				function () {
					var _n7 = rec.h;
					if (((_n7.$ === 2) && (_n7.a.$ === 1)) && (_n7.a.a.b.$ === 1)) {
						var _n8 = _n7.a.a;
						var index = _n8.a;
						var _n9 = _n8.b;
						return A3(author$project$Panel$Editor$Module$suggestionSelectChangedThenNameChangeEmit, suggestIndex, index, rec.r);
			...
			return A3(author$project$Panel$Editor$Module$update, author$project$Panel$Editor$Module$SelectUp, project, rec);
		}
	});
	...
	function (msg, project, _n0) {
		...
		while (true) {
			...
			switch (msg.$) {
				case 0:
					var active = msg.a;
					return A2(author$project$Panel$Editor$Module$activeTo, active, rec);
				case 1:
					var $temp$msg = author$project$Panel$Editor$Module$ActiveTo(
						A2(author$project$Panel$Editor$Module$selectLeft, targetModule, rec.h)),
				...
				case 2:
					var $temp$msg = author$project$Panel$Editor$Module$ActiveTo(
						A2(author$project$Panel$Editor$Module$selectRight, targetModule, rec.h)),
						$temp$project = project,
						$temp$_n0 = rec;
					msg = $temp$msg;
					project = $temp$project;
				...
				case 3:
					var $temp$msg = author$project$Panel$Editor$Module$ActiveTo(
						A2(author$project$Panel$Editor$Module$selectUp, targetModule, rec.h)),
						$temp$project = project,
						$temp$_n0 = rec;
					msg = $temp$msg;
					project = $temp$project;
				...
				case 4:
					var $temp$msg = author$project$Panel$Editor$Module$ActiveTo(
						A2(author$project$Panel$Editor$Module$selectDown, targetModule, rec.h)),
						$temp$project = project,
						$temp$_n0 = rec;
					msg = $temp$msg;
					project = $temp$project;
				...
				case 5:
					var $temp$msg = author$project$Panel$Editor$Module$ActiveTo(
						A2(author$project$Panel$Editor$Module$selectFirstChild, targetModule, rec.h)),
						$temp$project = project,
						$temp$_n0 = rec;
					msg = $temp$msg;
					project = $temp$project;
				...
				case 6:
					var $temp$msg = author$project$Panel$Editor$Module$ActiveTo(
						A2(author$project$Panel$Editor$Module$selectLastChild, targetModule, rec.h)),
						$temp$project = project,
						$temp$_n0 = rec;
					msg = $temp$msg;
					project = $temp$project;
				...
				case 7:
					var $temp$msg = author$project$Panel$Editor$Module$ActiveTo(
						A2(author$project$Panel$Editor$Module$selectParent, targetModule, rec.h)),
						$temp$project = project,
						$temp$_n0 = rec;
					msg = $temp$msg;
					project = $temp$project;
					...
					continue update;
				case 9:
					return A3(author$project$Panel$Editor$Module$suggestionPrevOrSelectUp, targetModule, project, rec);
				case 8:
					return A3(author$project$Panel$Editor$Module$suggestionPrevOrSelectDown, targetModule, project, rec);
				case 10:
					var string = msg.a;
					return A3(author$project$Panel$Editor$Module$input, string, targetModule, rec);
				case 11:
					return _Utils_Tuple2(rec, _List_Nil);
				case 12:
					var $temp$msg = author$project$Panel$Editor$Module$ActiveTo(
						author$project$Panel$Editor$Module$confirmMultiLineTextField(rec.h)),
						$temp$project = project,
						$temp$_n0 = rec;
					msg = $temp$msg;
					project = $temp$project;
				...
				case 14:
					var _n2 = rec.p;
					if (!_n2.$) {
						var $temp$msg = author$project$Panel$Editor$Module$ConfirmSingleLineTextField,
							$temp$project = project,
							$temp$_n0 = rec;
						msg = $temp$msg;
						project = $temp$project;
						...
						var $temp$msg = author$project$Panel$Editor$Module$SelectParent,
							$temp$project = project,
							$temp$_n0 = rec;
						msg = $temp$msg;
						project = $temp$project;
...
var author$project$Panel$EditorGroup$EmitFocusEditTextAea = {$: 4};
...
var author$project$Panel$Editor$Module$FocusThisEditor = {$: 16};
...
var author$project$Panel$EditorGroup$mouseOverAddGutter = F2(
	function (openEditorPosition, _n0) {
		...
		return _Utils_update(
			rec,
			{
				aP: elm$core$Maybe$Just(openEditorPosition)
			});
	});
		...
		switch (msg.$) {
			...
			case 5:
				...
				return _Utils_Tuple2(
					A2(
						author$project$Panel$EditorGroup$mapGroup,
						A2(author$project$Panel$EditorGroup$setEditorItem, rec.cg, newEditorItem),
						model),
					emit);
			case 6:
...
var author$project$Panel$EditorGroup$resizeFromHorizontalGutter = F3(
	function (_n0, gutter, model) {
		var mouseRelY = _n0.cc;
		var editorHeight = _n0.bZ;
		return A2(
			author$project$Panel$EditorGroup$mapGroup,
			A2(
				author$project$Panel$EditorGroup$resizeHorizontal,
				{b4: editorHeight, cu: mouseRelY},
				gutter),
			model);
	});
				...
				if (!gutter) {
					return author$project$Panel$EditorGroup$RowTwo(
						_Utils_update(
							rec,
							{
								j: A3(elm$core$Basics$clamp, 100, 900, (((x * 1002) / width) | 0) - 1)
							}));
				} else {
					return group;
				}
				...
				if (!gutter) {
					...
					return author$project$Panel$EditorGroup$RowThree(
						_Utils_update(
							rec,
							{
								I: A2(elm$core$Basics$max, 100, (rec.j + rec.I) - leftWidth),
								j: leftWidth
							}));
				} else {
					...
					return author$project$Panel$EditorGroup$RowThree(
						_Utils_update(
							rec,
							{
								I: A2(elm$core$Basics$max, 100, leftWidth - rec.j),
								j: ((leftWidth - rec.j) < 100) ? (leftWidth - 100) : rec.j
							}));
				}
		}
	});
var author$project$Panel$EditorGroup$resizeFromVerticalGutter = F3(
	function (_n0, gutter, model) {
		var mouseRelX = _n0.cb;
		var editorWidth = _n0.b_;
		return A2(
			author$project$Panel$EditorGroup$mapGroup,
			A2(
				author$project$Panel$EditorGroup$resizeVertical,
				{cr: editorWidth, ct: mouseRelX},
				gutter),
			model);
	});
				...
				case 0:
					...
					return A2(
						...
						A2(
							...
							author$project$Model$getWindowSize(model).cr,
							x),
						model);
				case 1:
					var gutter = _n1.a.a;
					return A2(
						...
						A2(
							...
							{
								b_: author$project$Model$getWindowSize(model).cr - author$project$Model$getTreePanelWidth(model),
								cb: A2(
									elm$core$Basics$max,
									0,
				...
				default:
					...
					return A2(
						...
						A2(
							...
							{
								bZ: author$project$Model$getWindowSize(model).b4,
								cc: A2(elm$core$Basics$max, 0, y)
							},
							gutter),
						model);
			}
...
var author$project$Panel$Editor$EditorKeyConfig$initModel = {aZ: 0, aR: elm$core$Maybe$Nothing};
...
var author$project$Project$Source$ModuleWithCache$defAndResultSetCompileResult = F2(
	function (compileResult, _n0) {
		...
		return _Utils_update(
			rec,
			{
				bn: elm$core$Maybe$Just(compileResult)
			});
	});
			...
			function () {
				...
				if (!_n1.$) {
					...
					return elm$core$Maybe$Just(
						{
							b7: index,
							cg: author$project$Project$moduleRefToListInt(ref),
							cq: wasm
						});
				} else {
					return elm$core$Maybe$Nothing;
...
var author$project$Project$Source$ModuleWithCache$defAndResultSetEvalResult = F2(
	function (evalResult, _n0) {
		...
		return _Utils_update(
			rec,
			{
				am: elm$core$Maybe$Just(evalResult)
			});
	});
...
var author$project$Panel$Tree$getOpenCloseData = function (_n0) {
	var openCloseData = _n0.a3;
	return openCloseData;
};
var author$project$Panel$Tree$isTreeOpen = F2(
	function (projectRef, _n0) {
		var isProjectRootOpen = _n0.aL;
		var isSourceOpen = _n0.aM;
		var isCoreOpen = _n0.aJ;
		_n1$3:
		while (true) {
			if (!projectRef.$) {
				switch (projectRef.a.$) {
...
var author$project$NSvg$polygon = F3(
	function (points, strokeStyle, fillStyle) {
		return author$project$NSvg$Polygon(
			{X: elm$core$Maybe$Nothing, B: fillStyle, aq: points, v: strokeStyle});
	});
...
var author$project$NSvg$rect = F3(
	function (_n0, strokeStyle, fillStyle) {
		...
		return author$project$NSvg$Rect(
			{X: elm$core$Maybe$Nothing, B: fillStyle, b4: height, v: strokeStyle, cr: width, ct: 0, cu: 0});
	});
		...
		switch (nSvgElement.$) {
			...
			default:
				...
				return author$project$NSvg$Line(
					_Utils_update(
						rec,
						{ax: rec.ax + x, ay: rec.ay + x, az: rec.az + y, aA: rec.aA + y}));
		}
	});
...
var author$project$NSvg$circle = F3(
	function (r, strokeStyle, fillStyle) {
		return author$project$NSvg$Circle(
			{aC: 0, aD: 0, B: fillStyle, bH: r, v: strokeStyle});
	});
		...
		[
			...
			m: _List_fromArray(
				[
					{
					m: _List_Nil,
					k: author$project$Panel$EditorTypeRef$EditorProject(author$project$Project$Document),
					t: author$project$Panel$Tree$documentIcon,
					u: 'Document'
				},
					{
					m: _List_Nil,
					k: author$project$Panel$EditorTypeRef$EditorProject(author$project$Project$Config),
					t: author$project$Panel$Tree$configIcon,
					u: 'Default IO Config'
				},
					{
					m: _List_fromArray(
						[
							{
							m: _List_Nil,
							k: author$project$Panel$EditorTypeRef$EditorProject(
								author$project$Project$Module(2)),
							t: author$project$Panel$Tree$moduleIcon,
							u: 'SampleModule'
						},
							{
							m: _List_fromArray(
					...
					k: author$project$Panel$EditorTypeRef$EditorProject(author$project$Project$Source),
					t: author$project$Panel$Tree$sourceIcon,
					u: 'Source'
				}
				]),
			k: author$project$Panel$EditorTypeRef$EditorProject(author$project$Project$ProjectRoot),
			t: author$project$Panel$Tree$defaultProjectIcon,
			u: author$project$Project$Label$toSmallString(
			...
			{m: _List_Nil, k: author$project$Panel$EditorTypeRef$EditorKeyConfig, t: author$project$Panel$Tree$moduleIcon, u: 'Editor Key Config'}
		]);
};
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'ref',
					elm$json$Json$Encode$list(elm$json$Json$Encode$int)($.cg)),
					_Utils_Tuple2(
					'wasm',
					elm$json$Json$Encode$list(elm$json$Json$Encode$int)($.cq))
				]));
	});
...
var author$project$Model$getEditorGroupPanelSize = function (model) {
	return {
		b4: author$project$Model$getWindowSize(model).b4,
		cr: author$project$Model$getWindowSize(model).cr - (author$project$Model$getTreePanelWidth(model) + author$project$Model$verticalGutterWidth)
	};
};
...
var author$project$NSvg$strokeStyleToSvgAttributes = function (strokeStyle) {
	if (!strokeStyle.$) {
		...
		var width = strokeStyle.a.cr;
		var strokeLineJoin = strokeStyle.a.aS;
		return _Utils_ap(
			_List_fromArray(
				[
...
var author$project$NSvg$elementToSvg = function (nSvgElement) {
	switch (nSvgElement.$) {
		case 0:
			var x = nSvgElement.a.ct;
			var y = nSvgElement.a.cu;
			var width = nSvgElement.a.cr;
			var height = nSvgElement.a.b4;
		...
		case 2:
			...
			return A2(
				...
				_List_Nil);
		case 3:
			var d = nSvgElement.a.bp;
			var strokeStyle = nSvgElement.a.v;
			var fillStyle = nSvgElement.a.B;
			var offset = nSvgElement.a.aQ;
			return A2(
				elm$svg$Svg$path,
				_Utils_ap(
					_List_fromArray(
				...
				_List_Nil);
		default:
			var x0 = nSvgElement.a.ax;
			var y0 = nSvgElement.a.az;
			var x1 = nSvgElement.a.ay;
			var y1 = nSvgElement.a.aA;
			var strokeStyle = nSvgElement.a.v;
			return A2(
				elm$svg$Svg$line,
				_Utils_ap(
...
var author$project$NSvg$line = F3(
	function (_n0, _n1, strokeStyle) {
		...
		var y1 = _n1.b;
		return author$project$NSvg$Line(
			{v: strokeStyle, ax: x0, ay: x1, az: y0, aA: y1});
	});
...
var author$project$Panel$Editor$EditorKeyConfig$selectFrame = function (oneKey) {
	...
	return A2(
		author$project$NSvg$translate,
		{ct: shapeData.a.a * 100, cu: shapeData.a.b * 100},
		A3(
...
var author$project$Panel$Editor$EditorKeyConfig$view = function (_n0) {
	var selectedKey = _n0.aR;
	var inputDevice = _n0.aZ;
	return {
		bU: _List_fromArray(
			[
				A2(
	...
	function (description, isFocus, descriptionActiveMaybe) {
		...
		return A2(
			...
			_Utils_ap(
				...
				function () {
					if ((!descriptionActiveMaybe.$) && (!descriptionActiveMaybe.a)) {
						var _n1 = descriptionActiveMaybe.a;
						return _List_Nil;
					} else {
						return _List_fromArray(
...
var author$project$Panel$Editor$Module$AddPartDef = {$: 15};
		...
		if (!editStateMaybeMaybe.$) {
			if (!editStateMaybeMaybe.a.$) {
				if (!editStateMaybeMaybe.a.a.$) {
					...
					var suggestIndex = editStateMaybeMaybe.a.a.a.V;
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								author$project$Panel$Editor$Module$subClass('partDef-typeTextArea'),
								elm$html$Html$Attributes$id('edit'),
								elm$html$Html$Events$onInput(author$project$Panel$Editor$Module$DefInput)
							]),
						_List_Nil)),
...
var author$project$Panel$Editor$Module$partDefViewType = F2(
	function (type_, editStateMaybe) {
		if (!editStateMaybe.$) {
			if (!editStateMaybe.a.$) {
				if (!editStateMaybe.a.a.$) {
					var _n1 = editStateMaybe.a.a;
					return A2(author$project$Panel$Editor$Module$partDefTypeEditView, type_, 0);
				} else {
					var suggestIndex = editStateMaybe.a.a.a.V;
					return A2(author$project$Panel$Editor$Module$partDefTypeEditView, type_, suggestIndex);
				}
			} else {
				var _n2 = editStateMaybe.a;
...
var author$project$Project$Source$ModuleWithCache$defAndResultGetEvalResult = function (_n0) {
	var evalResult = _n0.am;
	return evalResult;
};
var author$project$Panel$Editor$Module$partDefView = F5(
	function (isFocus, index, defAndResult, partDefActiveMaybe, editSateMaybe) {
...
var author$project$Panel$Editor$Module$partDefListView = F4(
	function (isFocus, defAndResultList, partDefActiveWithIndexMaybe, editStateMaybe) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
...
var author$project$Panel$Editor$Module$view = F3(
	function (project, isFocus, _n0) {
		...
		return {
			...
			cl: author$project$Project$Label$toCapitalString(
...
var author$project$Panel$EditorGroup$editorItemView = function (_n0) {
						...
						elm$html$Html$map(
							function (m) {
								return author$project$Panel$EditorGroup$EditorItemMsg(
									{
										a$: author$project$Panel$EditorGroup$ModuleEditorMsg(m),
										cg: editorIndex
									});
							}),
						viewItem.bU),
					...
					bU: A2(
						...
						elm$html$Html$map(
							function (m) {
								return author$project$Panel$EditorGroup$EditorItemMsg(
									{
										a$: author$project$Panel$EditorGroup$EditorKeyConfigMsg(m),
										cg: editorIndex
									});
							}),
						viewItem.bU),
	...
	return A2(
		...
		_Utils_ap(
			_List_fromArray(
				[
					A3(author$project$Panel$EditorGroup$editorTitle, childItem.cl, editorIndex, isOne)
				]),
			childItem.bU));
};
					...
					return _List_fromArray(
						[
							...
							author$project$Panel$EditorGroup$editorItemView(
							{
								...
								aF: bottom,
								b4: (((height - 2) * (1000 - topHeight)) / 1000) | 0,
								aI: _Utils_eq(
									elm$core$Maybe$Just(1),
									activeEditorIndexColumnMaybe),
								aK: false,
...
var author$project$Panel$EditorGroup$view = F5(
	function (project, _n0, isFocus, gutter, _n1) {
		...
		var height = _n0.b4;
		var group = _n1.aH;
		var activeEditorIndex = _n1.aB;
		var mouseOverOpenEditorPosition = _n1.aP;
					...
					case 1:
						...
						return _List_fromArray(
							[
								...
								project,
								left,
								{b4: height, cr: (((width - 4) * leftWidth) / 1000) | 0},
								1,
								function () {
									if (!activeEditorRow) {
								...
								project,
								center,
								{b4: height, cr: (((width - 4) * (1000 - leftWidth)) / 1000) | 0},
								2,
								function () {
									if (!activeEditorRow) {
										return elm$core$Maybe$Nothing;
					...
					default:
						...
						return _List_fromArray(
							[
								...
								project,
								center,
								{b4: height, cr: (((width - 4) * centerWidth) / 1000) | 0},
								2,
								function () {
									switch (activeEditorRow) {
										case 0:
								...
								project,
								right,
								{b4: height, cr: (((width - 4) * ((1000 - leftWidth) - centerWidth)) / 1000) | 0},
								3,
								function () {
									switch (activeEditorRow) {
										case 0:
...
var author$project$Panel$Tree$view = function (_n0) {
	...
	return (100 < width) ? _Utils_ap(
		...
		A2(
			...
			{k: editorRef, aG: focus, a5: project, cr: width},
			model)) : _List_Nil;
};
	...
	return A2(
		...
		A2(
			...
			author$project$Panel$Tree$view(
				{
					k: author$project$Model$getActiveEditor(model),
					aG: author$project$Model$isFocusTreePanel(model),
					ca: author$project$Model$getTreePanelModel(model),
					a5: author$project$Model$getProject(model),
					cr: author$project$Model$getTreePanelWidth(model)
				})));
};
...
var author$project$View$view = function (model) {
	return {
		...
		cl: 'Definy 0 - ' + author$project$Project$Label$toCapitalString(
...
var author$project$Main$main = elm$browser$Browser$document(
	{b8: author$project$Main$init, cj: author$project$Main$subscriptions, cn: author$project$Update$update, cp: author$project$View$view});
