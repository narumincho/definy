...
var author$project$Compiler$SafeExprToNoOp$convertLoop = function (_n0) {
	...
	while (true) {
		var left = _n0.S;
		var centerOp = _n0.P;
		var leftCandidate = _n0.aP;
		var right = _n0.U;
		if (!right.b) {
			return {P: centerOp, S: left, U: leftCandidate};
		} else {
			var _n2 = right.a;
			var op = _n2.a;
			var term = _n2.b;
			...
			if (A2(
				...
				var $temp$_n0 = {
					P: op,
					S: A3(author$project$Compiler$SafeExpr$concat, left, centerOp, leftCandidate),
					aP: A2(author$project$Compiler$SafeExpr$SafeExpr, term, _List_Nil),
					U: xs
				};
				_n0 = $temp$_n0;
...
var author$project$Compiler$SafeExprToNoOp$convert = function (_n1) {
	...
	if (!others.b) {
		...
		var a = author$project$Compiler$SafeExprToNoOp$convertLoop(
			{
				P: op,
				S: A2(author$project$Compiler$SafeExpr$SafeExpr, head, _List_Nil),
				aP: A2(author$project$Compiler$SafeExpr$SafeExpr, term, _List_Nil),
				U: xs
			});
		return A3(
			author$project$Compiler$NoOp$Call2,
			author$project$Compiler$SafeExprToNoOp$opToNoOp(a.P),
	...
	if (!_n0.$) {
		...
		if (!_n1.$) {
			...
			return author$project$Compiler$Success(
				{
					bp: author$project$Compiler$OptToBinary$convert(opt),
					a3: noOp,
					bC: opt
				});
		} else {
			...
			return A2(
				...
				function (compileResult) {
					return author$project$Model$ProjectMsg(
						{
							a0: moduleRef,
							bA: A2(author$project$Project$Source$ModuleWithCache$MsgReceiveCompileResult, partDefIndex, compileResult)
						});
				},
				A2(
					elm$core$Task$andThen,
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'ref',
					elm$json$Json$Encode$list(elm$json$Json$Encode$int)($.aT)),
					_Utils_Tuple2(
					'wasm',
					elm$json$Json$Encode$list(elm$json$Json$Encode$int)($.bX))
				]));
	});
...
var author$project$Model$runCmd = F3(
	function (moduleRef, partDefIndex, wasm) {
		return author$project$Model$run(
			{
				aI: author$project$Project$Source$ModuleIndex$partDefIndexToInt(partDefIndex),
				aT: author$project$Project$SourceIndex$moduleIndexToListInt(moduleRef),
				bX: wasm
			});
	});
var author$project$Model$sourceEmitToMsgAndCmd = F2(
	function (source, emit) {
		var moduleIndex = emit.a0;
...
var author$project$Model$getTreePanelModel = function (_n0) {
	var treePanelModel = _n0.bi;
	return treePanelModel;
};
var author$project$Model$CloseCommandPalette = {$: 13};
var author$project$Model$FocusTo = function (a) {
	return {$: 7, a: a};
};
var author$project$Model$OpenCommandPalette = {$: 12};
...
var author$project$Panel$Editor$Module$ConfirmMultiLineTextField = {$: 14};
var author$project$Panel$Editor$Module$ConfirmSingleLineTextFieldOrSelectParent = {$: 16};
var author$project$Panel$Editor$Module$SelectFirstChild = {$: 5};
var author$project$Panel$Editor$Module$SelectLastChild = {$: 6};
var author$project$Panel$Editor$Module$SelectLeft = {$: 1};
var author$project$Panel$Editor$Module$SelectRight = {$: 2};
var author$project$Panel$Editor$Module$SuggestionNextOrSelectDown = {$: 10};
var author$project$Panel$Editor$Module$SuggestionPrevOrSelectUp = {$: 11};
		...
		if (!_n1.a) {
			if ((!_n1.b) && (!_n1.c)) {
				switch (key) {
					case 79:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$SelectLeft]);
					case 80:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$SelectRight]);
					case 81:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$SuggestionPrevOrSelectUp]);
					case 78:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$SuggestionNextOrSelectDown]);
					case 55:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$SelectFirstChild]);
					case 53:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$ConfirmSingleLineTextFieldOrSelectParent]);
					default:
						return _List_Nil;
				}
			} else {
			...
			if ((!_n1.b) && (!_n1.c)) {
				switch (key) {
					case 79:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$SelectLastChild]);
					case 80:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$SelectFirstChild]);
					case 53:
						return _List_fromArray(
							[author$project$Panel$Editor$Module$ConfirmMultiLineTextField]);
					default:
						return _List_Nil;
				}
			} else {
			...
			return elm$core$Maybe$Just(
				author$project$Panel$EditorGroup$ColumnTwo(
					_Utils_update(
						rec,
						{
							N: A3(elm$core$Basics$clamp, 100, 900, (((mouseRelY * 1002) / editorHeight) | 0) - 1)
						})));
		}
	});
				...
				if (!gutter) {
					return A2(
						...
						A2(
							...
							A3(author$project$Panel$EditorGroup$resizeInColumn, rec.S, y, height)));
				} else {
					return group;
				}
			case 1:
					...
					default:
						return A2(
							...
							A2(
								...
								A3(author$project$Panel$EditorGroup$resizeInColumn, rec.U, y, height)));
				}
		}
	});
				...
				if (!gutter) {
					...
					return author$project$Panel$EditorGroup$RowThree(
						_Utils_update(
							rec,
							{
								H: A2(elm$core$Basics$max, 100, (rec.i + rec.H) - leftWidth),
								i: leftWidth
							}));
				} else {
					...
					return author$project$Panel$EditorGroup$RowThree(
						_Utils_update(
							rec,
							{
								H: A2(elm$core$Basics$max, 100, leftWidth - rec.i),
...
var author$project$Model$openCommandPalette = function (_n0) {
	...
	return _Utils_update(
		rec,
		{
			M: author$project$Model$SubModeCommandPalette(author$project$Panel$CommandPalette$initModel)
		});
};
			...
			case 0:
				...
				return author$project$Panel$EditorGroup$RowOne(
					_Utils_update(
						recRow,
						{
							S: A3(author$project$Panel$EditorGroup$setEditorItemColumn, editorRef.b, item, recRow.S)
						}));
			case 1:
				var recRow = group.a;
				return author$project$Panel$EditorGroup$RowTwo(
						...
						switch (_n2) {
							...
							default:
								return _Utils_update(
									recRow,
									{
										U: A3(author$project$Panel$EditorGroup$setEditorItemColumn, editorRef.b, item, recRow.U)
									});
						}
					}());
		}
...
var author$project$Panel$Editor$EditorKeyConfig$initModel = {a_: 0, aU: elm$core$Maybe$Nothing};
...
var author$project$Panel$Editor$Module$initModel = function (moduleRef) {
	return {X: author$project$Panel$Editor$Module$ActiveNone, b3: _List_Nil, a1: moduleRef};
};
...
var author$project$Model$toGutterMode = F2(
	function (gutter, _n0) {
		...
		return _Utils_update(
			rec,
			{
				M: author$project$Model$SubModeGutter(gutter)
			});
	});
...
var author$project$Panel$Editor$Module$BlurThisEditor = {$: 19};
...
var author$project$Panel$Editor$Module$branchPosParent = function (branchPos) {
	switch (branchPos.$) {
		case 0:
			return elm$core$Maybe$Nothing;
		case 1:
		...
		default:
			...
			var _n5 = author$project$Panel$Editor$Module$termOpPosParent(termOpPos);
			if (!_n5.$) {
...
var author$project$Panel$Editor$Module$lambdaPosParent = function (lambdaPos) {
	switch (lambdaPos.$) {
		case 0:
			return elm$core$Maybe$Nothing;
		case 1:
		...
		default:
			...
			return A2(
				...
				author$project$Panel$Editor$Module$branchPosParent(branchPos));
	}
};
var author$project$Panel$Editor$Module$termOpPosParent = function (termOpPos) {
	switch (termOpPos.$) {
		case 0:
			return elm$core$Maybe$Nothing;
		case 1:
		...
		case 2:
			var termIndex = termOpPos.a;
			var termType = termOpPos.b;
			var _n2 = author$project$Panel$Editor$Module$termTypeParent(termType);
			if (!_n2.$) {
...
var author$project$Panel$Editor$Module$termTypeParent = function (termType) {
	switch (termType.$) {
		case 0:
			return elm$core$Maybe$Nothing;
		case 1:
		...
		default:
			...
			return A2(
				...
				author$project$Panel$Editor$Module$lambdaPosParent(lambdaPos));
	}
};
					...
					if (active.a.$ === 1) {
						switch (active.a.a.b.$) {
							...
							default:
								var _n6 = active.a.a;
								var index = _n6.a;
								var termOpPos = _n6.b.a;
								var _n7 = author$project$Panel$Editor$Module$termOpPosParent(termOpPos);
								if (!_n7.$) {
									var movedTermOpPos = _n7.a;
									return author$project$Panel$Editor$Module$ActivePartDefList(
										author$project$Panel$Editor$Module$ActivePartDef(
											_Utils_Tuple2(
												index,
...
var author$project$Panel$Editor$Module$confirmSingleLineTextFieldOrSelectParent = F2(
	function (targetModule, active) {
		return author$project$Panel$Editor$Module$isNeedConfirmSingleLineTextField(active) ? author$project$Panel$Editor$Module$confirmSingleLineTextField(active) : A2(author$project$Panel$Editor$Module$selectParent, targetModule, active);
	});
...
var author$project$Panel$Editor$Module$emitSetExpr = F3(
	function (moduleIndex, partDefIndex, expr) {
		return author$project$Panel$Editor$Module$EmitMsgToSource(
			{
				a0: moduleIndex,
				bA: A2(author$project$Project$Source$ModuleWithCache$MsgSetExpr, partDefIndex, expr)
			});
	});
...
var author$project$Panel$Editor$Module$emitSetName = F3(
	function (moduleIndex, partDefIndex, name) {
		return author$project$Panel$Editor$Module$EmitMsgToSource(
			{
				a0: moduleIndex,
				bA: A2(author$project$Project$Source$ModuleWithCache$MsgSetName, partDefIndex, name)
			});
	});
...
var author$project$Panel$Editor$Module$emitSetType = F3(
	function (moduleIndex, partDefIndex, type_) {
		return author$project$Panel$Editor$Module$EmitMsgToSource(
			{
				a0: moduleIndex,
				bA: A2(author$project$Project$Source$ModuleWithCache$MsgSetType, partDefIndex, type_)
			});
	});
					...
					case 1:
						if (rest.a.a === 16) {
							...
							if (!label.$) {
								...
								return author$project$Parser$Type$TypeToExpr(
									{bO: others, ai: author$project$Project$Source$Module$PartDef$Type$empty});
							}
						} else {
							var _n5 = rest.a;
							var _char = _n5.b;
		...
		case 1:
			...
			if (!_n1.$) {
				...
				return author$project$Parser$BeginWithNameEndType(
					{aR: name, u: textAreaValue, ai: type_});
			} else {
				var type_ = _n1.a.ai;
				var rest = _n1.a.bO;
				...
				if (!_n2.$) {
					...
					return author$project$Parser$BeginWithNameEndExprTerm(
						{
							I: author$project$Parser$Expr$takeTerm(head),
							aR: name,
							L: author$project$Parser$Expr$takeTermListOT(others),
							u: textAreaValue,
							ai: type_
						});
				} else {
	...
	function (string, partDefIndex, moduleRef) {
		...
		switch (_n0.$) {
			...
			case 2:
				var name = _n0.a.aR;
				var type_ = _n0.a.ai;
				var headTerm = _n0.a.I;
				var opAndTermList = _n0.a.L;
				var textAreaValue = _n0.a.u;
				return _Utils_Tuple2(
					author$project$Panel$Editor$Module$ActivePartDefList(
						author$project$Panel$Editor$Module$ActivePartDef(
			...
			return author$project$Parser$BeginWithOpEndTerm(
				{
					...
					bU: author$project$Parser$Expr$takeTermListTO(others),
					u: textAreaValue
				});
		} else {
			var head = _n0.a.w;
...
var author$project$Project$Source$Module$PartDef$empty = {aF: author$project$Project$Source$Module$PartDef$Expr$empty, aR: author$project$Project$Source$Module$PartDef$Name$noName, ai: author$project$Project$Source$Module$PartDef$Type$empty};
var author$project$Panel$Editor$Module$inputInPartDefList = F5(
	function (string, project, targetModule, partDefListActive, model) {
		var _n0 = function () {
			if (partDefListActive.$ === 1) {
			...
			return _Utils_Tuple2(
				...
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$EmitMsgToSource(
						{
							a0: author$project$Panel$Editor$Module$getTargetModuleIndex(model),
							bA: author$project$Project$Source$ModuleWithCache$MsgSetReadMe(string)
						})
					]));
		} else {
								...
								return author$project$Panel$Editor$Module$ActivePartDefList(
									author$project$Panel$Editor$Module$ActivePartDef(
										_Utils_Tuple2(
											A2(
												elm$core$Basics$min,
												author$project$Project$Source$ModuleWithCache$getPartDefNum(module_) - 1,
												index + 1),
		...
		switch (termOpPos.$) {
			...
			case 2:
				...
				var termMaybe = A2(
					...
					author$project$Project$Source$Module$PartDef$Expr$getTermFromIndex(termIndex),
					exprMaybe);
				return A2(
					author$project$Panel$Editor$Module$TermOpTerm,
					termIndex,
		...
		while (true) {
			switch (active.$) {
				...
				case 1:
					if (!active.a) {
						var _n1 = active.a;
						return author$project$Panel$Editor$Module$ActiveReadMe(1);
					} else {
						break _n0$5;
					}
				default:
						...
						switch (active.a.a.b.$) {
							...
							case 3:
								...
								var exprMaybe = A2(
									elm$core$Maybe$map,
									author$project$Project$Source$Module$PartDef$getExpr,
									A2(author$project$Project$Source$ModuleWithCache$getPartDef, index, module_));
								return author$project$Panel$Editor$Module$ActivePartDefList(
									author$project$Panel$Editor$Module$ActivePartDef(
										_Utils_Tuple2(
											index,
											author$project$Panel$Editor$Module$ActivePartDefExpr(
												A2(author$project$Panel$Editor$Module$termOpPosFirstChild, exprMaybe, termOpPos)))));
							default:
								break _n0$5;
						}
					}
...
var author$project$Panel$Editor$Module$termOpPosLastChild = F2(
	function (exprMaybe, termOpPos) {
		var lastTermIndex = A2(
			...
			A2(
				elm$core$Maybe$map,
				A2(elm$core$Basics$composeR, author$project$Project$Source$Module$PartDef$Expr$getOthers, elm$core$List$length),
				exprMaybe));
		switch (termOpPos.$) {
			case 0:
				return A2(
				...
				if (!active.a.$) {
					...
					switch (active.a.a.b.$) {
						...
						default:
							var _n8 = active.a.a;
							var index = _n8.a;
							var termOpPos = _n8.b.a;
							return author$project$Panel$Editor$Module$ActivePartDefList(
								author$project$Panel$Editor$Module$ActivePartDef(
									_Utils_Tuple2(
										index,
										function () {
											var _n9 = author$project$Panel$Editor$Module$termOpPosLeft(termOpPos);
											if (!_n9.$) {
												var movedTermOpPos = _n9.a;
						...
						default:
							if (!active.a.a.b.a.$) {
								...
								var exprMaybe = A2(
									elm$core$Maybe$map,
									author$project$Project$Source$Module$PartDef$getExpr,
									A2(author$project$Project$Source$Module$getPartDef, index, module_));
...
var author$project$Panel$Editor$Module$nameSuggestList = A2(
	elm$core$List$map,
...
var author$project$Panel$Editor$Module$suggestionNext = F3(
	function (module_, project, model) {
		var _n0 = author$project$Panel$Editor$Module$getActive(model);
		_n0$2:
		while (true) {
			if (((_n0.$ === 2) && (_n0.a.$ === 1)) && (_n0.a.a.b.$ === 1)) {
				switch (_n0.a.a.b.a.$) {
					case 2:
						var _n1 = _n0.a.a;
						var partDefIndex = _n1.a;
						var index = _n1.b.a.a.aI;
						var searchName = _n1.b.a.a.V;
						var _n2 = A3(
					...
					case 1:
						...
						var searchName = A2(
							...
							A2(
								elm$core$Maybe$map,
								author$project$Project$Source$Module$PartDef$getName,
								A2(author$project$Project$Source$ModuleWithCache$getPartDef, partDefIndex, module_)));
						var _n5 = A3(
							author$project$Panel$Editor$Module$setActive,
							project,
							author$project$Panel$Editor$Module$ActivePartDefList(
...
var author$project$Panel$Editor$Module$suggestionPrev = F3(
	function (targetModule, project, model) {
		var _n0 = author$project$Panel$Editor$Module$getActive(model);
		if ((((_n0.$ === 2) && (_n0.a.$ === 1)) && (_n0.a.a.b.$ === 1)) && (_n0.a.a.b.a.$ === 2)) {
			var _n1 = _n0.a.a;
			var partDefIndex = _n1.a;
			var index = _n1.b.a.a.aI;
			var searchName = _n1.b.a.a.V;
					...
					_Utils_ap(
						_List_fromArray(
							[
								author$project$Panel$Editor$Module$EmitMsgToSource(
								{
									a0: author$project$Panel$Editor$Module$getTargetModuleIndex(newModel),
									bA: A2(author$project$Project$Source$ModuleWithCache$MsgSetName, index, searchName)
								})
							]),
						emitList));
			} else {
...
var author$project$Project$Source$ModuleWithCache$MsgAddDef = {$: 1};
var author$project$Panel$Editor$Module$suggestionNextOrSelectDown = F3(
	function (module_, project, model) {
		return function () {
			var _n3 = author$project$Panel$Editor$Module$getActive(model);
			_n3$2:
			while (true) {
				if (((_n3.$ === 2) && (_n3.a.$ === 1)) && (_n3.a.a.b.$ === 1)) {
					switch (_n3.a.a.b.a.$) {
						case 2:
							var _n4 = _n3.a.a;
							var index = _n4.b.a.a.aI;
							var searchName = _n4.b.a.a.V;
							return A2(author$project$Panel$Editor$Module$suggestionNext, module_, project);
						case 1:
							var _n5 = _n3.a.a;
							var _n6 = _n5.b.a;
							return A2(author$project$Panel$Editor$Module$suggestionNext, module_, project);
			...
			return A2(author$project$Panel$Editor$Module$update, author$project$Panel$Editor$Module$SelectDown, project);
		}()(model);
	});
var author$project$Panel$Editor$Module$suggestionPrevOrSelectUp = F3(
	function (targetModule, project, model) {
		return function () {
			...
			if ((((_n1.$ === 2) && (_n1.a.$ === 1)) && (_n1.a.a.b.$ === 1)) && (_n1.a.a.b.a.$ === 2)) {
				var _n2 = _n1.a.a;
				return A2(author$project$Panel$Editor$Module$suggestionPrev, targetModule, project);
			} else {
				return A2(author$project$Panel$Editor$Module$update, author$project$Panel$Editor$Module$SelectUp, project);
			}
		}()(model);
	});
		...
		switch (msg.$) {
			...
			case 1:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$selectLeft, targetModule, active),
					model);
			case 2:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$selectRight, targetModule, active),
					model);
			case 3:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$selectUp, targetModule, active),
					model);
			case 4:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$selectDown, targetModule, active),
					model);
			case 5:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$selectFirstChild, targetModule, active),
					model);
			case 6:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$selectLastChild, targetModule, active),
					model);
			case 7:
				return A3(
					author$project$Panel$Editor$Module$setActive,
					project,
					A2(author$project$Panel$Editor$Module$selectParent, targetModule, active),
					model);
			case 8:
				...
				return _Utils_Tuple2(
					...
					_List_fromArray(
						[
							...
							{
								a0: author$project$Panel$Editor$Module$getTargetModuleIndex(model),
								bA: author$project$Project$Source$ModuleWithCache$MsgAddDef
							})
						]));
			case 18:
				return _Utils_Tuple2(model, _List_Nil);
			default:
				return A3(author$project$Panel$Editor$Module$update, author$project$Panel$Editor$Module$ConfirmMultiLineTextField, project, model);
		}
	});
				...
				if (!index.a) {
					...
					return A2(
						...
						A2(
							...
							A2(author$project$Panel$EditorGroup$closeEditorColumn, editorRefColumn, rec.S)));
				} else {
					return group;
				}
			case 1:
					...
					case 0:
						return A2(
							...
							A2(
								...
								A2(author$project$Panel$EditorGroup$closeEditorColumn, index.b, rec.S)));
					case 1:
						return A2(
							elm$core$Maybe$withDefault,
							author$project$Panel$EditorGroup$RowOne(
					...
					default:
						return A2(
							...
							A2(
								...
								A2(author$project$Panel$EditorGroup$closeEditorColumn, index.b, rec.U)));
				}
		}
	});
...
var author$project$Panel$Editor$Module$FocusThisEditor = {$: 18};
...
var author$project$Panel$EditorGroup$mouseOverAddGutter = F2(
	function (openEditorPosition, _n0) {
		...
		return _Utils_update(
			rec,
			{
				aQ: elm$core$Maybe$Just(openEditorPosition)
			});
	});
				...
				if (!column.$) {
					...
					return elm$core$Maybe$Just(
						_Utils_Tuple2(
							author$project$Panel$EditorGroup$RowOne(
								{
									S: author$project$Panel$EditorGroup$ColumnTwo(
										{y: item, h: top, N: 500})
								}),
							_Utils_Tuple2(0, 1)));
				} else {
						...
						_Utils_Tuple2(
							author$project$Panel$EditorGroup$RowThree(
								_Utils_update(
									rec,
									{
										U: author$project$Panel$EditorGroup$ColumnTwo(
											{y: item, h: top, N: 500})
									})),
							_Utils_Tuple2(2, 1)));
				} else {
						...
						author$project$Panel$EditorGroup$RowThree(
							{
								...
								S: rec.S,
								i: 333,
								U: author$project$Panel$EditorGroup$ColumnOne(
									{h: item})
							}),
						_Utils_Tuple2(2, 0)));
			case 1:
		...
		switch (msg.$) {
			...
			case 6:
				...
				return _Utils_Tuple2(
					A2(
						author$project$Panel$EditorGroup$mapGroup,
						A2(author$project$Panel$EditorGroup$setEditorItem, rec.aT, newEditorItem),
						model),
					emit);
			case 7:
...
var author$project$Panel$Tree$getOpenCloseData = function (_n0) {
	var openCloseData = _n0.a5;
	return openCloseData;
};
var author$project$Panel$Tree$isTreeOpen = F2(
	function (projectRef, _n0) {
		var isProjectRootOpen = _n0.aM;
		var isSourceOpen = _n0.aN;
		var isCoreOpen = _n0.aK;
		_n1$3:
		while (true) {
			if (!projectRef.$) {
				switch (projectRef.a.$) {
...
var author$project$NSvg$rect = F3(
	function (_n0, strokeStyle, fillStyle) {
		...
		return author$project$NSvg$Rect(
			{Y: elm$core$Maybe$Nothing, z: fillStyle, C: height, t: strokeStyle, B: width, bY: 0, bZ: 0});
	});
		...
		switch (nSvgElement.$) {
			case 0:
				...
				return author$project$NSvg$Rect(
					_Utils_update(
						rec,
						{bY: rec.bY + x, bZ: rec.bZ + y}));
			case 1:
				var rec = nSvgElement.a;
				return author$project$NSvg$Circle(
					_Utils_update(
						rec,
						{aB: rec.aB + x, aC: rec.aC + y}));
			case 2:
				var rec = nSvgElement.a;
				return author$project$NSvg$Polygon(
					_Utils_update(
...
var author$project$NSvg$circle = F3(
	function (r, strokeStyle, fillStyle) {
		return author$project$NSvg$Circle(
			{aB: 0, aC: 0, z: fillStyle, bL: r, t: strokeStyle});
	});
				...
				A2(
					...
					elm$core$List$indexedMap(
						F2(
							function (i, _n1) {
								var partDef = _n1.a;
								return _Utils_eq(i, index) ? author$project$Project$Source$Module$PartDef$Name$NoName : author$project$Project$Source$Module$PartDef$getName(partDef);
							})),
...
var author$project$Project$Source$ModuleWithCache$emptyCompileAndRunResult = {aV: elm$core$Maybe$Nothing, bb: elm$core$Maybe$Nothing};
					...
					return _Utils_Tuple2(
						A3(
							...
							_Utils_update(
								rec,
								{
									aV: elm$core$Maybe$Just(compileResult)
								}),
							moduleWithResult),
						function () {
...
var author$project$Project$Source$update = F2(
	function (msg, source) {
		var moduleIndex = msg.a0;
		var moduleMsg = msg.bA;
		var _n1 = A2(
	...
	function (_n8, model) {
		...
		if (!_n9.$) {
			...
			return A2(
				...
				{
					a0: moduleIndex,
					bA: A2(author$project$Project$Source$ModuleWithCache$MsgReceiveRunResult, index, result)
				},
				model);
		} else {
...
var author$project$Panel$EditorGroup$initModel = _Utils_Tuple2(
	{
		...
		aH: author$project$Panel$EditorGroup$RowOne(
			{
				S: author$project$Panel$EditorGroup$ColumnOne(
					{
	...
	author$project$Project$Source$ModuleWithCache$init(
		{
			...
			a6: _List_fromArray(
				[
					...
					{
						aF: author$project$Project$Source$Module$PartDef$Expr$empty,
						aR: author$project$Project$Source$Module$PartDef$Name$fromLabel(
							A2(
								author$project$Project$Label$make,
			...
			a9: 'プログラムに最低限必要なものが含まれている標準ライブラリ。足し算引き算、論理演算などの演算や、リスト、辞書、集合などの基本データ構造を含む',
			bk: _List_Nil
		}));
var author$project$Project$Source$Module$PartDef$Type$Valid = function (a) {
	return {$: 0, a: a};
};
var author$project$Project$Source$Module$TypeDef$Int = 0;
...
var author$project$Project$Source$Module$TypeDef$typeDefInt = {
	b5: author$project$Project$Source$Module$TypeDef$TagOrKernelKernel(0),
	aR: A2(
		author$project$Project$Label$make,
	...
	author$project$Project$Source$ModuleWithCache$init(
		{
			...
			a9: 'WebAssemblyでサポートされている32bit符号付き整数を扱えるようになる',
			bk: _List_fromArray(
...
var author$project$Project$Source$initSampleModule = A2(
	...
	elm$core$List$map(
		function (moduleEmit) {
			return {cj: moduleEmit, a0: 2};
		}),
	author$project$Project$Source$ModuleWithCache$init(
		{
			aR: author$project$Project$Source$sampleModuleName,
			a6: _List_fromArray(
				[
					author$project$Project$Source$Module$PartDef$make(
					{
...
var author$project$Project$Source$init = function () {
	...
	var coreEmit = _n2.b;
	return _Utils_Tuple2(
		{aW: core, aX: coreInt32, bc: sampleModule},
		_Utils_ap(
			coreEmit,
...
var author$project$Project$init = function () {
	...
	return _Utils_Tuple2(
		{bo: author$project$Project$projectAuthor, b4: author$project$Project$Config$init, b6: author$project$Project$Document$init, aR: author$project$Project$projectName, be: source},
...
var author$project$Model$init = function () {
	...
	var model = {
		...
		a8: project,
		M: author$project$Model$SubModeNone,
		bi: author$project$Panel$Tree$initModel,
		bj: 250,
		bl: {C: 0, B: 0}
	};
...
var author$project$Key$fromKeyAndCodeAndModifierKeys = F5(
	function (keyString, codeString, ctrl, shift, alt) {
		...
		if (!_n0.$) {
			var key = _n0.a;
			return elm$core$Maybe$Just(
				{bn: alt, br: ctrl, bz: key, bR: shift});
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bw: fragment, by: host, bE: path, bG: port_, bJ: protocol, bK: query};
	});
...
var author$project$NSvg$strokeWidth = function (width) {
	return author$project$NSvg$Stroke(
		{Q: elm$core$Maybe$Nothing, ar: 0, B: width});
};
...
var author$project$NSvg$elementToSvg = function (nSvgElement) {
	switch (nSvgElement.$) {
		case 0:
			var x = nSvgElement.a.bY;
			var y = nSvgElement.a.bZ;
			...
			return A2(
				...
				_List_Nil);
		case 1:
			var cx = nSvgElement.a.aB;
			var cy = nSvgElement.a.aC;
			var r = nSvgElement.a.bL;
			var strokeStyle = nSvgElement.a.t;
			var fillStyle = nSvgElement.a.z;
			return A2(
				elm$svg$Svg$circle,
		...
		case 2:
			...
			return A2(
				...
				_List_Nil);
		case 3:
			var d = nSvgElement.a.bs;
			var strokeStyle = nSvgElement.a.t;
			var fillStyle = nSvgElement.a.z;
			var offset = nSvgElement.a.aS;
			return A2(
				elm$svg$Svg$path,
				_Utils_ap(
					_List_fromArray(
...
var author$project$Panel$Editor$EditorKeyConfig$selectFrame = function (oneKey) {
	...
	return A2(
		author$project$NSvg$translate,
		{bY: shapeData.a.a * 100, bZ: shapeData.a.b * 100},
		A3(
...
var author$project$Panel$Editor$EditorKeyConfig$view = function (_n0) {
	var selectedKey = _n0.aU;
	var inputDevice = _n0.a_;
	return {
		b0: _List_fromArray(
			[
				A2(
...
var author$project$Panel$Editor$Module$AddPartDef = {$: 17};
	...
	_List_fromArray(
		[
			...
			elm$json$Json$Decode$succeed(
				_Utils_Tuple2(author$project$Panel$Editor$Module$AddPartDef, true))),
			author$project$Panel$Editor$Module$subClass('partDefList-addPartDef')
		]),
	_List_fromArray(
		[
...
var author$project$Panel$Editor$Module$hideTextArea = A2(
	elm$html$Html$input,
	_List_fromArray(
		[
		...
		return A2(
			...
			_Utils_ap(
				...
				function () {
					if (!termOpPosMaybe.$) {
						return _List_fromArray(
							[author$project$Panel$Editor$Module$hideTextArea]);
					} else {
						return _List_Nil;
					}
				}()));
		...
		return A2(
			...
			function () {
				if (!suggestSelectDataMaybe.$) {
					var index = suggestSelectDataMaybe.a.aI;
					var searchName = suggestSelectDataMaybe.a.V;
					return _Utils_ap(
						_List_fromArray(
							[
								A3(
	...
	return A3(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2('input', author$project$Panel$Editor$Module$hideTextArea)
			]));
};
...
var author$project$Project$Source$ModuleWithCache$compileAndRunResultGetCompileResult = function (_n0) {
	var compileResult = _n0.aV;
	return compileResult;
};
var author$project$Project$Source$ModuleWithCache$compileAndRunResultGetRunResult = function (_n0) {
	var runResult = _n0.bb;
	return runResult;
};
var author$project$Panel$Editor$Module$resultArea = function (compileAndRunResult) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Panel$Editor$Module$partDefView = F4(
	function (isFocus, partDef, compileAndRunResult, partDefActiveMaybe) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					author$project$Panel$Editor$Module$resultArea(compileAndRunResult)
				]));
	});
var author$project$Panel$Editor$Module$partDefListView = F3(
	function (isFocus, defAndResultList, partDefActiveWithIndexMaybe) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
...
var author$project$Panel$Editor$Module$partDefinitionsView = F3(
	function (isFocus, partDefListActiveMaybe, partDefAndResultList) {
		return A2(
			elm$html$Html$div,
			_Utils_ap(
				_List_fromArray(
...
var author$project$Panel$Editor$Module$readMeViewTextArea = F3(
	function (readMe, isFocus, readMeActiveMaybe) {
		return A2(
			elm$html$Html$textarea,
			_Utils_ap(
				_List_fromArray(
				...
				function () {
					if (!readMeActiveMaybe.$) {
						if (!readMeActiveMaybe.a) {
...
var author$project$Panel$Editor$Module$readMeViewInputArea = F3(
	function (readMe, isFocus, readMeActiveMaybe) {
		return A2(
			...
			_List_fromArray(
				[
					author$project$Panel$Editor$Module$subClass('readMe-inputArea')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2('readMe-container', true),
									_Utils_Tuple2(
					...
					_List_fromArray(
						[
							...
							A3(author$project$Panel$Editor$Module$readMeViewTextArea, readMe, isFocus, readMeActiveMaybe)
						]))
				]));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A3(author$project$Panel$Editor$Module$readMeViewInputArea, readMe, isFocus, readMeActiveMaybe)
				]));
	});
...
var author$project$Panel$Editor$Module$typeDefinitionsView = function (isFocus) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		return {
			b0: _List_fromArray(
				[
					...
					author$project$Panel$Editor$Module$typeDefinitionsView(isFocus),
					A3(
			...
			ct: author$project$Project$Label$toCapitalString(
...
var author$project$Panel$EditorGroup$editorTitleAndBody = F4(
	function (editorIndex, isActive, project, editorItem) {
		switch (editorItem.$) {
			case 0:
						...
						elm$html$Html$map(
							function (m) {
								return author$project$Panel$EditorGroup$EditorItemMsg(
									{
										a2: author$project$Panel$EditorGroup$ModuleEditorMsg(m),
										aT: editorIndex
									});
							}),
						viewItem.b0),
					...
					b0: A2(
						...
						elm$html$Html$map(
							function (m) {
								return author$project$Panel$EditorGroup$EditorItemMsg(
									{
										a2: author$project$Panel$EditorGroup$EditorKeyConfigMsg(m),
										aT: editorIndex
									});
							}),
						viewItem.b0),
...
var author$project$Panel$EditorGroup$editorItemView = function (_n0) {
	var project = _n0.a8;
	var editorItem = _n0.aE;
	var editorIndex = _n0.aD;
	var width = _n0.B;
	var height = _n0.C;
	var isActive = _n0.aJ;
	var isOne = _n0.aL;
				...
				if (!columnGroup.$) {
					...
					return _List_fromArray(
						[
							...
							{
								aD: _Utils_Tuple2(editorRefRow, 0),
								aE: top,
								C: height - 2,
								aJ: _Utils_eq(
					...
					return _List_fromArray(
						[
							...
							author$project$Panel$EditorGroup$editorItemView(
							{
								aD: _Utils_Tuple2(editorRefRow, 1),
								aE: bottom,
...
var author$project$Panel$EditorGroup$view = F5(
	function (project, _n0, isFocus, gutter, _n1) {
		...
		var mouseOverOpenEditorPosition = _n1.aQ;
...
var author$project$Panel$Tree$view = function (_n0) {
	...
	return (100 < width) ? _Utils_ap(
		...
		A2(
			...
			{j: editorRef, aG: focus, a8: project, B: width},
			model)) : _List_Nil;
};
			...
			author$project$Panel$Tree$view(
				{
					...
					aG: author$project$Model$isFocusTreePanel(model),
					ci: author$project$Model$getTreePanelModel(model),
					a8: author$project$Model$getProject(model),
...
var author$project$View$view = function (model) {
	return {
		...
		ct: 'Definy 0 - ' + author$project$Project$Label$toCapitalString(
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		...
		cr: author$project$Model$subscriptions,
		cv: author$project$Model$update,
		cx: author$project$View$view
	});
