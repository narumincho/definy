...
var author$project$Compiler$SafeExprToNoOp$convertLoop = function (_n0) {
	...
	while (true) {
		var left = _n0.R;
		var centerOp = _n0.P;
		var leftCandidate = _n0.aF;
		var right = _n0.T;
		if (!right.b) {
			return {P: centerOp, R: left, T: leftCandidate};
		} else {
			var _n2 = right.a;
			var op = _n2.a;
			var term = _n2.b;
			...
			if (A2(
				...
				var $temp$_n0 = {
					P: op,
					R: A3(author$project$Compiler$SafeExpr$concat, left, centerOp, leftCandidate),
					aF: A2(author$project$Compiler$SafeExpr$SafeExpr, term, _List_Nil),
					T: xs
				};
				_n0 = $temp$_n0;
...
var author$project$Compiler$SafeExprToNoOp$convert = function (_n0) {
	...
	if (!others.b) {
		...
		var a = author$project$Compiler$SafeExprToNoOp$convertLoop(
			{
				P: op,
				R: A2(author$project$Compiler$SafeExpr$SafeExpr, head, _List_Nil),
				aF: A2(author$project$Compiler$SafeExpr$SafeExpr, term, _List_Nil),
				T: xs
			});
		return A3(
			...
			author$project$Compiler$SafeExprToNoOp$convert(a.R),
	...
	if (!_n0.$) {
		...
		if (!_n1.$) {
			...
			return author$project$Compiler$Success(
				{
					a8: author$project$Compiler$OptToBinary$convert(opt),
					aT: noOp,
					bl: opt
				});
		} else {
			...
			return A2(
				...
				function (compileResult) {
					return author$project$Model$ReceiveCompiledData(
						{ba: compileResult, bW: index, b3: moduleRef});
				},
				A2(
					elm$core$Task$andThen,
					function (def) {
...
var author$project$Panel$Editor$Module$initModel = function (moduleRef) {
	return {h: author$project$Panel$Editor$Module$ActiveNone, t: moduleRef};
};
...
var author$project$Panel$EditorGroup$initModel = {
	...
	aA: author$project$Panel$EditorGroup$RowOne(
		{
...
var author$project$Project$Source$ModuleWithCache$make = function (_n0) {
	...
	return {
		C: A2(
			elm$core$List$map,
			function (def) {
				return {ba: elm$core$Maybe$Nothing, ag: def, ai: elm$core$Maybe$Nothing};
			},
...
var author$project$Project$Source$init = {
	aK: author$project$Project$Source$ModuleWithCache$make(
		{
			aM: _List_fromArray(
				[
					author$project$Project$Source$Module$Def$make(
					{
						aO: author$project$Project$Source$Module$Def$Expr$empty,
						aS: author$project$Project$Source$Module$Def$Name$fromLabel(
							A2(
								author$project$Project$Label$make,
								author$project$Project$Label$ha,
								_List_fromArray(
									[author$project$Project$Label$ob, author$project$Project$Label$os]))),
						a3: author$project$Project$Source$Module$Def$Type$empty
					})
				]),
			aS: A2(
				author$project$Project$Label$make,
			...
			aY: 'プログラムに最低限必要なものが含まれている標準ライブラリ。足し算引き算、論理演算などの演算や、リスト、辞書、集合などの基本データ構造を含む'
		}),
	aL: author$project$Project$Source$ModuleWithCache$make(
		{
			aM: _List_fromArray(
				[
					author$project$Project$Source$Module$Def$make(
					{
						...
						a3: author$project$Project$Source$Module$Def$Type$int
					}),
					author$project$Project$Source$Module$Def$make(
					{
						aO: author$project$Project$Source$Module$Def$Expr$empty,
			...
			aY: 'WebAssemblyでサポートされている32bit符号付き整数を扱えるようになる'
		}),
	aZ: author$project$Project$Source$ModuleWithCache$make(
		{
			aM: _List_fromArray(
				[
					author$project$Project$Source$Module$Def$make(
...
var author$project$Project$init = {a7: author$project$Project$projectAuthor, bK: author$project$Project$Config$init, bL: author$project$Project$Document$init, aS: author$project$Project$projectName, a_: author$project$Project$Source$init};
var author$project$Model$initModel = {
	aN: author$project$Panel$EditorGroup$initModel,
	az: 1,
	al: _List_Nil,
	aX: author$project$Project$init,
	M: author$project$Model$SubModeNone,
	a1: author$project$Panel$Tree$initModel,
	a2: 250,
	a4: {bT: 0, ce: 0}
};
...
var author$project$Key$fromKeyAndCodeAndModifierKeys = F5(
	function (keyString, codeString, ctrl, shift, alt) {
		...
		if (!_n0.$) {
			var key = _n0.a;
			return elm$core$Maybe$Just(
				{a6: alt, bb: ctrl, bj: key, bz: shift});
		} else {
			return elm$core$Maybe$Nothing;
		}
	});
	...
	return A3(
		...
		A2(
			...
			A2(
				elm$json$Json$Decode$field,
				'target',
				A2(elm$json$Json$Decode$field, info.bU, elm$json$Json$Decode$bool))));
};
...
var author$project$Model$getEditorGroupPanelModel = function (_n0) {
	var editorGroupPanelModel = _n0.aN;
...
var author$project$Project$Source$Module$Def$empty = {aO: author$project$Project$Source$Module$Def$Expr$empty, aS: author$project$Project$Source$Module$Def$Name$noName, a3: author$project$Project$Source$Module$Def$Type$empty};
var author$project$Project$Source$ModuleWithCache$addDef = F2(
	function (def, _n0) {
		...
		return _Utils_update(
			rec,
			{
				C: (65535 <= elm$core$List$length(rec.C)) ? A2(elm$core$List$take, 65535, rec.C) : _Utils_ap(
					rec.C,
					_List_fromArray(
						[
							{ba: elm$core$Maybe$Nothing, ag: def, ai: elm$core$Maybe$Nothing}
						]))
			});
	});
...
var author$project$Panel$Editor$Module$BlurThisEditor = {$: 15};
...
var author$project$Panel$Editor$Module$ActiveExprOp = F3(
	function (a, b, c) {
		return {$: 3, a: a, b: b, c: c};
	});
var author$project$Panel$Editor$Module$ActiveExprTerm = F3(
	function (a, b, c) {
...
var author$project$Panel$Editor$Module$ActivePartDefExprSelf = {$: 0};
...
var author$project$Parser$Expr$parseResultAddTermOrOpList = F2(
	function (list, parseResult) {
		if (!parseResult.$) {
			...
			var termOrOpList = parseResult.a.f;
			var textAreaValue = parseResult.a.v;
			return author$project$Parser$Expr$End(
				{
					f: _Utils_ap(list, termOrOpList),
					v: textAreaValue
...
var author$project$Parser$Expr$termOrOpListToParseTermResultNeedOp = function (termOrOpList) {
	if (termOrOpList.b) {
		...
		return {g: elm$core$Maybe$Nothing, y: _List_Nil};
	}
};
	...
	if (list.b) {
		if (!list.a.$) {
			...
			return author$project$Parser$Expr$concatParseTermResult(
				{x: term, g: lastMaybe, y: others, v: textAreaValue});
		} else {
			var op = list.a.a;
			var listOthers = list.b;
			...
			return author$project$Parser$Expr$concatParseTermResult(
				{
					x: A3(author$project$Parser$Expr$TermWithParenthesis, 0, author$project$Project$Source$Module$Def$Expr$None, 0),
					g: lastMaybe,
					y: others,
					v: textAreaValue
				});
		...
		while (true) {
			if (rest.b) {
						...
						if (rest.a.a === 16) {
							...
							if (!label.$) {
								...
								return author$project$Parser$Type$TypeToExpr(
									{
										bx: others,
										a3: author$project$Project$Source$Module$Def$Type$fromLabel(l)
									});
							} else {
								return author$project$Parser$Type$TypeToExpr(
									{bx: others, a3: author$project$Project$Source$Module$Def$Type$empty});
							}
						} else {
							var _n5 = rest.a;
							var _char = _n5.b;
				...
				if (!label.$) {
					...
					return author$project$Parser$Type$TypeEnd(
						{v: textAreaValue, a3: author$project$Project$Source$Module$Def$Type$empty});
				}
			}
		}
	});
var author$project$Parser$Type$parse = function (list) {
	...
	while (true) {
		if (list.b) {
			...
			return author$project$Parser$Type$TypeEnd(
				{v: _List_Nil, a3: author$project$Project$Source$Module$Def$Type$empty});
		}
	}
};
		...
		case 1:
			...
			if (!_n1.$) {
				...
				return author$project$Parser$BeginWithNameEndType(
					{aS: name, v: textAreaValue, a3: type_});
			} else {
				var type_ = _n1.a.a3;
				var rest = _n1.a.bx;
				...
				return author$project$Project$Source$Module$Def$Type$isEmpty(type_) ? _Utils_Tuple2(
					...
					_List_fromArray(
						[
							...
							{bW: index, b3: moduleRef, a3: type_}),
						...
						author$project$Panel$Editor$Module$ActivePartDef(
							_Utils_Tuple2(
								...
								author$project$Panel$Editor$Module$ActivePartDefExpr(
									(_Utils_eq(headTerm, author$project$Project$Source$Module$Def$Expr$None) && _Utils_eq(opAndTermList, _List_Nil)) ? author$project$Panel$Editor$Module$ActivePartDefExprSelf : A3(
						...
						_Utils_ap(
							...
							_List_fromArray(
								[
									...
									{
										aO: A2(author$project$Project$Source$Module$Def$Expr$make, headTerm, opAndTermList),
										bW: index,
										b3: moduleRef
									})
								]))));
					...
					author$project$Panel$Editor$Module$ActivePartDefList(
						author$project$Panel$Editor$Module$ActivePartDef(
							_Utils_Tuple2(
								...
								author$project$Panel$Editor$Module$ActivePartDefExpr(
									A3(
										author$project$Panel$Editor$Module$ActiveExprOp,
										elm$core$List$length(opAndTermList),
										elm$core$Maybe$Nothing,
										elm$core$Maybe$Just(textAreaValue)))))),
					_List_fromArray(
...
var author$project$Panel$Editor$Module$getLastOp = F2(
	function (headOp, termAndOpList) {
		return A2(
			...
			A2(
				...
				author$project$Utility$ListExtra$last(termAndOpList)));
	});
	...
	if (list.b) {
		if (!list.a.$) {
			...
			return author$project$Parser$Expr$concatParseOpResult(
				{x: 15, g: lastMaybe, y: others, v: textAreaValue});
		} else {
			var op = list.a.a;
			var listOthers = list.b;
			...
			var lastMaybe = _n3.g;
			return author$project$Parser$Expr$concatParseOpResult(
				{x: op, g: lastMaybe, y: others, v: textAreaValue});
		}
	} else {
		return author$project$Parser$Expr$OpLastOp(
			{x: 15, y: _List_Nil, v: textAreaValue});
	}
};
	...
	function (parenthesisLevel, list) {
		...
		if (_n0.$ === 1) {
			...
			return author$project$Parser$BeginWithOpEndTerm(
				{
					bh: head,
					bY: author$project$Parser$Expr$takeTerm(last),
					bC: author$project$Parser$Expr$takeTermListTO(others),
					v: textAreaValue
				});
		} else {
			var head = _n0.a.x;
	...
	function (index, headOp, termOpList, expr) {
		...
		var replaceAndInsertElement = function () {
			...
			if (_n0.$ === 1) {
				return {
					Y: _List_Nil,
					ab: _Utils_Tuple2(headOp, targetTerm)
				};
			} else {
				var _n1 = _n0.a;
				var _n2 = _n1.a;
				...
				return {
					...
					ab: _Utils_Tuple2(headOp, headTerm)
				};
			}
		}();
		return A2(
			...
			A2(
				elm$core$Basics$composeR,
				A2(author$project$Utility$ListExtra$setAt, index, replaceAndInsertElement.ab),
				A2(author$project$Utility$ListExtra$insertList, index + 1, replaceAndInsertElement.Y)),
			expr);
	});
var author$project$Project$Source$Module$Def$Expr$replaceAndInsertOpLastTerm = F5(
	function (index, op, termOpList, lastTerm, expr) {
		...
		var replaceAndInsertElement = function () {
			...
			if (_n0.$ === 1) {
				return {
					Y: _Utils_eq(targetTerm, author$project$Project$Source$Module$Def$Expr$None) ? _List_Nil : _List_fromArray(
						[
							_Utils_Tuple2(15, targetTerm)
						]),
					ab: _Utils_Tuple2(op, lastTerm)
				};
			} else {
				var _n1 = _n0.a;
				var _n2 = _n1.a;
...
var author$project$Panel$Editor$Module$parserBeginWithOp = F5(
	function (string, index, moduleRef, opIndex, expr) {
		...
		if (!_n0.$) {
			var headOp = _n0.a.bh;
			var termAndOpList = _n0.a.bC;
			var lastTerm = _n0.a.bY;
			var textAreaValue = _n0.a.v;
			return _Utils_Tuple2(
				author$project$Panel$Editor$Module$ActivePartDefList(
					author$project$Panel$Editor$Module$ActivePartDef(
						_Utils_Tuple2(
							...
							author$project$Panel$Editor$Module$ActivePartDefExpr(
								A3(
									...
									elm$core$Maybe$Nothing,
									_Utils_eq(lastTerm, author$project$Project$Source$Module$Def$Expr$None) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(textAreaValue)))))),
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$EmitChangeExpr(
						{
							aO: A5(author$project$Project$Source$Module$Def$Expr$replaceAndInsertOpLastTerm, opIndex, headOp, termAndOpList, lastTerm, expr),
							bW: index,
							b3: moduleRef
						}),
						author$project$Panel$Editor$Module$textAreaValueToSetTextEmit(textAreaValue)
						...
						_Utils_Tuple2(
							...
							author$project$Panel$Editor$Module$ActivePartDefExpr(
								A3(
									...
									elm$core$Maybe$Nothing,
									(A2(author$project$Panel$Editor$Module$getLastOp, headOp, termAndOpList) === 15) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(textAreaValue)))))),
				_Utils_ap(
					_List_fromArray(
						[
							author$project$Panel$Editor$Module$EmitChangeExpr(
							{
								aO: A4(author$project$Project$Source$Module$Def$Expr$replaceAndInsertOpLastOp, opIndex, headOp, termAndOpList, expr),
								bW: index,
								b3: moduleRef
							})
						]),
...
var author$project$Panel$Editor$Module$getLastTerm = F2(
	function (headTerm, opAndTermList) {
		return A2(
			elm$core$Maybe$withDefault,
			headTerm,
			A2(
				elm$core$Maybe$map,
				elm$core$Tuple$second,
				author$project$Utility$ListExtra$last(opAndTermList)));
	});
						...
						_Utils_Tuple2(
							...
							author$project$Panel$Editor$Module$ActivePartDefExpr(
								A3(
									...
									elm$core$Maybe$Nothing,
									_Utils_eq(
										A2(author$project$Panel$Editor$Module$getLastTerm, headTerm, opAndTermList),
										author$project$Project$Source$Module$Def$Expr$None) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(textAreaValue)))))),
				_Utils_ap(
					_List_fromArray(
						[
							author$project$Panel$Editor$Module$EmitChangeExpr(
							{
								aO: ((!termIndex) ? A2(author$project$Project$Source$Module$Def$Expr$replaceAndInsertHeadLastTerm, headTerm, opAndTermList) : A3(author$project$Project$Source$Module$Def$Expr$replaceAndInsertTermLastTerm, termIndex - 1, headTerm, opAndTermList))(expr),
								bW: index,
								b3: moduleRef
							})
						]),
						...
						_Utils_Tuple2(
							...
							author$project$Panel$Editor$Module$ActivePartDefExpr(
								A3(
									...
									termIndex + elm$core$List$length(opAndTermList),
									elm$core$Maybe$Nothing,
									(lastOp === 15) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(textAreaValue)))))),
				_List_fromArray(
					[
						author$project$Panel$Editor$Module$EmitChangeExpr(
						{
							aO: ((!termIndex) ? A3(author$project$Project$Source$Module$Def$Expr$replaceAndInsertHeadLastOp, headTerm, opAndTermList, lastOp) : A4(author$project$Project$Source$Module$Def$Expr$replaceAndInsertTermLastOp, termIndex, headTerm, opAndTermList, lastOp))(expr),
							bW: index,
							b3: moduleRef
						}),
						author$project$Panel$Editor$Module$textAreaValueToSetTextEmit(textAreaValue)
							...
							_Utils_Tuple2(
								...
								author$project$Panel$Editor$Module$ActivePartDefExpr(
									function () {
										...
										if (!_n1) {
											return author$project$Panel$Editor$Module$ActivePartDefExprSelf;
										} else {
											var length = _n1;
											return A3(
												author$project$Panel$Editor$Module$ActiveExprTerm,
												length,
												elm$core$Maybe$Nothing,
												_Utils_eq(textAreaValue, _List_Nil) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(textAreaValue));
										}
									}())))),
					_List_fromArray(
						[
						...
						if (_n1.a.$ === 1) {
							switch (_n1.a.a.b.$) {
								case 1:
									var _n3 = _n1.a.a;
									var index = _n3.a;
									var _n4 = A3(author$project$Panel$Editor$Module$parserBeginWithName, string, index, rec.t);
									var active = _n4.a;
									var emitList = _n4.b;
									return _Utils_Tuple2(
										_Utils_update(
								...
								case 2:
									var _n5 = _n1.a.a;
									var index = _n5.a;
									var _n6 = A3(author$project$Panel$Editor$Module$parserBeginWithType, string, index, rec.t);
									var active = _n6.a;
									var emitList = _n6.b;
									return _Utils_Tuple2(
										_Utils_update(
								...
								case 3:
									switch (_n1.a.a.b.a.$) {
										case 0:
											...
											var index = _n7.a;
											var _n8 = _n7.b.a;
											var _n9 = A3(author$project$Panel$Editor$Module$parserInExpr, string, index, rec.t);
											var active = _n9.a;
											var emitList = _n9.b;
											return _Utils_Tuple2(
												_Utils_update(
									...
									return author$project$Panel$Editor$Module$ActivePartDefList(
										author$project$Panel$Editor$Module$ActivePartDef(
											_Utils_Tuple2(
												index,
												author$project$Panel$Editor$Module$ActivePartDefExpr(
													A3(author$project$Panel$Editor$Module$ActiveExprTerm, 0, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing)))));
								} else {
									break _n0$5;
								}
							default:
										...
										return author$project$Panel$Editor$Module$ActivePartDefList(
											author$project$Panel$Editor$Module$ActivePartDef(
												_Utils_Tuple2(
													index,
													author$project$Panel$Editor$Module$ActivePartDefExpr(
														A3(author$project$Panel$Editor$Module$ActiveExprTerm, opIndex, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing)))));
									default:
										if (!active.a.a.b.a.a) {
											var _n14 = active.a.a;
											var index = _n14.a;
											...
											var index = _n18.a;
											var _n19 = _n18.b.a;
											var termIndex = _n19.a;
											return author$project$Panel$Editor$Module$ActivePartDefList(
												author$project$Panel$Editor$Module$ActivePartDef(
													_Utils_Tuple2(
														index,
														author$project$Panel$Editor$Module$ActivePartDefExpr(
															A3(author$project$Panel$Editor$Module$ActiveExprOp, termIndex - 1, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing)))));
										}
								}
						}
					}
										...
										return (_Utils_cmp(exprTermCount, termIndex + 1) < 0) ? author$project$Panel$Editor$Module$ActivePartDefList(
											...
											author$project$Panel$Editor$Module$ActivePartDef(
												_Utils_Tuple2(
													index,
													author$project$Panel$Editor$Module$ActivePartDefExpr(
														A3(author$project$Panel$Editor$Module$ActiveExprOp, termIndex, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing)))));
									default:
										var _n15 = active.a.a;
										var index = _n15.a;
										var _n16 = _n15.b.a;
										...
										return (_Utils_cmp(exprTermCount, opIndex + 1) < 0) ? author$project$Panel$Editor$Module$ActivePartDefList(
											...
											author$project$Panel$Editor$Module$ActivePartDef(
												_Utils_Tuple2(
													index,
													author$project$Panel$Editor$Module$ActivePartDefExpr(
														A3(author$project$Panel$Editor$Module$ActiveExprTerm, opIndex + 1, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing)))));
								}
						}
					}
			}
	...
	function (suggestIndex, defIndex, moduleRef) {
		...
		if (!_n0.$) {
			...
			return _List_fromArray(
				[
					author$project$Panel$Editor$Module$EmitChangeName(
					{bW: defIndex, aS: suggestName, b3: moduleRef})
				]);
		} else {
			return _List_Nil;
		}
...
var author$project$Panel$Editor$Module$suggestionPrevOrSelectDown = F3(
	function (module_, project, _n8) {
		var rec = _n8;
		var _n9 = rec.h;
		if ((((_n9.$ === 2) && (_n9.a.$ === 1)) && (_n9.a.a.b.$ === 1)) && (!_n9.a.a.b.a.$)) {
			var _n10 = _n9.a.a;
			var index = _n10.a;
			var _n11 = _n10.b.a.a;
			var textAreaValue = _n11.a;
			var suggestIndex = _n11.b;
			return _Utils_Tuple2(
				_Utils_update(
					rec,
					{
						h: author$project$Panel$Editor$Module$ActivePartDefList(
							author$project$Panel$Editor$Module$ActivePartDef(
								_Utils_Tuple2(
									index,
									author$project$Panel$Editor$Module$ActivePartDefName(
										elm$core$Maybe$Just(
											_Utils_Tuple2(textAreaValue, suggestIndex + 1))))))
					}),
				A3(author$project$Panel$Editor$Module$suggestionSelectChangedThenNameChangeEmit, suggestIndex, index, rec.t));
		} else {
...
var author$project$Panel$Editor$Module$suggestionPrevOrSelectUp = F3(
	function (module_, project, _n4) {
		var rec = _n4;
		var _n5 = rec.h;
		if ((((_n5.$ === 2) && (_n5.a.$ === 1)) && (_n5.a.a.b.$ === 1)) && (!_n5.a.a.b.a.$)) {
			var _n6 = _n5.a.a;
			var index = _n6.a;
			var _n7 = _n6.b.a.a;
			var textAreaValue = _n7.a;
			var suggestIndex = _n7.b;
			return _Utils_Tuple2(
				_Utils_update(
					rec,
					{
								...
								_Utils_Tuple2(
									...
									author$project$Panel$Editor$Module$ActivePartDefName(
										elm$core$Maybe$Just(
											_Utils_Tuple2(
												textAreaValue,
												A2(elm$core$Basics$max, 0, suggestIndex - 1)))))))
					}),
				A3(author$project$Panel$Editor$Module$suggestionSelectChangedThenNameChangeEmit, suggestIndex, index, rec.t));
		} else {
				...
				if (!index.a) {
					...
					return A2(
						...
						A2(
							...
							A2(author$project$Panel$EditorGroup$closeEditorColumn, editorRefColumn, rec.R)));
				} else {
					return group;
				}
			case 1:
...
var author$project$Panel$Editor$Module$FocusThisEditor = {$: 14};
		...
		switch (msg.$) {
			...
			case 5:
				...
				return _Utils_Tuple2(
					A2(
						author$project$Panel$EditorGroup$mapGroup,
						A2(author$project$Panel$EditorGroup$setEditorItem, rec.b3, newEditorItem),
						model),
					emit);
			case 6:
				...
				if (!gutter) {
					...
					return author$project$Panel$EditorGroup$RowThree(
						_Utils_update(
							rec,
							{
								H: A2(elm$core$Basics$max, 100, (rec.j + rec.H) - leftWidth),
								j: leftWidth
							}));
				} else {
					...
					return author$project$Panel$EditorGroup$RowThree(
						_Utils_update(
							rec,
							{
								H: A2(elm$core$Basics$max, 100, leftWidth - rec.j),
				...
				case 0:
					...
					return A2(
						...
						A2(
							...
							author$project$Model$getWindowSize(model).ce,
							x),
						model);
				case 1:
					var gutter = _n1.a.a;
					return A2(
						...
						A2(
							...
							{
								bN: author$project$Model$getWindowSize(model).ce - author$project$Model$getTreePanelWidth(model),
								b_: A2(
									elm$core$Basics$max,
									0,
				...
				default:
					...
					return A2(
						...
						A2(
							...
							{
								bM: author$project$Model$getWindowSize(model).bT,
...
var author$project$Panel$Editor$EditorKeyConfig$initModel = {aP: 0, aI: elm$core$Maybe$Nothing};
...
var author$project$Project$Source$ModuleWithCache$defAndResultSetCompileResult = F2(
	function (compileResult, _n0) {
		...
		return _Utils_update(
			rec,
			{
				ba: elm$core$Maybe$Just(compileResult)
			});
	});
			...
			function () {
				...
				if (!_n1.$) {
					...
					return elm$core$Maybe$Just(
						{
							bW: index,
							b3: author$project$Project$moduleRefToListInt(ref),
							cd: wasm
						});
				} else {
					return elm$core$Maybe$Nothing;
...
var author$project$Project$Source$ModuleWithCache$defAndResultSetEvalResult = F2(
	function (evalResult, _n0) {
		...
		return _Utils_update(
			rec,
			{
				ai: elm$core$Maybe$Just(evalResult)
			});
	});
...
var author$project$Panel$Tree$getOpenCloseData = function (_n0) {
	var openCloseData = _n0.aV;
	return openCloseData;
};
var author$project$Panel$Tree$isTreeOpen = F2(
	function (projectRef, _n0) {
		var isProjectRootOpen = _n0.aC;
		var isSourceOpen = _n0.aD;
		var isCoreOpen = _n0.aB;
		_n1$3:
		while (true) {
			if (!projectRef.$) {
				switch (projectRef.a.$) {
...
var author$project$NSvg$polygon = F3(
	function (points, strokeStyle, fillStyle) {
		return author$project$NSvg$Polygon(
			{V: elm$core$Maybe$Nothing, A: fillStyle, am: points, u: strokeStyle});
	});
...
var author$project$NSvg$rect = F3(
	function (_n0, strokeStyle, fillStyle) {
		...
		return author$project$NSvg$Rect(
			{V: elm$core$Maybe$Nothing, A: fillStyle, bT: height, u: strokeStyle, ce: width, cg: 0, ch: 0});
	});
...
var author$project$NSvg$circle = F3(
	function (r, strokeStyle, fillStyle) {
		return author$project$NSvg$Circle(
			{ax: 0, ay: 0, A: fillStyle, bu: r, u: strokeStyle});
	});
...
var author$project$Panel$Tree$baseTree = function (project) {
	return _List_fromArray(
		[
			...
			{m: _List_Nil, k: author$project$Panel$EditorTypeRef$EditorKeyConfig, r: author$project$Panel$Tree$moduleIcon, s: 'Editor Key Config'}
		]);
};
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'ref',
					elm$json$Json$Encode$list(elm$json$Json$Encode$int)($.b3)),
					_Utils_Tuple2(
					'wasm',
					elm$json$Json$Encode$list(elm$json$Json$Encode$int)($.cd))
				]));
	});
...
var author$project$Model$getEditorGroupPanelSize = function (model) {
	return {
		bT: author$project$Model$getWindowSize(model).bT,
		ce: author$project$Model$getWindowSize(model).ce - (author$project$Model$getTreePanelWidth(model) + author$project$Model$verticalGutterWidth)
	};
};
...
var author$project$NSvg$strokeStyleToSvgAttributes = function (strokeStyle) {
	if (!strokeStyle.$) {
		...
		var width = strokeStyle.a.ce;
		var strokeLineJoin = strokeStyle.a.aJ;
		return _Utils_ap(
			_List_fromArray(
				[
...
var author$project$NSvg$elementToSvg = function (nSvgElement) {
	switch (nSvgElement.$) {
		case 0:
			var x = nSvgElement.a.cg;
			var y = nSvgElement.a.ch;
			var width = nSvgElement.a.ce;
			var height = nSvgElement.a.bT;
			var strokeStyle = nSvgElement.a.u;
			var fillStyle = nSvgElement.a.A;
			var clickMsg = nSvgElement.a.V;
			return A2(
				elm$svg$Svg$rect,
				_Utils_ap(
					_List_fromArray(
...
var author$project$NSvg$polygonWithClickEvent = F4(
	function (points, strokeStyle, fillStyle, cliskMsg) {
		return author$project$NSvg$Polygon(
			{
				V: elm$core$Maybe$Just(cliskMsg),
				A: fillStyle,
				am: points,
				u: strokeStyle
			});
...
var author$project$NSvg$rectWithClickEvent = F4(
	function (_n0, strokeStyle, fillStyle, clickMsg) {
		...
		return author$project$NSvg$Rect(
			{
				V: elm$core$Maybe$Just(clickMsg),
				A: fillStyle,
				bT: height,
				u: strokeStyle,
				ce: width,
...
var author$project$NSvg$line = F3(
	function (_n0, _n1, strokeStyle) {
		...
		var y1 = _n1.b;
		return author$project$NSvg$Line(
			{u: strokeStyle, as: x0, at: x1, au: y0, av: y1});
	});
...
var author$project$Panel$Editor$EditorKeyConfig$selectFrame = function (oneKey) {
	...
	return A2(
		author$project$NSvg$translate,
		{cg: shapeData.a.a * 100, ch: shapeData.a.b * 100},
		A3(
...
var author$project$Panel$Editor$EditorKeyConfig$view = function (_n0) {
	var selectedKey = _n0.aI;
	var inputDevice = _n0.aP;
	return {
		bH: _List_fromArray(
			[
				A2(
		...
		default:
			switch (partDefActive.a.$) {
				...
				case 1:
					...
					return '先頭の項の前';
				case 2:
					if (partDefActive.a.c.$ === 1) {
						var _n5 = partDefActive.a;
						var index = _n5.a;
						var _n6 = _n5.c;
						return elm$core$String$fromInt(index) + '番目の項';
					} else {
						var _n7 = partDefActive.a;
						var index = _n7.a;
						return elm$core$String$fromInt(index) + '番目の項を編集中';
					}
				default:
					if (partDefActive.a.c.$ === 1) {
						var _n8 = partDefActive.a;
						var index = _n8.a;
						var _n9 = _n8.c;
						return elm$core$String$fromInt(index) + '番目の演算子';
					} else {
						var _n10 = partDefActive.a;
						var index = _n10.a;
						return elm$core$String$fromInt(index) + '番目の演算子を編集中';
					}
			}
	}
};
...
var author$project$Project$Source$Module$Def$Expr$opToShortDescription = function (op) {
	switch (op) {
		case 0:
			return 'パイプライン';
		case 1:
...
var author$project$Project$Source$Module$Def$Expr$opToDescription = function (op) {
	return _Utils_Tuple2(
		author$project$Project$Source$Module$Def$Expr$opToString(op),
		author$project$Project$Source$Module$Def$Expr$opToShortDescription(op));
};
var author$project$Panel$Editor$Module$suggestionOpItem = F2(
	function (op, isSelect) {
		var _n0 = author$project$Project$Source$Module$Def$Expr$opToDescription(op);
		var text = _n0.a;
		var subItem = _n0.b;
		return A2(
			elm$html$Html$div,
...
var author$project$Project$Source$Module$Def$Expr$App = 14;
var author$project$Project$Source$Module$Def$Expr$allOperator = _List_fromArray(
	...
	return A2(
		...
		_Utils_ap(
			...
			A2(
				...
				author$project$Project$Source$Module$Def$Expr$allOperator)));
};
...
var author$project$Project$Source$Module$Def$Expr$termToDescription = function (term) {
	switch (term.$) {
		case 0:
			var i = term.a;
			return _Utils_Tuple2(
		...
		default:
			var expr = term.a;
			return _Utils_Tuple2('かっこ', '優先的に中身を計算する');
	}
};
var author$project$Panel$Editor$Module$suggestionTerm = function (term) {
	var _n0 = author$project$Project$Source$Module$Def$Expr$termToDescription(term);
	var text = _n0.a;
	var subItem = _n0.b;
	return A2(
		elm$html$Html$div,
										...
										function (index, _n6) {
											...
											return _List_fromArray(
												[
													...
													elm$html$Html$map,
													elm$core$Basics$always(
														A3(author$project$Panel$Editor$Module$ActiveExprOp, index, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing)),
													A2(
													...
													elm$html$Html$map,
													elm$core$Basics$always(
														A3(author$project$Panel$Editor$Module$ActiveExprTerm, index + 1, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing)),
													A2(
														author$project$Panel$Editor$Module$termViewOutput,
														term,
														function () {
				...
				[
					...
					function () {
						if ((!partDefActiveMaybe.$) && (partDefActiveMaybe.a.$ === 1)) {
							var textAreaValueAndIndexMaybe = partDefActiveMaybe.a.a;
							return elm$core$Maybe$Just(textAreaValueAndIndexMaybe);
						} else {
							return elm$core$Maybe$Nothing;
						}
					}()),
							...
							elm$html$Html$map(
								function (m) {
									return author$project$Panel$EditorGroup$EditorItemMsg(
										{
											aR: author$project$Panel$EditorGroup$ModuleEditorMsg(m),
											b3: editorRef
										});
								}),
							viewItem.bH),
						...
						bH: A2(
							...
							elm$html$Html$map(
								function (m) {
									return author$project$Panel$EditorGroup$EditorItemMsg(
										{
											aR: author$project$Panel$EditorGroup$EditorKeyConfigMsg(m),
											b3: editorRef
										});
								}),
							viewItem.bH),
				...
				if (!columnGroup.$) {
					...
					return _List_fromArray(
						[
							...
							project,
							top,
							{bT: (((height - 2) * topHeight) / 1000) | 0, ce: width},
							_Utils_Tuple2(editorRefRow, 0),
							_Utils_eq(
								_Utils_Tuple2(editorRefRow, 0),
								activeEditorRef),
							...
							project,
							bottom,
							{bT: (((height - 2) * (1000 - topHeight)) / 1000) | 0, ce: width},
					...
					case 1:
						...
						return _List_fromArray(
							[
								...
								project,
								left,
								{bT: height, ce: (((width - 4) * leftWidth) / 1000) | 0},
								1,
								activeEditorIndex,
								0,
								_Utils_eq(
								...
								project,
								center,
								{bT: height, ce: (((width - 4) * (1000 - leftWidth)) / 1000) | 0},
								2,
								activeEditorIndex,
								1,
								_Utils_eq(
					...
					default:
						...
						return _List_fromArray(
							[
								...
								project,
								center,
								{bT: height, ce: (((width - 4) * centerWidth) / 1000) | 0},
								2,
								activeEditorIndex,
								1,
								_Utils_eq(
								...
								project,
								right,
								{bT: height, ce: (((width - 4) * ((1000 - leftWidth) - centerWidth)) / 1000) | 0},
								3,
								activeEditorIndex,
								2,
								_Utils_eq(
...
var author$project$Panel$Tree$view = function (_n0) {
	...
	return (100 < width) ? _Utils_ap(
		...
		A2(
			...
			{k: editorRef, az: focus, aX: project, ce: width},
			model)) : _List_Nil;
};
			...
			author$project$Panel$Tree$view(
				{
					...
					az: author$project$Model$isFocusTreePanel(model),
					bZ: author$project$Model$getTreePanelModel(model),
					aX: author$project$Model$getProject(model),
					ce: author$project$Model$getTreePanelWidth(model)
				})));
};
...
var author$project$Main$main = elm$browser$Browser$document(
	{bX: author$project$Main$init, b6: author$project$Main$subscriptions, ca: author$project$Update$update, cc: author$project$View$view});
