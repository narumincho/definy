...
keyboard oneKey =
    [ VectorImage.rect { width = 6500, height = 1800 } (VectorImage.strokeColorWidth black 3) VectorImage.fillNone ]
        ++ List.concat
            ((keyList
...
selectFrame oneKey =
    ...
    keyShapeToVectorImageShape shapeData.shape
        (VectorImage.strokeColorWidth (Css.rgb 255 165 0) 30)
...
keyShapeToVectorImage keyShape =
    keyShapeToVectorImageShape keyShape
        (VectorImage.strokeColorWidth black 20)
        (VectorImage.fillColor (Css.rgb 65 65 65))
...
backquoteKey =
    [ VectorImage.path "M 175.295 99.242 L 175.295 101.932 L 162.265 101.932 C 156.885 97.625 150.985 92.045 144.565 85.192 C 138.145 78.345 133.608 72.912 130.955 68.892 L 130.955 66.632 L 154.095 66.632 C 156.388 71.365 159.652 77.015 163.885 83.582 C 168.118 90.149 171.922 95.369 175.295 99.242 Z" VectorImage.strokeNone (VectorImage.fillColor white)
    , VectorImage.rect { width = 8, height = 105 } VectorImage.strokeNone (VectorImage.fillColor skyBlue)
        |> VectorImage.translate { x = 67, y = 155 }
    , VectorImage.rect { width = 88, height = 8 } VectorImage.strokeNone (VectorImage.fillColor skyBlue)
        |> VectorImage.translate { x = 28, y = 192 }
    , VectorImage.rect { width = 103, height = 8 } VectorImage.strokeNone (VectorImage.fillColor skyBlue)
        |> VectorImage.translate { x = 20, y = 219 }
    , VectorImage.path "M38,158 L51,182 L45,186 L31,161Z" VectorImage.strokeNone (VectorImage.fillColor skyBlue) -- 半の左上の点
    , VectorImage.path "M111,160 L96,187 L89,183 L102,157Z" VectorImage.strokeNone (VectorImage.fillColor skyBlue) -- 半の右上の点
    , VectorImage.path "M172,159 L138,271 L131,271 L164,159Z" VectorImage.strokeNone (VectorImage.fillColor skyBlue) -- /
    , VectorImage.path "M234,153 L284,196 L279,204 L231,162 L184,205 L180,197 L227,153 Z" VectorImage.strokeNone (VectorImage.fillColor skyBlue) -- 全の屋根
    , VectorImage.rect { width = 8, height = 60 } VectorImage.strokeNone (VectorImage.fillColor skyBlue)
        |> VectorImage.translate { x = 227, y = 196 }
    , VectorImage.rect { width = 68, height = 8 } VectorImage.strokeNone (VectorImage.fillColor skyBlue)
        |> VectorImage.translate { x = 199, y = 196 }
    , VectorImage.rect { width = 78, height = 8 } VectorImage.strokeNone (VectorImage.fillColor skyBlue)
        |> VectorImage.translate { x = 193, y = 222 }
    , VectorImage.rect { width = 97, height = 8 } VectorImage.strokeNone (VectorImage.fillColor skyBlue)
...
numpadAdd =
    [ VectorImage.path "M 142.985 350.285 L 142.985 314.175 L 106.775 314.175 L 106.775 300.145 L 142.985 300.145 L 142.985 263.845 L 157.015 263.845 L 157.015 300.145 L 193.225 300.145 L 193.225 314.175 L 157.015 314.175 L 157.015 350.285 L 142.985 350.285 Z M 139.615 249.715 Z" VectorImage.strokeNone (VectorImage.fillColor white) ]
...
numpadEnterKey =
    [ VectorImage.line ( 220, 100 ) ( 220, 500 ) (VectorImage.strokeColorWidth white 10)
    , VectorImage.line ( 220, 500 ) ( 80, 500 ) (VectorImage.strokeColorWidth white 10)
    , VectorImage.line ( 80, 500 ) ( 100, 480 ) (VectorImage.strokeColorWidth white 10)
    , VectorImage.line ( 80, 500 ) ( 100, 520 ) (VectorImage.strokeColorWidth white 10)
    ]
