...
typePartIdWithParameterToJsonValue typePartIdWithParameter =
    Je.object
        [ ( "typePartId", typeIdToJsonValue typePartIdWithParameter.typePartId )
