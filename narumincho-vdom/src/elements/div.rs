...
impl From<DivAutocapitalize> for String {
    fn from(value: DivAutocapitalize) -> Self {
...
impl From<DivDir> for String {
    fn from(value: DivDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<DivPopover> for String {
    fn from(value: DivPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-div-element
