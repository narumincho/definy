...
pub enum FieldsetAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<FieldsetAutocapitalize> for String {
    fn from(value: FieldsetAutocapitalize) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum FieldsetDir {
    Ltr,
    Rtl,
    Auto,
}
...
impl From<FieldsetDir> for String {
    fn from(value: FieldsetDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum FieldsetPopover {
    Auto,
    Manual,
}

impl FieldsetPopover {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Auto => "auto",
            Self::Manual => "manual",
...
impl From<FieldsetPopover> for String {
    fn from(value: FieldsetPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/form-elements.html#the-fieldset-element
...
impl Fieldset {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "fieldset".to_string(),
...
impl From<Fieldset> for crate::Node {
