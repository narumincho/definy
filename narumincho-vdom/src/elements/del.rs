...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/edits.html#the-del-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct DelJsProperties {
...
impl Del {
    ...
    pub fn date_time(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("dateTime".to_string(), value.clone());
