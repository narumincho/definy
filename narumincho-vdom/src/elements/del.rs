...
impl From<DelAutocapitalize> for String {
    fn from(value: DelAutocapitalize) -> Self {
...
impl From<DelDir> for String {
    fn from(value: DelDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<DelPopover> for String {
    fn from(value: DelPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/edits.html#the-del-element
