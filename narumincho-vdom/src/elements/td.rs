...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/tables.html#the-td-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct TdJsProperties {
    ...
    pub cell_index: std::option::Option<String>,
