...
impl Td {
    ...
    pub fn abbr(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("abbr".to_string(), value.into());
        self
    }
    ...
    pub fn axis(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("axis".to_string(), value.into());
        self
    }
    ...
    pub fn ch(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("ch".to_string(), value.into());
        self
    }

    pub fn ch_off(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("chOff".to_string(), value.into());
        self
    }

    pub fn headers(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("headers".to_string(), value.into());
        self
    }
    ...
    pub fn scope(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("scope".to_string(), value.into());
        self
    }
    ...
    pub fn v_align(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("vAlign".to_string(), value.into());
        self
    }
