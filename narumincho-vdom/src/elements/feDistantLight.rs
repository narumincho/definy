...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fedistantlight
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fedistantlight
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeDistantLightJsProperties {
    ...
    pub azimuth: std::option::Option<String>,
    ...
    pub elevation: std::option::Option<String>,
...
pub fn feDistantLight() -> FeDistantLight {
    FeDistantLight::default()
}
...
impl FeDistantLight {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::FeDistantLight(self),
            children: Vec::new(),
        })
    }
