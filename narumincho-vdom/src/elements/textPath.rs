...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/text.html#elementdef-textPath
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct TextPathJsProperties {
    ...
    pub spacing: std::option::Option<String>,
