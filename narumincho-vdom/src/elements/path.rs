...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/paths.html#elementdef-path
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/paths.html#elementdef-path
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct PathJsProperties {
