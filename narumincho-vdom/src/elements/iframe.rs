...
pub struct IframeJsProperties {
    ...
    pub permissions_policy: std::option::Option<String>,
...
impl Iframe {
    ...
    pub fn allow_fullscreen(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("allowFullscreen".to_string(), String::new());
        } else {
    ...
    pub fn credentialless(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("credentialless".to_string(), String::new());
        } else {
    ...
    pub fn frame_border(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("frameBorder".to_string(), value.clone());
    ...
    pub fn long_desc(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("longDesc".to_string(), value.clone());
    ...
    pub fn margin_height(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("marginHeight".to_string(), value.clone());
    ...
    pub fn margin_width(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("marginWidth".to_string(), value.clone());
    ...
    pub fn private_token(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("privateToken".to_string(), value.clone());
    ...
    pub fn scrolling(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("scrolling".to_string(), value.clone());
