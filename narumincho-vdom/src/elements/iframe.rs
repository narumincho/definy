...
impl Iframe {
    ...
    pub fn allow(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("allow".to_string(), value.clone());
        self.allow = Some(value);
        self
    }

    pub fn allow_fullscreen(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("allowFullscreen".to_string(), String::new());
        } else {
            self.attributes.remove("allowFullscreen");
        }
        self.allow_fullscreen = Some(value);
        self
    }
    ...
    pub fn credentialless(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("credentialless".to_string(), String::new());
        } else {
            self.attributes.remove("credentialless");
        }
    ...
    pub fn csp(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("csp".to_string(), value.clone());
        self.csp = Some(value);
        self
    }
    ...
    pub fn frame_border(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("frameBorder".to_string(), value.clone());
        self.frame_border = Some(value);
        self
    }
    ...
    pub fn long_desc(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("longDesc".to_string(), value.clone());
        self.long_desc = Some(value);
        self
    }

    pub fn margin_height(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("marginHeight".to_string(), value.clone());
        self.margin_height = Some(value);
        self
    }

    pub fn margin_width(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("marginWidth".to_string(), value.clone());
    ...
    pub fn private_token(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("privateToken".to_string(), value.clone());
        self.private_token = Some(value);
        self
    }
    ...
    pub fn sandbox(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("sandbox".to_string(), value.clone());
    ...
    pub fn scrolling(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("scrolling".to_string(), value.clone());
        self.scrolling = Some(value);
        self
    }
    ...
    pub fn srcdoc(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("srcdoc".to_string(), value.clone());
        self.srcdoc = Some(value);
        self
    }
