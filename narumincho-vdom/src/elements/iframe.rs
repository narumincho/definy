...
impl Iframe {
    ...
    pub fn csp(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("csp".to_string(), value.into());
        self
    }

    pub fn frame_border(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("frameBorder".to_string(), value.into());
        self
    }
    ...
    pub fn long_desc(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("longDesc".to_string(), value.into());
        self
    }

    pub fn margin_height(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("marginHeight".to_string(), value.into());
        self
    }

    pub fn margin_width(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("marginWidth".to_string(), value.into());
        self
    }
    ...
    pub fn private_token(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("privateToken".to_string(), value.into());
        self
    }
    ...
    pub fn sandbox(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("sandbox".to_string(), value.into());
        self
    }

    pub fn scrolling(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("scrolling".to_string(), value.into());
        self
    }
    ...
    pub fn srcdoc(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("srcdoc".to_string(), value.into());
        self
    }
