...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-munder
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-munder
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MunderJsProperties {
...
impl Munder {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Munder(self),
            children: Vec::new(),
        })
    }
