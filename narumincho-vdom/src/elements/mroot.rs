...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mroot
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-mroot
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MrootJsProperties {
...
impl Mroot {
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::Mroot(self),
            children,
        }
    }
}
