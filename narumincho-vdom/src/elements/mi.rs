...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mi
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-mi
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MiJsProperties {
...
impl Mi {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Mi(self),
            children: Vec::new(),
        })
    }
