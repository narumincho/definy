...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-feconvolvematrix
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-feconvolvematrix
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeConvolveMatrixJsProperties {
