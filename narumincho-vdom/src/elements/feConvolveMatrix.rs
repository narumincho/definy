...
pub struct FeConvolveMatrix {
    ...
    pub bias: std::option::Option<String>,
    ...
    pub divisor: std::option::Option<String>,
    pub double: std::option::Option<String>,
    pub edge_mode: std::option::Option<String>,
    ...
    pub kernel_matrix: std::option::Option<String>,
    pub kernel_unit_length_x: std::option::Option<String>,
    pub kernel_unit_length_y: std::option::Option<String>,
    ...
    pub order_x: std::option::Option<String>,
    pub order_y: std::option::Option<String>,
    ...
    pub preserve_alpha: std::option::Option<String>,
    ...
    pub target_x: std::option::Option<String>,
    pub target_y: std::option::Option<String>,
...
impl FeConvolveMatrix {
    ...
    pub fn divisor(mut self, value: impl Into<String>) -> Self {
        self.divisor = Some(value.into());
        self
    }
    ...
    pub fn edge_mode(mut self, value: impl Into<String>) -> Self {
        self.edge_mode = Some(value.into());
        self
    }
    ...
    pub fn in1(mut self, value: impl Into<String>) -> Self {
        self.in1 = Some(value.into());
        self
    }
    ...
    pub fn kernel_matrix(mut self, value: impl Into<String>) -> Self {
        self.kernel_matrix = Some(value.into());
        self
    }

    pub fn kernel_unit_length_x(mut self, value: impl Into<String>) -> Self {
        self.kernel_unit_length_x = Some(value.into());
        self
    }

    pub fn kernel_unit_length_y(mut self, value: impl Into<String>) -> Self {
        self.kernel_unit_length_y = Some(value.into());
        self
    }
    ...
    pub fn order_x(mut self, value: impl Into<String>) -> Self {
        self.order_x = Some(value.into());
        self
    }

    pub fn order_y(mut self, value: impl Into<String>) -> Self {
        self.order_y = Some(value.into());
        self
    }
    ...
    pub fn preserve_alpha(mut self, value: impl Into<String>) -> Self {
        self.preserve_alpha = Some(value.into());
        self
    }
    ...
    pub fn target_x(mut self, value: impl Into<String>) -> Self {
        self.target_x = Some(value.into());
        self
    }

    pub fn target_y(mut self, value: impl Into<String>) -> Self {
        self.target_y = Some(value.into());
        self
    }
