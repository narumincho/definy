...
pub struct FeDisplacementMap {
    ...
    pub in2: std::option::Option<String>,
    ...
    pub scale: std::option::Option<String>,
    ...
    pub x_channel_selector: std::option::Option<String>,
    pub y: std::option::Option<String>,
    pub y_channel_selector: std::option::Option<String>,
}

pub fn feDisplacementMap() -> FeDisplacementMap {
    FeDisplacementMap::default()
}
...
impl FeDisplacementMap {
    ...
    pub fn in2(mut self, value: impl Into<String>) -> Self {
        self.in2 = Some(value.into());
        self
    }
    ...
    pub fn scale(mut self, value: impl Into<String>) -> Self {
    ...
    pub fn x_channel_selector(mut self, value: impl Into<String>) -> Self {
        self.x_channel_selector = Some(value.into());
        self
    }
    ...
    pub fn y_channel_selector(mut self, value: impl Into<String>) -> Self {
        self.y_channel_selector = Some(value.into());
        self
    }
