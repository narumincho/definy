...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fedisplacementmap
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fedisplacementmap
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeDisplacementMapJsProperties {
