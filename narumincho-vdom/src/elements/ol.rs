...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/grouping-content.html#the-ol-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct OlJsProperties {
...
impl Ol {
    ...
    pub fn reversed(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("reversed".to_string(), String::new());
        } else {
