...
impl From<OlAutocapitalize> for String {
    fn from(value: OlAutocapitalize) -> Self {
...
impl From<OlDir> for String {
    fn from(value: OlDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<OlPopover> for String {
    fn from(value: OlPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-ol-element
...
impl Ol {
    ...
    pub fn compact(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "compact");
        if value {
            self.attributes.push(("compact".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn reversed(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "reversed");
        if value {
            self.attributes
                .push(("reversed".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn start(self, value: impl Into<String>) -> Self {
        self.attribute("start", value)
    }
...
impl From<Ol> for crate::Node {
    fn from(value: Ol) -> Self {
        value.into_node()
    }
}
