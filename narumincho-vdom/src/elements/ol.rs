...
impl Ol {
    ...
    pub fn compact(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("compact".to_string(), String::new());
        } else {
            self.attributes.remove("compact");
        }
    ...
    pub fn reversed(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("reversed".to_string(), String::new());
        } else {
            self.attributes.remove("reversed");
        }
        self.reversed = Some(value);
        self
    }
    ...
    pub fn start(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("start".to_string(), value.clone());
