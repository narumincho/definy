...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fefunca
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fefunca
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeFuncAJsProperties {
