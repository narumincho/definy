...
impl From<AudioAutocapitalize> for String {
    fn from(value: AudioAutocapitalize) -> Self {
...
impl From<AudioCrossOrigin> for String {
    fn from(value: AudioCrossOrigin) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<AudioDir> for String {
    fn from(value: AudioDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum AudioPopover {
    Auto,
    Manual,
}
...
impl From<AudioPopover> for String {
    fn from(value: AudioPopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<AudioPreload> for String {
    fn from(value: AudioPreload) -> Self {
        value.as_str().to_string()
    }
}
...
impl Audio {
    ...
    pub fn autoplay(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "autoplay");
        if value {
            self.attributes
    ...
    pub fn controls(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "controls");
        if value {
            self.attributes
                .push(("controls".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn current_time(self, value: impl Into<String>) -> Self {
        self.attribute("currentTime", value)
    }

    pub fn default_muted(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "defaultMuted");
        if value {
            self.attributes
                .push(("defaultMuted".to_string(), String::new()));
        }
        self
    }

    pub fn default_playback_rate(self, value: impl Into<String>) -> Self {
    ...
    pub fn disable_remote_playback(mut self, value: bool) -> Self {
        self.attributes
            .retain(|(key, _)| key != "disableRemotePlayback");
        if value {
            self.attributes
                .push(("disableRemotePlayback".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn loop_(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "loop");
        if value {
            self.attributes.push(("loop".to_string(), String::new()));
        }
        self
    }

    pub fn muted(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "muted");
        if value {
    ...
    pub fn playback_rate(self, value: impl Into<String>) -> Self {
        self.attribute("playbackRate", value)
    }

    pub fn preload(self, value: impl Into<String>) -> Self {
        self.attribute("preload", value)
    }

    pub fn preserves_pitch(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "preservesPitch");
        if value {
            self.attributes
                .push(("preservesPitch".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn src_object(self, value: impl Into<String>) -> Self {
    ...
    pub fn on_encrypted(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("encrypted".to_string(), handler));
        self
    }
...
impl From<Audio> for crate::Node {
