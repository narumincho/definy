...
pub enum AudioCrossOrigin {
    Anonymous,
    UseCredentials,
}

impl AudioCrossOrigin {
...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/media.html#audio
...
pub struct Audio {
    ...
    pub preload: std::option::Option<AudioPreload>,
...
impl Audio {
    ...
    pub fn cross_origin(mut self, value: AudioCrossOrigin) -> Self {
    ...
    pub fn preload(mut self, value: AudioPreload) -> Self {
