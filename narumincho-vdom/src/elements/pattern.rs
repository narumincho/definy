...
pub struct Pattern {
    ...
    pub pattern_content_units: std::option::Option<String>,
    pub pattern_transform: std::option::Option<String>,
    pub pattern_units: std::option::Option<String>,
...
impl Pattern {
    ...
    pub fn pattern_content_units(mut self, value: impl Into<String>) -> Self {
        self.pattern_content_units = Some(value.into());
        self
    }

    pub fn pattern_transform(mut self, value: impl Into<String>) -> Self {
        self.pattern_transform = Some(value.into());
        self
    }

    pub fn pattern_units(mut self, value: impl Into<String>) -> Self {
        self.pattern_units = Some(value.into());
        self
    }
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::Pattern(self),
            children,
        }
    }
}
