...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/pservers.html#elementdef-pattern
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/pservers.html#elementdef-pattern
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct PatternJsProperties {
