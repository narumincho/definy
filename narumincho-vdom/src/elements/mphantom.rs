...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mphantom
...
impl Mphantom {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "mphantom".to_string(),
...
impl From<Mphantom> for crate::Node {
    fn from(value: Mphantom) -> Self {
        value.into_node()
    }
}
