...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/sections.html#the-body-element
...
pub struct Body {
    ...
    pub a_link: std::option::Option<String>,
    ...
    pub v_link: std::option::Option<String>,
...
impl Body {
    ...
    pub fn a_link(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("aLink".to_string(), value.clone());
        self.a_link = Some(value);
        self
    }
    ...
    pub fn autocorrect(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("autocorrect".to_string(), String::new());
        } else {
    ...
    pub fn background(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("background".to_string(), value.clone());
    ...
    pub fn bg_color(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("bgColor".to_string(), value.clone());
    ...
    pub fn link(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("link".to_string(), value.clone());
    ...
    pub fn text(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("text".to_string(), value.clone());
    ...
    pub fn v_link(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("vLink".to_string(), value.clone());
        self.v_link = Some(value);
        self
    }

    pub fn virtual_keyboard_policy(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("virtualKeyboardPolicy".to_string(), value.clone());
    ...
    pub fn writing_suggestions(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("writingSuggestions".to_string(), value.clone());
    ...
    pub fn on_afterprint(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("afterprint".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_beforeprint(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("beforeprint".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_beforeunload(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("beforeunload".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_gamepadconnected(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("gamepadconnected".to_string(), handler.into()));
        self
    }

    pub fn on_gamepaddisconnected(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("gamepaddisconnected".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_hashchange(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("hashchange".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_languagechange(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("languagechange".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_message(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("message".to_string(), handler.into()));
        self
    }

    pub fn on_messageerror(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("messageerror".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_offline(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("offline".to_string(), handler.into()));
        self
    }

    pub fn on_line(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("line".to_string(), handler.into()));
        self
    }

    pub fn on_orientationchange(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("orientationchange".to_string(), handler.into()));
        self
    }

    pub fn on_pagehide(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("pagehide".to_string(), handler.into()));
        self
    }

    pub fn on_pagereveal(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("pagereveal".to_string(), handler.into()));
        self
    }

    pub fn on_pageshow(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("pageshow".to_string(), handler.into()));
        self
    }

    pub fn on_pageswap(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("pageswap".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_popstate(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("popstate".to_string(), handler.into()));
        self
    }

    pub fn on_portalactivate(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("portalactivate".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_rejectionhandled(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("rejectionhandled".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_storage(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("storage".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_unhandledrejection(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("unhandledrejection".to_string(), handler.into()));
        self
    }

    pub fn on_unload(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("unload".to_string(), handler.into()));
        self
    }
