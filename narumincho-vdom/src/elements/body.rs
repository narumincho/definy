...
impl From<BodyAutocapitalize> for String {
    fn from(value: BodyAutocapitalize) -> Self {
...
impl From<BodyDir> for String {
    fn from(value: BodyDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum BodyPopover {
    Auto,
    Manual,
}
...
impl From<BodyPopover> for String {
    fn from(value: BodyPopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl Body {
    ...
    pub fn bg_color(self, value: impl Into<String>) -> Self {
    ...
    pub fn link(self, value: impl Into<String>) -> Self {
        self.attribute("link", value)
    }
    ...
    pub fn v_link(self, value: impl Into<String>) -> Self {
        self.attribute("vLink", value)
    }
    ...
    pub fn on_afterprint(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("afterprint".to_string(), handler));
        self
    }
    ...
    pub fn on_beforeprint(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("beforeprint".to_string(), handler));
        self
    }
    ...
    pub fn on_beforeunload(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("beforeunload".to_string(), handler));
        self
    }
    ...
    pub fn on_gamepadconnected(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("gamepadconnected".to_string(), handler));
        self
    }

    pub fn on_gamepaddisconnected(mut self, handler: crate::EventHandler) -> Self {
        self.events
            .push(("gamepaddisconnected".to_string(), handler));
        self
    }
    ...
    pub fn on_hashchange(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("hashchange".to_string(), handler));
        self
    }
    ...
    pub fn on_languagechange(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("languagechange".to_string(), handler));
        self
    }
    ...
    pub fn on_message(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("message".to_string(), handler));
        self
    }

    pub fn on_messageerror(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("messageerror".to_string(), handler));
        self
    }
    ...
    pub fn on_offline(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("offline".to_string(), handler));
        self
    }

    pub fn on_line(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("line".to_string(), handler));
        self
    }

    pub fn on_orientationchange(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("orientationchange".to_string(), handler));
        self
    }

    pub fn on_pagehide(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("pagehide".to_string(), handler));
        self
    }

    pub fn on_pagereveal(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("pagereveal".to_string(), handler));
        self
    }

    pub fn on_pageshow(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("pageshow".to_string(), handler));
        self
    }

    pub fn on_pageswap(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("pageswap".to_string(), handler));
        self
    }
    ...
    pub fn on_popstate(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("popstate".to_string(), handler));
        self
    }

    pub fn on_portalactivate(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("portalactivate".to_string(), handler));
        self
    }
    ...
    pub fn on_rejectionhandled(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("rejectionhandled".to_string(), handler));
        self
    }
    ...
    pub fn on_storage(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("storage".to_string(), handler));
        self
    }
    ...
    pub fn on_unhandledrejection(mut self, handler: crate::EventHandler) -> Self {
        self.events
            .push(("unhandledrejection".to_string(), handler));
        self
    }

    pub fn on_unload(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("unload".to_string(), handler));
        self
    }
