...
impl Body {
    ...
    pub fn a_link(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("aLink".to_string(), value.into());
        self
    }
    ...
    pub fn background(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("background".to_string(), value.into());
        self
    }

    pub fn bg_color(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("bgColor".to_string(), value.into());
        self
    }

    pub fn link(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("link".to_string(), value.into());
        self
    }
    ...
    pub fn v_link(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("vLink".to_string(), value.into());
        self
    }
