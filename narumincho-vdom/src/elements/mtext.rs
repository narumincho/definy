...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mtext
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-mtext
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MtextJsProperties {
...
impl Mtext {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Mtext(self),
            children: Vec::new(),
        })
    }
