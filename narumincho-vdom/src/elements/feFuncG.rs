...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fefuncg
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fefuncg
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeFuncGJsProperties {
