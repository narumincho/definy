...
pub struct FeFuncG {
    ...
    pub amplitude: std::option::Option<String>,
    ...
    pub exponent: std::option::Option<String>,
    ...
    pub intercept: std::option::Option<String>,
    ...
    pub slope: std::option::Option<String>,
    pub table_values: std::option::Option<String>,
...
impl FeFuncG {
    ...
    pub fn amplitude(mut self, value: impl Into<String>) -> Self {
        self.amplitude = Some(value.into());
        self
    }
    ...
    pub fn exponent(mut self, value: impl Into<String>) -> Self {
        self.exponent = Some(value.into());
        self
    }
    ...
    pub fn intercept(mut self, value: impl Into<String>) -> Self {
    ...
    pub fn slope(mut self, value: impl Into<String>) -> Self {
        self.slope = Some(value.into());
        self
    }

    pub fn table_values(mut self, value: impl Into<String>) -> Self {
        self.table_values = Some(value.into());
        self
    }
