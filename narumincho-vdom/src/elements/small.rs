...
impl From<SmallAutocapitalize> for String {
    fn from(value: SmallAutocapitalize) -> Self {
...
impl From<SmallDir> for String {
    fn from(value: SmallDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum SmallPopover {
    Auto,
    Manual,
}
...
impl From<SmallPopover> for String {
    fn from(value: SmallPopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<Small> for crate::Node {
