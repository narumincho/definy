...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/image-maps.html#the-area-element
...
pub struct Area {
    ...
    pub no_href: std::option::Option<bool>,
    ...
    pub target: std::option::Option<AreaTarget>,
...
impl Area {
    ...
    pub fn coords(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("coords".to_string(), value.clone());
    ...
    pub fn download(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("download".to_string(), value.clone());
    ...
    pub fn hash(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("hash".to_string(), value.clone());
    ...
    pub fn host(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("host".to_string(), value.clone());
    ...
    pub fn hostname(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("hostname".to_string(), value.clone());
    ...
    pub fn no_href(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("noHref".to_string(), String::new());
        } else {
            self.attributes.remove("noHref");
        }
        self.no_href = Some(value);
        self
    }

    pub fn password(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("password".to_string(), value.clone());
        self.password = Some(value);
        self
    }

    pub fn pathname(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("pathname".to_string(), value.clone());
        self.pathname = Some(value);
        self
    }

    pub fn ping(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("ping".to_string(), value.clone());
    ...
    pub fn port(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("port".to_string(), value.clone());
    ...
    pub fn protocol(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("protocol".to_string(), value.clone());
    ...
    pub fn search(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("search".to_string(), value.clone());
    ...
    pub fn shape(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("shape".to_string(), value.clone());
        self.shape = Some(value);
        self
    }

    pub fn target(mut self, value: AreaTarget) -> Self {
    ...
    pub fn username(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("username".to_string(), value.clone());
