...
impl Area {
    ...
    pub fn hash(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("hash".to_string(), value.into());
        self
    }

    pub fn host(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("host".to_string(), value.into());
        self
    }

    pub fn hostname(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("hostname".to_string(), value.into());
        self
    }
    ...
    pub fn password(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("password".to_string(), value.into());
        self
    }

    pub fn pathname(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("pathname".to_string(), value.into());
        self
    }

    pub fn ping(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("ping".to_string(), value.into());
        self
    }

    pub fn port(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("port".to_string(), value.into());
        self
    }

    pub fn protocol(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("protocol".to_string(), value.into());
        self
    }
    ...
    pub fn rel(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("rel".to_string(), value.into());
        self
    }
    ...
    pub fn search(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("search".to_string(), value.into());
        self
    }
