...
pub enum DatalistAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<DatalistAutocapitalize> for String {
    fn from(value: DatalistAutocapitalize) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum DatalistDir {
    Ltr,
    Rtl,
    Auto,
}
...
impl From<DatalistDir> for String {
    fn from(value: DatalistDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum DatalistPopover {
    Auto,
    Manual,
}

impl DatalistPopover {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Auto => "auto",
            Self::Manual => "manual",
...
impl From<DatalistPopover> for String {
    fn from(value: DatalistPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/form-elements.html#the-datalist-element
...
impl Datalist {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "datalist".to_string(),
...
impl From<Datalist> for crate::Node {
