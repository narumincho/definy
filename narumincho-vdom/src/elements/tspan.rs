...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/text.html#elementdef-tspan
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/text.html#elementdef-tspan
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct TspanJsProperties {
