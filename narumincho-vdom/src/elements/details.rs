...
pub enum DetailsAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<DetailsAutocapitalize> for String {
    fn from(value: DetailsAutocapitalize) -> Self {
...
impl From<DetailsDir> for String {
    fn from(value: DetailsDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum DetailsPopover {
    Auto,
    Manual,
}
...
impl From<DetailsPopover> for String {
    fn from(value: DetailsPopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl Details {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "details".to_string(),
...
impl From<Details> for crate::Node {
