...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mpadded
...
impl Mpadded {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "mpadded".to_string(),
...
impl From<Mpadded> for crate::Node {
    fn from(value: Mpadded) -> Self {
        value.into_node()
    }
}
