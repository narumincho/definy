...
impl From<SAutocapitalize> for String {
    fn from(value: SAutocapitalize) -> Self {
...
impl From<SDir> for String {
    fn from(value: SDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<SPopover> for String {
    fn from(value: SPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-s-element
