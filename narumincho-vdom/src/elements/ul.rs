...
impl From<UlAutocapitalize> for String {
    fn from(value: UlAutocapitalize) -> Self {
...
impl From<UlDir> for String {
    fn from(value: UlDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<UlPopover> for String {
    fn from(value: UlPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-ul-element
