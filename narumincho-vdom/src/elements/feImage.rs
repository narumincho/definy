...
pub enum FeImageCrossOrigin {
    Anonymous,
    UseCredentials,
}

impl FeImageCrossOrigin {
...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-feimage
...
pub struct FeImage {
    ...
    pub cross_origin: std::option::Option<FeImageCrossOrigin>,
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-feimage
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeImageJsProperties {
...
impl FeImage {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::FeImage(self),
            children: Vec::new(),
        })
    }
    ...
    pub fn cross_origin(mut self, value: FeImageCrossOrigin) -> Self {
        self.attributes
