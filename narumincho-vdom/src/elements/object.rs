...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/iframe-embed-object.html#the-object-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct ObjectJsProperties {
...
impl Object {
    ...
    pub fn code_base(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("codeBase".to_string(), value.clone());
    ...
    pub fn code_type(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("codeType".to_string(), value.clone());
