...
pub struct Object {
    ...
    pub declare: std::option::Option<bool>,
...
impl Object {
    ...
    pub fn archive(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("archive".to_string(), value.clone());
    ...
    pub fn code(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("code".to_string(), value.clone());
    ...
    pub fn code_base(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("codeBase".to_string(), value.clone());
        self.code_base = Some(value);
        self
    }

    pub fn code_type(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("codeType".to_string(), value.clone());
        self.code_type = Some(value);
        self
    }

    pub fn data(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("data".to_string(), value.clone());
    ...
    pub fn standby(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("standby".to_string(), value.clone());
