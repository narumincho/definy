...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-femerge
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-femerge
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeMergeJsProperties {
