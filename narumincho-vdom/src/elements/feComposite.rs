...
pub struct FeComposite {
    ...
    pub k1: std::option::Option<String>,
    pub k2: std::option::Option<String>,
    pub k3: std::option::Option<String>,
    pub k4: std::option::Option<String>,
...
impl FeComposite {
    ...
    pub fn k1(mut self, value: impl Into<String>) -> Self {
        self.k1 = Some(value.into());
        self
    }

    pub fn k2(mut self, value: impl Into<String>) -> Self {
        self.k2 = Some(value.into());
        self
    }

    pub fn k3(mut self, value: impl Into<String>) -> Self {
        self.k3 = Some(value.into());
        self
    }

    pub fn k4(mut self, value: impl Into<String>) -> Self {
        self.k4 = Some(value.into());
        self
    }
