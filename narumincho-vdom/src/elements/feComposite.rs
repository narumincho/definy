...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fecomposite
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fecomposite
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeCompositeJsProperties {
