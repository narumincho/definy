...
impl Table {
    ...
    pub fn caption(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("caption".to_string(), value.into());
        self
    }

    pub fn cell_padding(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("cellPadding".to_string(), value.into());
        self
    }

    pub fn cell_spacing(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("cellSpacing".to_string(), value.into());
        self
    }

    pub fn frame(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("frame".to_string(), value.into());
        self
    }
    ...
    pub fn rows(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("rows".to_string(), value.into());
        self
    }

    pub fn rules(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("rules".to_string(), value.into());
        self
    }

    pub fn summary(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("summary".to_string(), value.into());
        self
    }

    pub fn t_foot(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("tFoot".to_string(), value.into());
        self
    }

    pub fn t_head(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("tHead".to_string(), value.into());
        self
    }
