...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/tables.html#the-table-element
...
pub struct Table {
    ...
    pub cell_padding: std::option::Option<String>,
    pub cell_spacing: std::option::Option<String>,
    ...
    pub t_foot: std::option::Option<String>,
    pub t_head: std::option::Option<String>,
...
impl Table {
    ...
    pub fn border(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("border".to_string(), value.clone());
    ...
    pub fn caption(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("caption".to_string(), value.clone());
        self.caption = Some(value);
        self
    }

    pub fn cell_padding(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("cellPadding".to_string(), value.clone());
        self.cell_padding = Some(value);
        self
    }

    pub fn cell_spacing(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("cellSpacing".to_string(), value.clone());
        self.cell_spacing = Some(value);
        self
    }

    pub fn frame(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("frame".to_string(), value.clone());
    ...
    pub fn rows(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("rows".to_string(), value.clone());
    ...
    pub fn rules(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("rules".to_string(), value.clone());
    ...
    pub fn summary(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("summary".to_string(), value.clone());
        self.summary = Some(value);
        self
    }

    pub fn t_foot(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("tFoot".to_string(), value.clone());
        self.t_foot = Some(value);
        self
    }

    pub fn t_head(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("tHead".to_string(), value.clone());
        self.t_head = Some(value);
        self
    }
