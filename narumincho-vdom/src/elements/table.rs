...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/tables.html#the-table-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct TableJsProperties {
    ...
    pub t_bodies: std::option::Option<String>,
...
impl Table {
    ...
    pub fn cell_padding(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("cellPadding".to_string(), value.clone());
    ...
    pub fn cell_spacing(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("cellSpacing".to_string(), value.clone());
