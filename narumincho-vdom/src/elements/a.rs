...
impl From<AnchorTarget> for String {
    fn from(value: AnchorTarget) -> Self {
        value.as_str().to_string()
    }
}
...
pub fn a<L: crate::Route>() -> Anchor<L> {
    Anchor::new()
}

impl<L: crate::Route> Default for Anchor<L> {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<L: crate::Route> Anchor<L> {
    ...
    pub fn href(self, href: impl Into<crate::Href<L>>) -> Self {
        self.attribute("href", href.into())
    }
}
impl<L: crate::Route> From<Anchor<L>> for crate::Node {
    fn from(value: Anchor<L>) -> Self {
        value.into_node()
    }
}
