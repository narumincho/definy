...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-feoffset
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-feoffset
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeOffsetJsProperties {
