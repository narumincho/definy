...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fegaussianblur
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fegaussianblur
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeGaussianBlurJsProperties {
