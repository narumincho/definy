...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mspace
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-mspace
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MspaceJsProperties {
...
impl Mspace {
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::Mspace(self),
            children,
        }
    }
}
