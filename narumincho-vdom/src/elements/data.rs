...
impl From<DataAutocapitalize> for String {
    fn from(value: DataAutocapitalize) -> Self {
...
impl From<DataPopover> for String {
    fn from(value: DataPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-data-element
