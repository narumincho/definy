...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fecomponenttransfer
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fecomponenttransfer
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeComponentTransferJsProperties {
