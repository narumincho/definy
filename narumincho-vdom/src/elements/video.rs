...
impl Video {
    ...
    pub fn autoplay(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("autoplay".to_string(), String::new());
        } else {
            self.attributes.remove("autoplay");
        }
        self.autoplay = Some(value);
        self
    }

    pub fn controls(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("controls".to_string(), String::new());
        } else {
            self.attributes.remove("controls");
        }
        self.controls = Some(value);
        self
    }

    pub fn cross_origin(mut self, value: VideoCrossOrigin) -> Self {
        self.attributes.insert("crossOrigin".to_string(), value.as_str().to_string());
    ...
    pub fn current_time(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("currentTime".to_string(), value.clone());
        self.current_time = Some(value);
        self
    }

    pub fn default_muted(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("defaultMuted".to_string(), String::new());
        } else {
            self.attributes.remove("defaultMuted");
        }
        self.default_muted = Some(value);
        self
    }

    pub fn default_playback_rate(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("defaultPlaybackRate".to_string(), value.clone());
        self.default_playback_rate = Some(value);
        self
    }

    pub fn disable_picture_in_picture(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("disablePictureInPicture".to_string(), String::new());
        } else {
            self.attributes.remove("disablePictureInPicture");
        }
        self.disable_picture_in_picture = Some(value);
        self
    }

    pub fn disable_remote_playback(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("disableRemotePlayback".to_string(), String::new());
        } else {
            self.attributes.remove("disableRemotePlayback");
        }
        self.disable_remote_playback = Some(value);
        self
    }

    pub fn loading(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("loading".to_string(), value.clone());
    ...
    pub fn loop_(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("loop".to_string(), String::new());
        } else {
            self.attributes.remove("loop");
        }
    ...
    pub fn muted(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("muted".to_string(), String::new());
        } else {
            self.attributes.remove("muted");
        }
    ...
    pub fn playback_rate(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("playbackRate".to_string(), value.clone());
        self.playback_rate = Some(value);
        self
    }

    pub fn plays_inline(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("playsInline".to_string(), String::new());
        } else {
            self.attributes.remove("playsInline");
        }
        self.plays_inline = Some(value);
        self
    }

    pub fn poster(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("poster".to_string(), value.clone());
        self.poster = Some(value);
        self
    }

    pub fn preload(mut self, value: VideoPreload) -> Self {
        self.attributes.insert("preload".to_string(), value.as_str().to_string());
        self.preload = Some(value);
        self
    }

    pub fn preserves_pitch(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("preservesPitch".to_string(), String::new());
        } else {
            self.attributes.remove("preservesPitch");
        }
        self.preserves_pitch = Some(value);
        self
    }
    ...
    pub fn src_object(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("srcObject".to_string(), value.clone());
        self.src_object = Some(value);
        self
    }
    ...
    pub fn volume(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("volume".to_string(), value.clone());
    ...
    pub fn on_encrypted(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("encrypted".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_enterpictureinpicture(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("enterpictureinpicture".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_leavepictureinpicture(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("leavepictureinpicture".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_waitingforkey(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("waitingforkey".to_string(), handler.into()));
        self
    }
