...
impl Video {
    ...
    pub fn autoplay(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("autoplay".to_string(), String::new());
        } else {
    ...
    pub fn controls(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("controls".to_string(), String::new());
        } else {
    ...
    pub fn current_time(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("currentTime".to_string(), value.clone());
    ...
    pub fn default_muted(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("defaultMuted".to_string(), String::new());
        } else {
    ...
    pub fn default_playback_rate(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("defaultPlaybackRate".to_string(), value.clone());
    ...
    pub fn disable_picture_in_picture(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("disablePictureInPicture".to_string(), String::new());
        } else {
    ...
    pub fn disable_remote_playback(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("disableRemotePlayback".to_string(), String::new());
        } else {
    ...
    pub fn playback_rate(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("playbackRate".to_string(), value.clone());
    ...
    pub fn plays_inline(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("playsInline".to_string(), String::new());
        } else {
    ...
    pub fn preload(mut self, value: VideoPreload) -> Self {
        self.attributes
            .insert("preload".to_string(), value.as_str().to_string());
    ...
    pub fn preserves_pitch(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("preservesPitch".to_string(), String::new());
        } else {
    ...
    pub fn src_object(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("srcObject".to_string(), value.clone());
    ...
    pub fn on_enterpictureinpicture(mut self, handler: impl Into<String>) -> Self {
        self.events
            .push(("enterpictureinpicture".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_leavepictureinpicture(mut self, handler: impl Into<String>) -> Self {
        self.events
            .push(("leavepictureinpicture".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_waitingforkey(mut self, handler: impl Into<String>) -> Self {
        self.events
            .push(("waitingforkey".to_string(), handler.into()));
        self
    }
