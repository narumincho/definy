...
impl From<VideoPreload> for String {
    fn from(value: VideoPreload) -> Self {
        value.as_str().to_string()
    }
}
...
impl Video {
    ...
    pub fn disable_picture_in_picture(mut self, value: bool) -> Self {
        ...
        if value {
            self.attributes
                .push(("disablePictureInPicture".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn plays_inline(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "playsInline");
        if value {
            self.attributes
                .push(("playsInline".to_string(), String::new()));
        }
        self
    }

    pub fn poster(self, value: impl Into<String>) -> Self {
    ...
    pub fn on_enterpictureinpicture(mut self, handler: crate::EventHandler) -> Self {
        self.events
            .push(("enterpictureinpicture".to_string(), handler));
        self
    }
    ...
    pub fn on_leavepictureinpicture(mut self, handler: crate::EventHandler) -> Self {
        self.events
            .push(("leavepictureinpicture".to_string(), handler));
        self
    }
...
impl From<Video> for crate::Node {
