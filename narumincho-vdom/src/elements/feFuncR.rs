...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fefuncr
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fefuncr
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeFuncRJsProperties {
