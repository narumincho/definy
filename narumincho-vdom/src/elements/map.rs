...
impl From<MapAutocapitalize> for String {
    fn from(value: MapAutocapitalize) -> Self {
...
impl From<MapPopover> for String {
    fn from(value: MapPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/image-maps.html#the-map-element
