...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/image-maps.html#the-map-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MapJsProperties {
    pub access_key_label: std::option::Option<String>,
    pub active_view_transition: std::option::Option<String>,
    pub areas: std::option::Option<String>,
