...
impl From<LiAutocapitalize> for String {
    fn from(value: LiAutocapitalize) -> Self {
...
impl From<LiDir> for String {
    fn from(value: LiDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<LiPopover> for String {
    fn from(value: LiPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-li-element
