...
pub struct Script {
    ...
    pub cross_origin: std::option::Option<ScriptCrossOrigin>,
    pub defer: std::option::Option<bool>,
    pub event: std::option::Option<String>,
    pub fetch_priority: std::option::Option<String>,
    pub html_for: std::option::Option<String>,
    pub integrity: std::option::Option<String>,
    pub no_module: std::option::Option<bool>,
...
impl Script {
    ...
    pub fn defer(mut self, value: bool) -> Self {
        ...
        self.defer = Some(value);
        self
    }

    pub fn event(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("event".to_string(), value.clone());
    ...
    pub fn html_for(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("htmlFor".to_string(), value.clone());
        self.html_for = Some(value);
        self
    }
