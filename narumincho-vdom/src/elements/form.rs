...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/forms.html#the-form-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FormJsProperties {
    ...
    pub elements: std::option::Option<String>,
...
impl Form {
    ...
    pub fn accept_charset(mut self, value: impl Into<String>) -> Self {
        ...
        self.attributes
            .insert("acceptCharset".to_string(), value.clone());
    ...
    pub fn encoding(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("encoding".to_string(), value.clone());
    ...
    pub fn no_validate(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("noValidate".to_string(), String::new());
        } else {
