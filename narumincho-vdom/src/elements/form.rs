...
impl Form {
    ...
    pub fn action(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("action".to_string(), value.into());
        self
    }
    ...
    pub fn encoding(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("encoding".to_string(), value.into());
        self
    }

    pub fn enctype(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("enctype".to_string(), value.into());
        self
    }

    pub fn method(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("method".to_string(), value.into());
        self
    }
