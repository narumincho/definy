...
pub struct Form {
    ...
    pub target: std::option::Option<FormTarget>,
...
impl Form {
    ...
    pub fn accept_charset(mut self, value: impl Into<String>) -> Self {
        ...
        self.attributes.insert("acceptCharset".to_string(), value.clone());
    ...
    pub fn action(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("action".to_string(), value.clone());
    ...
    pub fn encoding(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("encoding".to_string(), value.clone());
    ...
    pub fn enctype(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("enctype".to_string(), value.clone());
        self.enctype = Some(value);
        self
    }

    pub fn method(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("method".to_string(), value.clone());
    ...
    pub fn no_validate(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("noValidate".to_string(), String::new());
        } else {
            self.attributes.remove("noValidate");
        }
    ...
    pub fn target(mut self, value: FormTarget) -> Self {
