...
impl From<ColAutocapitalize> for String {
    fn from(value: ColAutocapitalize) -> Self {
...
impl From<ColDir> for String {
    fn from(value: ColDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<ColPopover> for String {
    fn from(value: ColPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/tables.html#the-col-element
