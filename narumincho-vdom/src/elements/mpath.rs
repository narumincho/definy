...
/// HTML Content Attributes for https://svgwg.org/specs/animations/#elementdef-mpath
...
/// JavaScript / DOM Properties for https://svgwg.org/specs/animations/#elementdef-mpath
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MpathJsProperties {
