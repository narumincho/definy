...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/form-elements.html#the-textarea-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct TextareaJsProperties {
...
impl Textarea {
    ...
    pub fn wrap(mut self, value: TextareaWrap) -> Self {
        self.attributes
            .insert("wrap".to_string(), value.as_str().to_string());
