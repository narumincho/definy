...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/form-elements.html#the-textarea-element
...
pub struct Textarea {
    ...
    pub wrap: std::option::Option<TextareaWrap>,
...
impl Textarea {
    ...
    pub fn wrap(mut self, value: TextareaWrap) -> Self {
        self.attributes.insert("wrap".to_string(), value.as_str().to_string());
