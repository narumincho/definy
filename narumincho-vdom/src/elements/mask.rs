...
/// HTML Content Attributes for https://drafts.csswg.org/css-masking-1/#elementdef-mask
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/css-masking-1/#elementdef-mask
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MaskJsProperties {
    ...
    pub mask_content_units: std::option::Option<String>,
    pub mask_units: std::option::Option<String>,
