...
impl Mask {
    ...
    pub fn mask_content_units(mut self, value: impl Into<String>) -> Self {
        self.mask_content_units = Some(value.into());
        self
    }

    pub fn mask_units(mut self, value: impl Into<String>) -> Self {
        self.mask_units = Some(value.into());
        self
    }
