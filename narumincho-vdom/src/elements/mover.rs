...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mover
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-mover
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MoverJsProperties {
...
impl Mover {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Mover(self),
            children: Vec::new(),
        })
    }
