...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-maction
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-maction
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MactionJsProperties {
...
impl Maction {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Maction(self),
            children: Vec::new(),
        })
    }
