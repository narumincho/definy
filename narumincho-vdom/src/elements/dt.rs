...
impl From<DtAutocapitalize> for String {
    fn from(value: DtAutocapitalize) -> Self {
...
impl From<DtDir> for String {
    fn from(value: DtDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<DtPopover> for String {
    fn from(value: DtPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-dt-element
