...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-annotation-xml
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-annotation-xml
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct AnnotationXmlJsProperties {
...
pub fn annotation_xml() -> AnnotationXml {
    AnnotationXml::default()
}
...
impl AnnotationXml {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::AnnotationXml(self),
            children: Vec::new(),
        })
    }
