...
pub struct FeTurbulence {
    ...
    pub base_frequency_x: std::option::Option<String>,
    pub base_frequency_y: std::option::Option<String>,
    ...
    pub num_octaves: std::option::Option<String>,
    ...
    pub seed: std::option::Option<String>,
    pub shadow_root: std::option::Option<String>,
    pub short: std::option::Option<String>,
    pub stitch_tiles: std::option::Option<String>,
...
impl FeTurbulence {
    ...
    pub fn base_frequency_x(mut self, value: impl Into<String>) -> Self {
        self.base_frequency_x = Some(value.into());
        self
    }

    pub fn base_frequency_y(mut self, value: impl Into<String>) -> Self {
        self.base_frequency_y = Some(value.into());
        self
    }
    ...
    pub fn num_octaves(mut self, value: impl Into<String>) -> Self {
        self.num_octaves = Some(value.into());
        self
    }
    ...
    pub fn stitch_tiles(mut self, value: impl Into<String>) -> Self {
        self.stitch_tiles = Some(value.into());
        self
    }
