...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-feturbulence
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-feturbulence
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeTurbulenceJsProperties {
