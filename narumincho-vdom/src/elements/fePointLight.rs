...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fepointlight
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fepointlight
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FePointLightJsProperties {
