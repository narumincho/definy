...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-msubsup
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-msubsup
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MsubsupJsProperties {
...
impl Msubsup {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Msubsup(self),
            children: Vec::new(),
        })
    }
