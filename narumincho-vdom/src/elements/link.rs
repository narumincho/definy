...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/semantics.html#the-link-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct LinkJsProperties {
    ...
    pub sheet: std::option::Option<String>,
...
impl Link {
    ...
    pub fn fetch_priority(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("fetchPriority".to_string(), value.clone());
    ...
    pub fn hreflang(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("hreflang".to_string(), value.clone());
    ...
    pub fn image_sizes(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("imageSizes".to_string(), value.clone());
    ...
    pub fn image_srcset(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("imageSrcset".to_string(), value.clone());
    ...
    pub fn integrity(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("integrity".to_string(), value.clone());
    ...
    pub fn referrer_policy(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("referrerPolicy".to_string(), value.clone());
