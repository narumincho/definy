...
impl From<LinkAutocapitalize> for String {
    fn from(value: LinkAutocapitalize) -> Self {
...
impl From<LinkCrossOrigin> for String {
    fn from(value: LinkCrossOrigin) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<LinkDir> for String {
    fn from(value: LinkDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum LinkPopover {
    Auto,
    Manual,
}
...
impl From<LinkPopover> for String {
    fn from(value: LinkPopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl Link {
    ...
    pub fn as_(self, value: impl Into<String>) -> Self {
    ...
    pub fn image_sizes(self, value: impl Into<String>) -> Self {
        self.attribute("imageSizes", value)
    }

    pub fn image_srcset(self, value: impl Into<String>) -> Self {
        self.attribute("imageSrcset", value)
    }
