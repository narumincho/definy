...
impl Link {
    ...
    pub fn as_(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("as".to_string(), value.into());
        self
    }
    ...
    pub fn image_sizes(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("imageSizes".to_string(), value.into());
        self
    }

    pub fn image_srcset(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("imageSrcset".to_string(), value.into());
        self
    }
    ...
    pub fn media(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("media".to_string(), value.into());
        self
    }
