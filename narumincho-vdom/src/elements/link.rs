...
pub enum LinkCrossOrigin {
    Anonymous,
    UseCredentials,
}

impl LinkCrossOrigin {
...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/semantics.html#the-link-element
...
pub struct Link {
    ...
    pub image_sizes: std::option::Option<String>,
    pub image_srcset: std::option::Option<String>,
    ...
    pub target: std::option::Option<LinkTarget>,
...
impl Link {
    ...
    pub fn as_(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("as".to_string(), value.clone());
        self.r#as = Some(value);
        self
    }
    ...
    pub fn charset(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("charset".to_string(), value.clone());
    ...
    pub fn disabled(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("disabled".to_string(), String::new());
        } else {
    ...
    pub fn fetch_priority(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("fetchPriority".to_string(), value.clone());
        self.fetch_priority = Some(value);
        self
    }

    pub fn href(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("href".to_string(), value.clone());
    ...
    pub fn hreflang(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("hreflang".to_string(), value.clone());
        self.hreflang = Some(value);
        self
    }

    pub fn image_sizes(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("imageSizes".to_string(), value.clone());
        self.image_sizes = Some(value);
        self
    }

    pub fn image_srcset(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("imageSrcset".to_string(), value.clone());
        self.image_srcset = Some(value);
        self
    }

    pub fn integrity(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("integrity".to_string(), value.clone());
        self.integrity = Some(value);
        self
    }

    pub fn media(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("media".to_string(), value.clone());
    ...
    pub fn referrer_policy(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("referrerPolicy".to_string(), value.clone());
    ...
    pub fn rel(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("rel".to_string(), value.clone());
        self.rel = Some(value);
        self
    }
    ...
    pub fn rev(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("rev".to_string(), value.clone());
        self.rev = Some(value);
        self
    }
    ...
    pub fn target(mut self, value: LinkTarget) -> Self {
        self.attributes.insert("target".to_string(), value.as_str().to_string());
    ...
    pub fn type_(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("type".to_string(), value.clone());
