...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mrow
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-mrow
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MrowJsProperties {
...
impl Mrow {
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::Mrow(self),
            children,
        }
    }
}
