...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-feblend
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-feblend
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeBlendJsProperties {
