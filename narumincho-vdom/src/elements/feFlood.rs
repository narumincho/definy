...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-feflood
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-feflood
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeFloodJsProperties {
