...
pub enum BlockquoteAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<BlockquoteAutocapitalize> for String {
    fn from(value: BlockquoteAutocapitalize) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum BlockquoteDir {
    Ltr,
    Rtl,
    Auto,
}
...
impl From<BlockquoteDir> for String {
    fn from(value: BlockquoteDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum BlockquotePopover {
    Auto,
    Manual,
}

impl BlockquotePopover {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Auto => "auto",
            Self::Manual => "manual",
...
impl From<BlockquotePopover> for String {
    fn from(value: BlockquotePopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-blockquote-element
...
impl Blockquote {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "blockquote".to_string(),
    ...
    pub fn cite(self, value: impl Into<String>) -> Self {
...
impl From<Blockquote> for crate::Node {
