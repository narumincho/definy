...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/scripting.html#the-template-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct TemplateJsProperties {
...
impl Template {
    ...
    pub fn shadow_root_clonable(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("shadowRootClonable".to_string(), String::new());
        } else {
    ...
    pub fn shadow_root_custom_element_registry(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("shadowRootCustomElementRegistry".to_string(), value.clone());
    ...
    pub fn shadow_root_delegates_focus(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("shadowRootDelegatesFocus".to_string(), String::new());
        } else {
    ...
    pub fn shadow_root_mode(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("shadowRootMode".to_string(), value.clone());
    ...
    pub fn shadow_root_serializable(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("shadowRootSerializable".to_string(), String::new());
        } else {
    ...
    pub fn shadow_root_slot_assignment(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("shadowRootSlotAssignment".to_string(), value.clone());
