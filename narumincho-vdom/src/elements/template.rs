...
impl Template {
    ...
    pub fn shadow_root_custom_element_registry(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("shadowRootCustomElementRegistry".to_string(), value.into());
        self
    }
    ...
    pub fn shadow_root_mode(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("shadowRootMode".to_string(), value.into());
        self
    }
    ...
    pub fn shadow_root_slot_assignment(mut self, value: impl Into<String>) -> Self {
        self.attributes
            .insert("shadowRootSlotAssignment".to_string(), value.into());
        self
    }
