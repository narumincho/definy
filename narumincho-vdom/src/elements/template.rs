...
pub enum TemplateAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<TemplateAutocapitalize> for String {
    fn from(value: TemplateAutocapitalize) -> Self {
...
impl From<TemplateDir> for String {
    fn from(value: TemplateDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TemplatePopover {
    Auto,
    Manual,
}

impl TemplatePopover {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Auto => "auto",
            Self::Manual => "manual",
...
impl From<TemplatePopover> for String {
    fn from(value: TemplatePopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl Template {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "template".to_string(),
    ...
    pub fn shadow_root_clonable(mut self, value: bool) -> Self {
        self.attributes
            .retain(|(key, _)| key != "shadowRootClonable");
        if value {
            self.attributes
                .push(("shadowRootClonable".to_string(), String::new()));
        }
        self
    }

    pub fn shadow_root_custom_element_registry(self, value: impl Into<String>) -> Self {
        self.attribute("shadowRootCustomElementRegistry", value)
    }

    pub fn shadow_root_delegates_focus(mut self, value: bool) -> Self {
        self.attributes
            .retain(|(key, _)| key != "shadowRootDelegatesFocus");
        if value {
            self.attributes
                .push(("shadowRootDelegatesFocus".to_string(), String::new()));
        }
        self
    }

    pub fn shadow_root_mode(self, value: impl Into<String>) -> Self {
        self.attribute("shadowRootMode", value)
    }

    pub fn shadow_root_serializable(mut self, value: bool) -> Self {
        self.attributes
            .retain(|(key, _)| key != "shadowRootSerializable");
        if value {
            self.attributes
                .push(("shadowRootSerializable".to_string(), String::new()));
        }
        self
    }

    pub fn shadow_root_slot_assignment(self, value: impl Into<String>) -> Self {
        self.attribute("shadowRootSlotAssignment", value)
    }
...
impl From<Template> for crate::Node {
