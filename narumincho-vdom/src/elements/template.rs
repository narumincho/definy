...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/scripting.html#the-template-element
...
pub struct Template {
    ...
    pub shadow_root_clonable: std::option::Option<bool>,
    pub shadow_root_custom_element_registry: std::option::Option<String>,
    pub shadow_root_delegates_focus: std::option::Option<bool>,
    pub shadow_root_mode: std::option::Option<String>,
    pub shadow_root_serializable: std::option::Option<bool>,
    pub shadow_root_slot_assignment: std::option::Option<String>,
...
impl Template {
    ...
    pub fn shadow_root_clonable(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("shadowRootClonable".to_string(), String::new());
        } else {
            self.attributes.remove("shadowRootClonable");
        }
        self.shadow_root_clonable = Some(value);
        self
    }

    pub fn shadow_root_custom_element_registry(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("shadowRootCustomElementRegistry".to_string(), value.clone());
        self.shadow_root_custom_element_registry = Some(value);
        self
    }

    pub fn shadow_root_delegates_focus(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("shadowRootDelegatesFocus".to_string(), String::new());
        } else {
            self.attributes.remove("shadowRootDelegatesFocus");
        }
        self.shadow_root_delegates_focus = Some(value);
        self
    }

    pub fn shadow_root_mode(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("shadowRootMode".to_string(), value.clone());
        self.shadow_root_mode = Some(value);
        self
    }

    pub fn shadow_root_serializable(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("shadowRootSerializable".to_string(), String::new());
        } else {
            self.attributes.remove("shadowRootSerializable");
        }
        self.shadow_root_serializable = Some(value);
        self
    }

    pub fn shadow_root_slot_assignment(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("shadowRootSlotAssignment".to_string(), value.clone());
        self.shadow_root_slot_assignment = Some(value);
        self
    }
