...
pub struct template {
    ...
    pub shadowrootserializable: Option<String>,
    pub shadowrootcustomelementregistry: Option<String>,
    pub shadowrootslotassignment: Option<String>,
    pub shadowrootdelegatesfocus: Option<String>,
    pub shadowrootclonable: Option<String>,
    pub shadowrootreferencetarget: Option<String>,
}
