...
impl From<BrAutocapitalize> for String {
    fn from(value: BrAutocapitalize) -> Self {
...
impl From<BrDir> for String {
    fn from(value: BrDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<BrPopover> for String {
    fn from(value: BrPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-br-element
...
impl Br {
    ...
    pub fn clear(self, value: impl Into<String>) -> Self {
        self.attribute("clear", value)
    }
...
impl From<Br> for crate::Node {
    fn from(value: Br) -> Self {
        value.into_node()
    }
}
