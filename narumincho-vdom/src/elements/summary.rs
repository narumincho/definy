...
pub enum SummaryAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<SummaryAutocapitalize> for String {
    fn from(value: SummaryAutocapitalize) -> Self {
...
impl From<SummaryDir> for String {
    fn from(value: SummaryDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum SummaryPopover {
    Auto,
    Manual,
}
...
impl From<SummaryPopover> for String {
    fn from(value: SummaryPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/interactive-elements.html#the-summary-element
...
impl Summary {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "summary".to_string(),
...
impl From<Summary> for crate::Node {
