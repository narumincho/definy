...
/// HTML Content Attributes for https://drafts.csswg.org/css-masking-1/#elementdef-clippath
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/css-masking-1/#elementdef-clippath
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct ClipPathJsProperties {
    ...
    pub clip_path_units: std::option::Option<String>,
