...
/// HTML Content Attributes for https://svgwg.org/specs/animations/#elementdef-set
...
impl Set {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Set(self),
            children: Vec::new(),
        })
    }
    ...
    pub fn on_begin(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("begin".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_end(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("end".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_repeat(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("repeat".to_string(), handler.into()));
        self
    }
