...
impl From<SubAutocapitalize> for String {
    fn from(value: SubAutocapitalize) -> Self {
...
impl From<SubPopover> for String {
    fn from(value: SubPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-sub-element
