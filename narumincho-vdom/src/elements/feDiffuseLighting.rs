...
pub struct FeDiffuseLighting {
    ...
    pub diffuse_constant: std::option::Option<String>,
...
impl FeDiffuseLighting {
    ...
    pub fn diffuse_constant(mut self, value: impl Into<String>) -> Self {
        self.diffuse_constant = Some(value.into());
        self
    }
