...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fediffuselighting
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fediffuselighting
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeDiffuseLightingJsProperties {
