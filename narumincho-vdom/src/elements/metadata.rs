...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/struct.html#elementdef-metadata
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/struct.html#elementdef-metadata
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MetadataJsProperties {
...
impl Metadata {
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::Metadata(self),
            children,
        }
    }
}
