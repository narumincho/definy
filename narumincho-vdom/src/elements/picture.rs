...
pub enum PictureAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<PictureAutocapitalize> for String {
    fn from(value: PictureAutocapitalize) -> Self {
...
impl From<PictureDir> for String {
    fn from(value: PictureDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PicturePopover {
    Auto,
    Manual,
}
...
impl From<PicturePopover> for String {
    fn from(value: PicturePopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/embedded-content.html#the-picture-element
...
impl Picture {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "picture".to_string(),
...
impl From<Picture> for crate::Node {
