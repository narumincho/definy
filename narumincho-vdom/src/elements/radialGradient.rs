...
/// HTML Content Attributes for https://www.w3.org/TR/SVG11/pservers.html#RadialGradients
...
impl RadialGradient {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "radialGradient".to_string(),
...
impl From<RadialGradient> for crate::Node {
