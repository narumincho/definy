...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/semantics.html#meta
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MetaJsProperties {
...
impl Meta {
    ...
    pub fn http_equiv(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("httpEquiv".to_string(), value.clone());
