...
impl Meta {
    ...
    pub fn content(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("content".to_string(), value.clone());
    ...
    pub fn http_equiv(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("httpEquiv".to_string(), value.clone());
        self.http_equiv = Some(value);
        self
    }
    ...
    pub fn scheme(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("scheme".to_string(), value.clone());
