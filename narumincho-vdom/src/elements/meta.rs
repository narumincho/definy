...
impl From<MetaAutocapitalize> for String {
    fn from(value: MetaAutocapitalize) -> Self {
...
impl From<MetaDir> for String {
    fn from(value: MetaDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum MetaPopover {
    Auto,
    Manual,
}
...
impl From<MetaPopover> for String {
    fn from(value: MetaPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/semantics.html#meta
...
impl Meta {
    ...
    pub fn http_equiv(self, value: impl Into<String>) -> Self {
        self.attribute("httpEquiv", value)
    }
    ...
    pub fn scheme(self, value: impl Into<String>) -> Self {
        self.attribute("scheme", value)
    }
