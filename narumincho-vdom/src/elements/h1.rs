...
impl From<H1Autocapitalize> for String {
    fn from(value: H1Autocapitalize) -> Self {
...
impl From<H1Dir> for String {
    fn from(value: H1Dir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<H1Popover> for String {
    fn from(value: H1Popover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/sections.html#the-h1-element
