...
impl From<ImgAutocapitalize> for String {
    fn from(value: ImgAutocapitalize) -> Self {
...
impl From<ImgCrossOrigin> for String {
    fn from(value: ImgCrossOrigin) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<ImgDir> for String {
    fn from(value: ImgDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<ImgPopover> for String {
    fn from(value: ImgPopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl Img {
    ...
    pub fn decoding(self, value: impl Into<String>) -> Self {
    ...
    pub fn is_map(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "isMap");
        if value {
            self.attributes.push(("isMap".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn lowsrc(self, value: impl Into<String>) -> Self {
        self.attribute("lowsrc", value)
    }
    ...
    pub fn sizes(self, value: impl Into<String>) -> Self {
    ...
    pub fn srcset(self, value: impl Into<String>) -> Self {
