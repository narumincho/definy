...
impl Img {
    ...
    pub fn decoding(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("decoding".to_string(), value.into());
        self
    }
    ...
    pub fn lowsrc(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("lowsrc".to_string(), value.into());
        self
    }
    ...
    pub fn sizes(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("sizes".to_string(), value.into());
        self
    }
    ...
    pub fn srcset(mut self, value: impl Into<String>) -> Self {
        self.attributes.insert("srcset".to_string(), value.into());
        self
    }
