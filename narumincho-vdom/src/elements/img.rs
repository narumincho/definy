...
impl Img {
    ...
    pub fn cross_origin(mut self, value: ImgCrossOrigin) -> Self {
    ...
    pub fn decoding(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("decoding".to_string(), value.clone());
        self.decoding = Some(value);
        self
    }
    ...
    pub fn is_map(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("isMap".to_string(), String::new());
        } else {
            self.attributes.remove("isMap");
        }
    ...
    pub fn lowsrc(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("lowsrc".to_string(), value.clone());
        self.lowsrc = Some(value);
        self
    }
    ...
    pub fn sizes(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("sizes".to_string(), value.clone());
    ...
    pub fn srcset(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("srcset".to_string(), value.clone());
        self.srcset = Some(value);
        self
    }
