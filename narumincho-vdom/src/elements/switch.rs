...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/struct.html#elementdef-switch
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/struct.html#elementdef-switch
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct SwitchJsProperties {
