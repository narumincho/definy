...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fefuncb
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fefuncb
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeFuncBJsProperties {
