...
pub struct Image {
    ...
    pub cross_origin: std::option::Option<ImageCrossOrigin>,
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/embedded.html#elementdef-image
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct ImageJsProperties {
