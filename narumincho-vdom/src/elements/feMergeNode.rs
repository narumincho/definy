...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-femergenode
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-femergenode
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeMergeNodeJsProperties {
