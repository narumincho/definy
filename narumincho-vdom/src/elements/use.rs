...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/struct.html#elementdef-use
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/struct.html#elementdef-use
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct UseJsProperties {
...
impl Use {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Use(self),
            children: Vec::new(),
        })
    }
