...
impl From<PAutocapitalize> for String {
    fn from(value: PAutocapitalize) -> Self {
...
impl From<PDir> for String {
    fn from(value: PDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<PPopover> for String {
    fn from(value: PPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-p-element
