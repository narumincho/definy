...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-msqrt
...
impl From<Msqrt> for crate::Node {
    fn from(value: Msqrt) -> Self {
        value.into_node()
    }
}
