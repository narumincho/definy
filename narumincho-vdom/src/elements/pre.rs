...
impl From<PreAutocapitalize> for String {
    fn from(value: PreAutocapitalize) -> Self {
...
impl From<PreDir> for String {
    fn from(value: PreDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<PrePopover> for String {
    fn from(value: PrePopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-pre-element
