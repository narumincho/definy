...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/form-elements.html#the-option-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct OptionJsProperties {
...
impl Option {
    ...
    pub fn default_selected(mut self, value: bool) -> Self {
        if value {
            self.attributes
                .insert("defaultSelected".to_string(), String::new());
        } else {
