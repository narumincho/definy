...
impl Option {
    ...
    pub fn default_selected(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("defaultSelected".to_string(), String::new());
        } else {
            self.attributes.remove("defaultSelected");
        }
    ...
    pub fn label(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("label".to_string(), value.clone());
    ...
    pub fn selected(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("selected".to_string(), String::new());
        } else {
            self.attributes.remove("selected");
        }
