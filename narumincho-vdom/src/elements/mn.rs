...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mn
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-mn
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MnJsProperties {
...
impl Mn {
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::Mn(self),
            children,
        }
    }
}
