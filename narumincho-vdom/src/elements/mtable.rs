...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mtable
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-mtable
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MtableJsProperties {
...
impl Mtable {
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::Mtable(self),
            children,
        }
    }
}
