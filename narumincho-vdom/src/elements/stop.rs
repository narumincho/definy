...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/pservers.html#elementdef-stop
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/pservers.html#elementdef-stop
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct StopJsProperties {
