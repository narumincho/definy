...
impl From<BaseAutocapitalize> for String {
    fn from(value: BaseAutocapitalize) -> Self {
...
impl From<BasePopover> for String {
    fn from(value: BasePopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<BaseTarget> for String {
    fn from(value: BaseTarget) -> Self {
        value.as_str().to_string()
    }
}
