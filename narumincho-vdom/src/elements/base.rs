...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/semantics.html#the-base-element
...
pub struct Base {
    ...
    pub target: std::option::Option<BaseTarget>,
...
impl Base {
    ...
    pub fn target(mut self, value: BaseTarget) -> Self {
