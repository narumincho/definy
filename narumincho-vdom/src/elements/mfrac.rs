...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mfrac
...
impl From<Mfrac> for crate::Node {
    fn from(value: Mfrac) -> Self {
        value.into_node()
    }
}
