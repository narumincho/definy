...
pub struct Text {
    ...
    pub length_adjust: std::option::Option<String>,
    ...
    pub rotate: std::option::Option<String>,
    ...
    pub text_length: std::option::Option<String>,
...
impl Text {
    ...
    pub fn dx(mut self, value: impl Into<String>) -> Self {
        self.dx = Some(value.into());
        self
    }

    pub fn dy(mut self, value: impl Into<String>) -> Self {
        self.dy = Some(value.into());
        self
    }
    ...
    pub fn length_adjust(mut self, value: impl Into<String>) -> Self {
        self.length_adjust = Some(value.into());
        self
    }
    ...
    pub fn rotate(mut self, value: impl Into<String>) -> Self {
    ...
    pub fn text_length(mut self, value: impl Into<String>) -> Self {
