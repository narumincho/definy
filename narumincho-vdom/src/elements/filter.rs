...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-filter
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-filter
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FilterJsProperties {
    ...
    pub filter_units: std::option::Option<String>,
    ...
    pub primitive_units: std::option::Option<String>,
...
impl Filter {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Filter(self),
            children: Vec::new(),
        })
    }
