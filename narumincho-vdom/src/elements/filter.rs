...
impl Filter {
    ...
    pub fn filter_units(mut self, value: impl Into<String>) -> Self {
        self.filter_units = Some(value.into());
        self
    }
    ...
    pub fn primitive_units(mut self, value: impl Into<String>) -> Self {
        self.primitive_units = Some(value.into());
        self
    }
