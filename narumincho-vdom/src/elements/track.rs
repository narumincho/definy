...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/media.html#the-track-element
...
pub struct Track {
    ...
    pub r#default: std::option::Option<bool>,
...
impl Track {
    ...
    pub fn default_(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("default".to_string(), String::new());
        } else {
            self.attributes.remove("default");
        }
    ...
    pub fn kind(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("kind".to_string(), value.clone());
    ...
    pub fn srclang(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("srclang".to_string(), value.clone());
        self.srclang = Some(value);
        self
    }
