...
impl From<TrackAutocapitalize> for String {
    fn from(value: TrackAutocapitalize) -> Self {
...
impl From<TrackDir> for String {
    fn from(value: TrackDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TrackPopover {
    Auto,
    Manual,
}
...
impl From<TrackPopover> for String {
    fn from(value: TrackPopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl Track {
    ...
    pub fn default_(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "default");
        if value {
            self.attributes.push(("default".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn srclang(self, value: impl Into<String>) -> Self {
...
impl From<Track> for crate::Node {
