...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/shapes.html#elementdef-polyline
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/shapes.html#elementdef-polyline
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct PolylineJsProperties {
