...
pub struct Polyline {
    ...
    pub animated_points: std::option::Option<String>,
    ...
    pub points: std::option::Option<String>,
...
impl Polyline {
    ...
    pub fn animated_points(mut self, value: impl Into<String>) -> Self {
        self.animated_points = Some(value.into());
        self
    }
    ...
    pub fn points(mut self, value: impl Into<String>) -> Self {
        self.points = Some(value.into());
        self
    }
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::Polyline(self),
            children,
        }
    }
}
