...
pub struct Marker {
    ...
    pub marker_height: std::option::Option<String>,
    pub marker_units: std::option::Option<String>,
    pub marker_width: std::option::Option<String>,
    ...
    pub orient: std::option::Option<String>,
    pub orient_angle: std::option::Option<String>,
    pub orient_type: std::option::Option<String>,
    ...
    pub preserve_aspect_ratio: std::option::Option<String>,
    pub previous_element_sibling: std::option::Option<String>,
    pub previous_sibling: std::option::Option<String>,
    pub ref_x: std::option::Option<String>,
    pub ref_y: std::option::Option<String>,
    ...
    pub view_box: std::option::Option<String>,
...
impl Marker {
    ...
    pub fn marker_height(mut self, value: impl Into<String>) -> Self {
        self.marker_height = Some(value.into());
        self
    }

    pub fn marker_units(mut self, value: impl Into<String>) -> Self {
        self.marker_units = Some(value.into());
        self
    }

    pub fn marker_width(mut self, value: impl Into<String>) -> Self {
        self.marker_width = Some(value.into());
        self
    }
    ...
    pub fn orient(mut self, value: impl Into<String>) -> Self {
        self.orient = Some(value.into());
        self
    }

    pub fn orient_angle(mut self, value: impl Into<String>) -> Self {
        self.orient_angle = Some(value.into());
        self
    }

    pub fn orient_type(mut self, value: impl Into<String>) -> Self {
        self.orient_type = Some(value.into());
        self
    }
    ...
    pub fn preserve_aspect_ratio(mut self, value: impl Into<String>) -> Self {
        self.preserve_aspect_ratio = Some(value.into());
        self
    }
    ...
    pub fn ref_x(mut self, value: impl Into<String>) -> Self {
        self.ref_x = Some(value.into());
        self
    }

    pub fn ref_y(mut self, value: impl Into<String>) -> Self {
        self.ref_y = Some(value.into());
        self
    }
