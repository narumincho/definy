...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/painting.html#elementdef-marker
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/painting.html#elementdef-marker
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MarkerJsProperties {
...
impl Marker {
    ...
    pub fn orient(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("orient".to_string(), value.clone());
        self.orient = Some(value);
        self
    }
