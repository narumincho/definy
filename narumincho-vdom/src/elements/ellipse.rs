...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/shapes.html#elementdef-ellipse
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/shapes.html#elementdef-ellipse
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct EllipseJsProperties {
    ...
    pub cy: std::option::Option<String>,
    ...
    pub rx: std::option::Option<String>,
    pub ry: std::option::Option<String>,
