...
impl From<ButtonAutocapitalize> for String {
    fn from(value: ButtonAutocapitalize) -> Self {
...
impl From<ButtonCommand> for String {
    fn from(value: ButtonCommand) -> Self {
        value.as_str()
    }
}
...
impl From<ButtonDir> for String {
    fn from(value: ButtonDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ButtonPopover {
    Auto,
    Manual,
}
...
impl From<ButtonPopover> for String {
    fn from(value: ButtonPopover) -> Self {
        value.as_str().to_string()
    }
}
...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/form-elements.html#the-button-element
...
impl From<Button> for crate::Node {
