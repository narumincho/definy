...
pub struct Button {
    ...
    pub command_for_element: std::option::Option<String>,
...
impl Button {
    ...
    pub fn command_for_element(mut self, value: impl Into<String>) -> Self {
        self.command_for_element = Some(value.into());
        self
    }
