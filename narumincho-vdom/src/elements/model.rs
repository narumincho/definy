...
impl Model {
    ...
    pub fn bounding_box_center(mut self, value: impl Into<String>) -> Self {
        self.bounding_box_center = Some(value.into());
        self
    }

    pub fn bounding_box_extents(mut self, value: impl Into<String>) -> Self {
        self.bounding_box_extents = Some(value.into());
        self
    }
    ...
    pub fn environment_map(mut self, value: impl Into<String>) -> Self {
        self.environment_map = Some(value.into());
        self
    }
    ...
    pub fn stage_mode(mut self, value: impl Into<String>) -> Self {
        self.stage_mode = Some(value.into());
        self
    }
