...
/// HTML Content Attributes for https://immersive-web.github.io/model-element/#dfn-model
...
pub struct Model {
    ...
    pub entity_transform: std::option::Option<String>,
    pub environment_map: std::option::Option<String>,
    pub role: std::option::Option<String>,
    pub stage_mode: std::option::Option<String>,
...
impl Model {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Model(self),
            children: Vec::new(),
        })
    }
    ...
    pub fn entity_transform(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("entityTransform".to_string(), value.clone());
        self.entity_transform = Some(value);
        self
    }

    pub fn environment_map(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("environmentMap".to_string(), value.clone());
        self.environment_map = Some(value);
        self
    }
    ...
    pub fn stage_mode(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("stageMode".to_string(), value.clone());
        self.stage_mode = Some(value);
        self
    }
