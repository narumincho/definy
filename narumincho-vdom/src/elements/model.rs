...
/// JavaScript / DOM Properties for https://immersive-web.github.io/model-element/#dfn-model
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct ModelJsProperties {
    ...
    pub bounding_box_center: std::option::Option<String>,
    pub bounding_box_extents: std::option::Option<String>,
...
impl Model {
    ...
    pub fn entity_transform(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("entityTransform".to_string(), value.clone());
    ...
    pub fn environment_map(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("environmentMap".to_string(), value.clone());
    ...
    pub fn stage_mode(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("stageMode".to_string(), value.clone());
