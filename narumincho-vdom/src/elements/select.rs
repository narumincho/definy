...
pub struct Select {
    ...
    pub selected_index: std::option::Option<String>,
...
impl Select {
    ...
    pub fn selected_index(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("selectedIndex".to_string(), value.clone());
