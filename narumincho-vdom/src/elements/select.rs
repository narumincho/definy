...
pub struct Select {
    ...
    pub options: std::option::Option<String>,
    ...
    pub selected_options: std::option::Option<String>,
...
impl Select {
    ...
    pub fn selected_index(mut self, value: impl Into<String>) -> Self {
        self.selected_index = Some(value.into());
        self
    }

    pub fn selected_options(mut self, value: impl Into<String>) -> Self {
        self.selected_options = Some(value.into());
        self
    }
