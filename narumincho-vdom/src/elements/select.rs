...
impl From<SelectAutocapitalize> for String {
    fn from(value: SelectAutocapitalize) -> Self {
...
impl From<SelectDir> for String {
    fn from(value: SelectDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum SelectPopover {
    Auto,
    Manual,
}
...
impl From<SelectPopover> for String {
    fn from(value: SelectPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/form-elements.html#the-select-element
...
impl Select {
    ...
    pub fn selected_index(self, value: impl Into<String>) -> Self {
        self.attribute("selectedIndex", value)
    }
...
impl From<Select> for crate::Node {
