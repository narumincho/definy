...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/form-elements.html#the-select-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct SelectJsProperties {
...
impl Select {
    ...
    pub fn selected_index(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("selectedIndex".to_string(), value.clone());
