...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-msup
...
impl From<Msup> for crate::Node {
    fn from(value: Msup) -> Self {
        value.into_node()
    }
}
