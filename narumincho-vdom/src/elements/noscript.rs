...
pub enum NoscriptAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<NoscriptAutocapitalize> for String {
    fn from(value: NoscriptAutocapitalize) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum NoscriptDir {
    Ltr,
    Rtl,
    Auto,
}
...
impl From<NoscriptDir> for String {
    fn from(value: NoscriptDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum NoscriptPopover {
    Auto,
    Manual,
}

impl NoscriptPopover {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Auto => "auto",
            Self::Manual => "manual",
...
impl From<NoscriptPopover> for String {
    fn from(value: NoscriptPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/scripting.html#the-noscript-element
...
impl Noscript {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "noscript".to_string(),
...
impl From<Noscript> for crate::Node {
