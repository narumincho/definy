...
pub enum GeolocationAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl GeolocationAutocapitalize {
...
impl From<GeolocationAutocapitalize> for String {
    fn from(value: GeolocationAutocapitalize) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum GeolocationDir {
    Ltr,
    Rtl,
    Auto,
}
...
impl From<GeolocationDir> for String {
    fn from(value: GeolocationDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum GeolocationInitialPermissionStatus {
    Granted,
    Denied,
    Prompt,
}

impl GeolocationInitialPermissionStatus {
    pub fn as_str(&self) -> &'static str {
        match self {
...
impl From<GeolocationInitialPermissionStatus> for String {
    fn from(value: GeolocationInitialPermissionStatus) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum GeolocationInvalidReason {
    IllegalSubframe,
...
impl GeolocationInvalidReason {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::IllegalSubframe => "illegal_subframe",
            Self::UnsuccessfulRegistration => "unsuccessful_registration",
            Self::RecentlyAttached => "recently_attached",
            Self::IntersectionChanged => "intersection_changed",
            Self::IntersectionOutOfViewportOrClipped => "intersection_out_of_viewport_or_clipped",
            Self::IntersectionOccludedOrDistorted => "intersection_occluded_or_distorted",
            Self::StyleInvalid => "style_invalid",
            Self::TypeInvalid => "type_invalid",
        }
    }
}

impl From<GeolocationInvalidReason> for String {
    fn from(value: GeolocationInvalidReason) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum GeolocationPermissionStatus {
    Granted,
    Denied,
    Prompt,
}

impl GeolocationPermissionStatus {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Granted => "granted",
            Self::Denied => "denied",
...
impl From<GeolocationPermissionStatus> for String {
    fn from(value: GeolocationPermissionStatus) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum GeolocationPopover {
    Auto,
    Manual,
}

impl GeolocationPopover {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Auto => "auto",
            Self::Manual => "manual",
...
impl From<GeolocationPopover> for String {
    fn from(value: GeolocationPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://wicg.github.io/PEPC/geolocation-element.html#elementdef-geolocation
...
impl Geolocation {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "geolocation".to_string(),
    ...
    pub fn autolocate(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "autolocate");
        if value {
            self.attributes
                .push(("autolocate".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn initial_permission_status(self, value: impl Into<String>) -> Self {
        self.attribute("initialPermissionStatus", value)
    }
    ...
    pub fn invalid_reason(self, value: impl Into<String>) -> Self {
        self.attribute("invalidReason", value)
    }
    ...
    pub fn permission_status(self, value: impl Into<String>) -> Self {
        self.attribute("permissionStatus", value)
    }
    ...
    pub fn watch(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "watch");
        if value {
            self.attributes.push(("watch".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn on_location(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("location".to_string(), handler));
        self
    }
    ...
    pub fn on_promptaction(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("promptaction".to_string(), handler));
        self
    }

    pub fn on_promptdismiss(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("promptdismiss".to_string(), handler));
        self
    }
    ...
    pub fn on_validationstatuschange(mut self, handler: crate::EventHandler) -> Self {
        self.events
            .push(("validationstatuschange".to_string(), handler));
        self
    }
...
impl From<Geolocation> for crate::Node {
