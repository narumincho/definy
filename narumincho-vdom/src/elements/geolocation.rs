...
impl Geolocation {
    ...
    pub fn autolocate(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("autolocate".to_string(), String::new());
        } else {
            self.attributes.remove("autolocate");
        }
        self.autolocate = Some(value);
        self
    }

    pub fn initial_permission_status(mut self, value: GeolocationInitialPermissionStatus) -> Self {
        self.attributes.insert("initialPermissionStatus".to_string(), value.as_str().to_string());
        self.initial_permission_status = Some(value);
        self
    }

    pub fn invalid_reason(mut self, value: GeolocationInvalidReason) -> Self {
        self.attributes.insert("invalidReason".to_string(), value.as_str().to_string());
        self.invalid_reason = Some(value);
        self
    }

    pub fn permission_status(mut self, value: GeolocationPermissionStatus) -> Self {
        self.attributes.insert("permissionStatus".to_string(), value.as_str().to_string());
        self.permission_status = Some(value);
        self
    }
    ...
    pub fn watch(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("watch".to_string(), String::new());
        } else {
            self.attributes.remove("watch");
        }
    ...
    pub fn on_location(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("location".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_promptaction(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("promptaction".to_string(), handler.into()));
        self
    }

    pub fn on_promptdismiss(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("promptdismiss".to_string(), handler.into()));
        self
    }
    ...
    pub fn on_validationstatuschange(mut self, handler: impl Into<String>) -> Self {
        self.events.push(("validationstatuschange".to_string(), handler.into()));
        self
    }
