...
pub enum StyleElementAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl StyleElementAutocapitalize {
...
impl From<StyleElementAutocapitalize> for String {
    fn from(value: StyleElementAutocapitalize) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum StyleElementDir {
    Ltr,
    Rtl,
    Auto,
}

impl StyleElementDir {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Ltr => "ltr",
            Self::Rtl => "rtl",
...
impl From<StyleElementDir> for String {
    fn from(value: StyleElementDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum StyleElementPopover {
    Auto,
    Manual,
}

impl StyleElementPopover {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Auto => "auto",
            Self::Manual => "manual",
...
impl From<StyleElementPopover> for String {
    fn from(value: StyleElementPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/semantics.html#the-style-element
...
impl From<StyleElement> for crate::Node {
    fn from(value: StyleElement) -> Self {
        value.into_node()
    }
}
