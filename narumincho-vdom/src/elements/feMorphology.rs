...
pub struct FeMorphology {
    ...
    pub radius_x: std::option::Option<String>,
    pub radius_y: std::option::Option<String>,
...
pub fn feMorphology() -> FeMorphology {
    FeMorphology::default()
}
...
impl FeMorphology {
    ...
    pub fn radius_x(mut self, value: impl Into<String>) -> Self {
        self.radius_x = Some(value.into());
        self
    }

    pub fn radius_y(mut self, value: impl Into<String>) -> Self {
        self.radius_y = Some(value.into());
        self
    }
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::FeMorphology(self),
            children,
        }
    }
}
