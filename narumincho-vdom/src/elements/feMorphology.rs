...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-femorphology
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-femorphology
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeMorphologyJsProperties {
