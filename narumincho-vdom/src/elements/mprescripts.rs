...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mprescripts
...
impl Mprescripts {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "mprescripts".to_string(),
...
impl From<Mprescripts> for crate::Node {
    fn from(value: Mprescripts) -> Self {
        value.into_node()
    }
}
