...
pub struct Svg {
    ...
    pub current_translate: std::option::Option<String>,
...
impl Svg {
    ...
    pub fn current_scale(mut self, value: impl Into<String>) -> Self {
        self.current_scale = Some(value.into());
        self
    }

    pub fn current_translate(mut self, value: impl Into<String>) -> Self {
        self.current_translate = Some(value.into());
        self
    }
