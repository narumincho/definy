...
pub struct Svg {
    ...
    pub current_scale: std::option::Option<String>,
...
impl Svg {
    ...
    pub fn current_scale(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("currentScale".to_string(), value.clone());
        self.current_scale = Some(value);
        self
    }
