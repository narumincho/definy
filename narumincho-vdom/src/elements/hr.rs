...
impl Hr {
    ...
    pub fn color(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("color".to_string(), value.clone());
    ...
    pub fn no_shade(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("noShade".to_string(), String::new());
        } else {
            self.attributes.remove("noShade");
        }
        self.no_shade = Some(value);
        self
    }
    ...
    pub fn size(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("size".to_string(), value.clone());
