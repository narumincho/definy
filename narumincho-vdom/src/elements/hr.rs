...
impl From<HrAutocapitalize> for String {
    fn from(value: HrAutocapitalize) -> Self {
...
impl From<HrDir> for String {
    fn from(value: HrDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<HrPopover> for String {
    fn from(value: HrPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-hr-element
...
impl Hr {
    ...
    pub fn no_shade(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "noShade");
        if value {
            self.attributes.push(("noShade".to_string(), String::new()));
        }
        self
    }
    ...
    pub fn size(self, value: impl Into<String>) -> Self {
        self.attribute("size", value)
    }
...
impl From<Hr> for crate::Node {
    fn from(value: Hr) -> Self {
        value.into_node()
    }
}
