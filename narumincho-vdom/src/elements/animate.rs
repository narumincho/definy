...
/// HTML Content Attributes for https://svgwg.org/specs/animations/#elementdef-animate
...
impl Animate {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "animate".to_string(),
    ...
    pub fn on_begin(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("begin".to_string(), handler));
        self
    }
    ...
    pub fn on_end(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("end".to_string(), handler));
        self
    }
    ...
    pub fn on_repeat(mut self, handler: crate::EventHandler) -> Self {
        self.events.push(("repeat".to_string(), handler));
        self
    }
...
impl From<Animate> for crate::Node {
