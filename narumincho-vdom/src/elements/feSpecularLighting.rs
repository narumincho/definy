...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fespecularlighting
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fespecularlighting
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeSpecularLightingJsProperties {
