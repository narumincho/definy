...
pub struct FeSpecularLighting {
    ...
    pub specular_constant: std::option::Option<String>,
    pub specular_exponent: std::option::Option<String>,
    pub surface_scale: std::option::Option<String>,
...
pub fn feSpecularLighting() -> FeSpecularLighting {
    FeSpecularLighting::default()
}
...
impl FeSpecularLighting {
    ...
    pub fn specular_constant(mut self, value: impl Into<String>) -> Self {
        self.specular_constant = Some(value.into());
        self
    }

    pub fn specular_exponent(mut self, value: impl Into<String>) -> Self {
        self.specular_exponent = Some(value.into());
        self
    }

    pub fn surface_scale(mut self, value: impl Into<String>) -> Self {
        self.surface_scale = Some(value.into());
        self
    }
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::FeSpecularLighting(self),
            children,
        }
    }
}
