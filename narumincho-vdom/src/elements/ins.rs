...
impl From<InsAutocapitalize> for String {
    fn from(value: InsAutocapitalize) -> Self {
...
impl From<InsDir> for String {
    fn from(value: InsDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<InsPopover> for String {
    fn from(value: InsPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/edits.html#the-ins-element
