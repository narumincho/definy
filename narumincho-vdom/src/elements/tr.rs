...
impl From<TrAutocapitalize> for String {
    fn from(value: TrAutocapitalize) -> Self {
...
impl From<TrDir> for String {
    fn from(value: TrDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<TrPopover> for String {
    fn from(value: TrPopover) -> Self {
        value.as_str().to_string()
    }
}
