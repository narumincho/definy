...
impl Tr {
    ...
    pub fn cells(mut self, value: impl Into<String>) -> Self {
        self.cells = Some(value.into());
        self
    }
    ...
    pub fn row_index(mut self, value: impl Into<String>) -> Self {
        self.row_index = Some(value.into());
        self
    }
    ...
    pub fn section_row_index(mut self, value: impl Into<String>) -> Self {
        self.section_row_index = Some(value.into());
        self
    }
