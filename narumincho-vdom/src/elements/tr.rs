...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/tables.html#the-tr-element
...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/tables.html#the-tr-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct TrJsProperties {
    ...
    pub cells: std::option::Option<String>,
    ...
    pub row_index: std::option::Option<String>,
    ...
    pub section_row_index: std::option::Option<String>,
