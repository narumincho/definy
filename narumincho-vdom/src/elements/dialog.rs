...
impl Dialog {
    ...
    pub fn closed_by(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("closedBy".to_string(), value.clone());
    ...
    pub fn open(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("open".to_string(), String::new());
        } else {
            self.attributes.remove("open");
        }
    ...
    pub fn return_value(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("returnValue".to_string(), value.clone());
