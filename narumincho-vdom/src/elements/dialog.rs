...
impl From<DialogAutocapitalize> for String {
    fn from(value: DialogAutocapitalize) -> Self {
...
impl From<DialogDir> for String {
    fn from(value: DialogDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum DialogPopover {
    Auto,
    Manual,
}
...
impl From<DialogPopover> for String {
    fn from(value: DialogPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/interactive-elements.html#the-dialog-element
...
impl Dialog {
    ...
    pub fn closed_by(self, value: impl Into<String>) -> Self {
    ...
    pub fn open(mut self, value: bool) -> Self {
        self.attributes.retain(|(key, _)| key != "open");
        if value {
            self.attributes.push(("open".to_string(), String::new()));
        }
        self
    }

    pub fn return_value(self, value: impl Into<String>) -> Self {
        self.attribute("returnValue", value)
    }
...
impl From<Dialog> for crate::Node {
