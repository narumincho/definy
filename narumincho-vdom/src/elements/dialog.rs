...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/interactive-elements.html#the-dialog-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct DialogJsProperties {
...
impl Dialog {
    ...
    pub fn closed_by(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("closedBy".to_string(), value.clone());
    ...
    pub fn return_value(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes
            .insert("returnValue".to_string(), value.clone());
