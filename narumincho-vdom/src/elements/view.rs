...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/linking.html#elementdef-view
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/linking.html#elementdef-view
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct ViewJsProperties {
