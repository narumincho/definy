...
impl From<PortalAutocapitalize> for String {
    fn from(value: PortalAutocapitalize) -> Self {
...
impl From<PortalDir> for String {
    fn from(value: PortalDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PortalPopover {
    Auto,
    Manual,
}
...
impl From<PortalPopover> for String {
    fn from(value: PortalPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://wicg.github.io/portals/#elementdef-portal
...
impl From<Portal> for crate::Node {
