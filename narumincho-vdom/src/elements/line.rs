...
pub struct Line {
    ...
    pub path_length: std::option::Option<String>,
    ...
    pub x1: std::option::Option<String>,
    pub x2: std::option::Option<String>,
    pub y1: std::option::Option<String>,
    pub y2: std::option::Option<String>,
}
...
impl Line {
    ...
    pub fn path_length(mut self, value: impl Into<String>) -> Self {
        self.path_length = Some(value.into());
        self
    }
    ...
    pub fn x1(mut self, value: impl Into<String>) -> Self {
        self.x1 = Some(value.into());
        self
    }

    pub fn x2(mut self, value: impl Into<String>) -> Self {
        self.x2 = Some(value.into());
        self
    }

    pub fn y1(mut self, value: impl Into<String>) -> Self {
        self.y1 = Some(value.into());
        self
    }

    pub fn y2(mut self, value: impl Into<String>) -> Self {
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::Line(self),
            children,
        }
    }
}
