...
impl FeDropShadow {
    ...
    pub fn std_deviation_x(mut self, value: impl Into<String>) -> Self {
        self.std_deviation_x = Some(value.into());
        self
    }

    pub fn std_deviation_y(mut self, value: impl Into<String>) -> Self {
        self.std_deviation_y = Some(value.into());
        self
    }
