...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-mtr
...
/// JavaScript / DOM Properties for https://w3c.github.io/mathml-core/#dfn-mtr
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct MtrJsProperties {
...
impl Mtr {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Mtr(self),
            children: Vec::new(),
        })
    }
