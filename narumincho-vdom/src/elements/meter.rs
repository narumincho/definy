...
impl From<MeterAutocapitalize> for String {
    fn from(value: MeterAutocapitalize) -> Self {
...
impl From<MeterDir> for String {
    fn from(value: MeterDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum MeterPopover {
    Auto,
    Manual,
}
...
impl From<MeterPopover> for String {
    fn from(value: MeterPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/form-elements.html#the-meter-element
...
impl Meter {
    ...
    pub fn high(self, value: impl Into<String>) -> Self {
        self.attribute("high", value)
    }
    ...
    pub fn low(self, value: impl Into<String>) -> Self {
        self.attribute("low", value)
    }
    ...
    pub fn optimum(self, value: impl Into<String>) -> Self {
        self.attribute("optimum", value)
    }
...
impl From<Meter> for crate::Node {
