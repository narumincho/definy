...
pub enum SectionAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<SectionAutocapitalize> for String {
    fn from(value: SectionAutocapitalize) -> Self {
...
impl From<SectionDir> for String {
    fn from(value: SectionDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum SectionPopover {
    Auto,
    Manual,
}
...
impl From<SectionPopover> for String {
    fn from(value: SectionPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/sections.html#the-section-element
...
impl Section {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "section".to_string(),
...
impl From<Section> for crate::Node {
