...
pub struct FeSpotLight {
    ...
    pub limiting_cone_angle: std::option::Option<String>,
    ...
    pub points_at_x: std::option::Option<String>,
    pub points_at_y: std::option::Option<String>,
    pub points_at_z: std::option::Option<String>,
    ...
    pub z: std::option::Option<String>,
}

pub fn feSpotLight() -> FeSpotLight {
    FeSpotLight::default()
}
...
impl FeSpotLight {
    ...
    pub fn limiting_cone_angle(mut self, value: impl Into<String>) -> Self {
        self.limiting_cone_angle = Some(value.into());
        self
    }
    ...
    pub fn points_at_x(mut self, value: impl Into<String>) -> Self {
        self.points_at_x = Some(value.into());
        self
    }

    pub fn points_at_y(mut self, value: impl Into<String>) -> Self {
        self.points_at_y = Some(value.into());
        self
    }

    pub fn points_at_z(mut self, value: impl Into<String>) -> Self {
        self.points_at_z = Some(value.into());
        self
    }
    ...
    pub fn z(mut self, value: impl Into<String>) -> Self {
        self.z = Some(value.into());
        self
    }
    ...
    pub fn to_element(self, children: Vec<super::Node>) -> super::Element {
        super::Element {
            ...
            element_content: super::ElementContent::FeSpotLight(self),
            children,
        }
    }
}
