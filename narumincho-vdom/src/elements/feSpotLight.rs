...
/// HTML Content Attributes for https://drafts.csswg.org/filter-effects-1/#elementdef-fespotlight
...
/// JavaScript / DOM Properties for https://drafts.csswg.org/filter-effects-1/#elementdef-fespotlight
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct FeSpotLightJsProperties {
