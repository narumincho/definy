...
pub enum FigcaptionAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl From<FigcaptionAutocapitalize> for String {
    fn from(value: FigcaptionAutocapitalize) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum FigcaptionDir {
    Ltr,
    Rtl,
    Auto,
}
...
impl From<FigcaptionDir> for String {
    fn from(value: FigcaptionDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum FigcaptionPopover {
    Auto,
    Manual,
}

impl FigcaptionPopover {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Auto => "auto",
            Self::Manual => "manual",
...
impl From<FigcaptionPopover> for String {
    fn from(value: FigcaptionPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/grouping-content.html#the-figcaption-element
...
impl Figcaption {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "figcaption".to_string(),
...
impl From<Figcaption> for crate::Node {
    fn from(value: Figcaption) -> Self {
        value.into_node()
    }
}
