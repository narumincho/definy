...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/shapes.html#elementdef-circle
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/shapes.html#elementdef-circle
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct CircleJsProperties {
...
impl Circle {
    ...
    pub fn into_node(self) -> super::Node {
        super::Node::Element(super::Element {
            ...
            element_content: super::ElementContent::Circle(self),
            children: Vec::new(),
        })
    }
