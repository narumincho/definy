...
/// HTML Content Attributes for https://w3c.github.io/mathml-core/#dfn-munderover
...
impl Munderover {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "munderover".to_string(),
...
impl From<Munderover> for crate::Node {
    fn from(value: Munderover) -> Self {
        value.into_node()
    }
}
