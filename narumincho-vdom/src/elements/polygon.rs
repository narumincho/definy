...
/// HTML Content Attributes for https://w3c.github.io/svgwg/svg2-draft/shapes.html#elementdef-polygon
...
/// JavaScript / DOM Properties for https://w3c.github.io/svgwg/svg2-draft/shapes.html#elementdef-polygon
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct PolygonJsProperties {
