...
pub enum SelectedcontentAutocapitalize {
    Off,
    None,
    Characters,
    Words,
...
impl SelectedcontentAutocapitalize {
...
impl From<SelectedcontentAutocapitalize> for String {
    fn from(value: SelectedcontentAutocapitalize) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum SelectedcontentDir {
    Ltr,
    Rtl,
    Auto,
}

impl SelectedcontentDir {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Ltr => "ltr",
            Self::Rtl => "rtl",
...
impl From<SelectedcontentDir> for String {
    fn from(value: SelectedcontentDir) -> Self {
        value.as_str().to_string()
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum SelectedcontentPopover {
    Auto,
    Manual,
}

impl SelectedcontentPopover {
    pub fn as_str(&self) -> &'static str {
        match self {
            Self::Auto => "auto",
            Self::Manual => "manual",
...
impl From<SelectedcontentPopover> for String {
    fn from(value: SelectedcontentPopover) -> Self {
        value.as_str().to_string()
    }
}

/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/form-elements.html#the-selectedcontent-element
...
impl Default for Selectedcontent {
    fn default() -> Self {
        Self::new()
    }
}
...
impl Selectedcontent {
    ...
    pub fn into_node(self) -> crate::Node {
        crate::Node::Element(crate::Element {
            element_name: "selectedcontent".to_string(),
...
impl From<Selectedcontent> for crate::Node {
    fn from(value: Selectedcontent) -> Self {
        value.into_node()
    }
}
