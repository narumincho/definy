...
/// JavaScript / DOM Properties for https://html.spec.whatwg.org/multipage/form-elements.html#the-selectedcontent-element
#[derive(Default, Debug, Clone, PartialEq, Eq)]
pub struct SelectedcontentJsProperties {
