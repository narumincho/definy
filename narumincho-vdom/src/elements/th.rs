...
/// HTML Content Attributes for https://html.spec.whatwg.org/multipage/tables.html#the-th-element
...
impl Th {
    ...
    pub fn abbr(mut self, value: impl Into<String>) -> Self {
        ...
        self.attributes.insert("abbr".to_string(), value.clone());
        self.abbr = Some(value);
        self
    }
    ...
    pub fn axis(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("axis".to_string(), value.clone());
    ...
    pub fn ch(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("ch".to_string(), value.clone());
        self.ch = Some(value);
        self
    }

    pub fn ch_off(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("chOff".to_string(), value.clone());
        self.ch_off = Some(value);
        self
    }

    pub fn headers(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("headers".to_string(), value.clone());
    ...
    pub fn no_wrap(mut self, value: bool) -> Self {
        if value {
            self.attributes.insert("noWrap".to_string(), String::new());
        } else {
            self.attributes.remove("noWrap");
        }
        self.no_wrap = Some(value);
        self
    }
    ...
    pub fn scope(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("scope".to_string(), value.clone());
    ...
    pub fn v_align(mut self, value: impl Into<String>) -> Self {
        let value = value.into();
        self.attributes.insert("vAlign".to_string(), value.clone());
        self.v_align = Some(value);
        self
    }
