...
impl From<ThAutocapitalize> for String {
    fn from(value: ThAutocapitalize) -> Self {
...
impl From<ThDir> for String {
    fn from(value: ThDir) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<ThPopover> for String {
    fn from(value: ThPopover) -> Self {
        value.as_str().to_string()
    }
}
...
impl From<Th> for crate::Node {
    fn from(value: Th) -> Self {
        value.into_node()
    }
}
