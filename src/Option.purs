...
-- |
-- | bar :: Int
-- | bar = Option.getWithDefault 13 (Proxy.Proxy :: _ "bar") someOption
-- | ```
-- |
-- | The `proxy` can be anything so long as its type variable has kind `Symbol`.
-- |
...
-- |
-- | anotherOption :: Option.Option ( foo :: Boolean, bar :: Int )
-- | anotherOption = Option.modify (Proxy.Proxy :: _ "bar") (_ + 1) someOption
-- | ```
-- |
-- | The `proxy` can be anything so long as its type variable has kind `Symbol`.
-- |
...
-- | anotherRecord = Option.recordRename { bar: Proxy.Proxy :: _ "bar2" } someRecord
-- | ```
recordRename ::
...
-- | anotherOption = Option.rename { bar: Proxy.Proxy :: _ "bar2" } someOption
-- | ```
rename ::
...
-- |
-- | anotherOption :: Option.Option ( foo :: Boolean, bar :: Int )
-- | anotherOption = Option.set (Proxy.Proxy :: _ "bar") 31 someOption
-- | ```
-- |
-- | The `proxy` can be anything so long as its type variable has kind `Symbol`.
-- |
...
age = get (Proxy.Proxy :: _ "age") user

user1 :: User
user1 = set (Proxy.Proxy :: _ "age") 12 user

user2 :: Option ( username :: String, age :: Int, height :: Int )
user2 = insert (Proxy.Proxy :: _ "height") 12 user

user3 :: Option ( username :: String, age :: Boolean )
user3 = set (Proxy.Proxy :: _ "age") true user

user4 :: Option ( username :: String )
user4 = delete (Proxy.Proxy :: _ "age") user

user5 :: Option ( username :: String, age :: Boolean )
user5 = modify (Proxy.Proxy :: _ "age") (\_ -> true) user
...
user27 = rename { age: Proxy.Proxy :: Proxy.Proxy "age1" } user

user28 :: Option ( age :: Int, username2 :: String )
user28 = rename { username: Proxy.Proxy :: Proxy.Proxy "username2" } user
...
greeting8 = recordRename { name: Proxy.Proxy :: Proxy.Proxy "Name", title: Proxy.Proxy :: Proxy.Proxy "Title" } greeting1
