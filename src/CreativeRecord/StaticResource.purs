...
module CreativeRecord.StaticResource (battlePng, colorPng, definy20210811Png, desired_route_titlePng, fontPng, grape_svg_codePng, gravity_starPng, henkanPng, iconPng, kamausagiPng, list_uiPng, not_foundPng, powershell_iconPng, pure_script_code_genPng, starPng, svg_basicPng, tsukumartPng, windowPng) where
