...
keyList : List { pos : ( Int, Int ), shape : KeyShape, stroke : List (NSvg Msg), key : Key.OneKey }
keyList =
...
selectFrame : Key.OneKey -> NSvg msg
selectFrame oneKey =
    let
        shapeData =
            getPosAndKeyShapeFromOneKey oneKey
    in
    keyShapeToNSvgShape shapeData.shape
        (NSvg.strokeColorWidth P.orange 30)
        NSvg.fillNone
        |> NSvg.translate
...
getPosAndKeyShapeFromOneKeyLoop : Key.OneKey -> List { pos : ( Int, Int ), shape : KeyShape, stroke : List (NSvg Msg), key : Key.OneKey } -> { pos : ( Int, Int ), shape : KeyShape }
...
keyShapeToNSvg : KeyShape -> NSvg Msg
keyShapeToNSvg keyShape =
    keyShapeToNSvgShape keyShape
        (NSvg.strokeColorWidth P.black 20)
        (NSvg.fillColor (Color.fromRGB ( 65, 65, 65 )))


keyShapeToNSvgShape : KeyShape -> NSvg.StrokeStyle -> NSvg.FillStyle -> NSvg msg
keyShapeToNSvgShape keyShape =
    case keyShape of
        KeyShape3x2 ->
            NSvg.rect { width = 300, height = 200 }

        KeyShape4x2 ->
            NSvg.rect { width = 400, height = 200 }

        KeyShape3x3 ->
            NSvg.rect { width = 300, height = 300 }

        KeyShape4x3 ->
            NSvg.rect { width = 400, height = 300 }

        KeyShape5x3 ->
            NSvg.rect { width = 500, height = 300 }

        KeyShape6x3 ->
            NSvg.rect { width = 600, height = 300 }

        KeyShape15x3 ->
            NSvg.rect { width = 1500, height = 300 }

        KeyShapeEnter ->
            NSvg.polygon [ ( 0, 0 ), ( 700, 0 ), ( 700, 600 ), ( 100, 600 ), ( 100, 300 ), ( 0, 300 ) ]

        KeyShape6x2 ->
            NSvg.rect { width = 600, height = 200 }

        KeyShape3x6 ->
            NSvg.rect { width = 300, height = 600 }


addKeyFrameAndClick : Maybe Key.OneKey -> { pos : ( Int, Int ), shape : KeyShape, stroke : List (NSvg Msg), key : Key.OneKey } -> List (NSvg Msg)
addKeyFrameAndClick selectedKey { pos, shape, stroke, key } =
    keyShapeToNSvgShapeClick shape (SelectKey key)
        :: stroke
        |> List.map
            (NSvg.translate
...
keyShapeToNSvgShapeClick : KeyShape -> Msg -> NSvg Msg
keyShapeToNSvgShapeClick keyShape msg =
    (case keyShape of
        KeyShape3x2 ->
            NSvg.rectWithClickEvent { width = 300, height = 200 }

        KeyShape4x2 ->
            NSvg.rectWithClickEvent { width = 400, height = 200 }

        KeyShape3x3 ->
            NSvg.rectWithClickEvent { width = 300, height = 300 }

        KeyShape4x3 ->
            NSvg.rectWithClickEvent { width = 400, height = 300 }

        KeyShape5x3 ->
            NSvg.rectWithClickEvent { width = 500, height = 300 }

        KeyShape6x3 ->
            NSvg.rectWithClickEvent { width = 600, height = 300 }

        KeyShape15x3 ->
            NSvg.rectWithClickEvent { width = 1500, height = 300 }

        KeyShapeEnter ->
            NSvg.polygonWithClickEvent [ ( 0, 0 ), ( 700, 0 ), ( 700, 600 ), ( 100, 600 ), ( 100, 300 ), ( 0, 300 ) ]

        KeyShape6x2 ->
            NSvg.rectWithClickEvent { width = 600, height = 200 }

        KeyShape3x6 ->
            NSvg.rectWithClickEvent { width = 300, height = 600 }
    )
        (NSvg.strokeColorWidth
            P.black
            20
        )
        (NSvg.fillColor (Color.fromRGB ( 65, 65, 65 )))
