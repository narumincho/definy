...
import { typeAnnotation, typeToString } from "./type";
import { statementListToString } from "./statement";
  ...
  switch (expr._) {
    ...
    case "TypeAssertion":
      return (
        ...
        (codeType === d.CodeType.TypeScript
...
const binaryOperatorExprToString = (
  ...
  const operatorExprCombineStrength = exprCombineStrength(
    d.TsExpr.BinaryOperator(binaryOperatorExpr)
  );
