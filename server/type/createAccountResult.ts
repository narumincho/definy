...
export type CreateAccountResult = CreateAccountNotFoundTotpKeyId | CreateAccountDuplicateCode | CreateAccountInvalidCode | CreateAccountResultOk;

export const CreateAccountResult = new g.GraphQLUnionType({
name: "CreateAccountResult",
types: [CreateAccountNotFoundTotpKeyId, CreateAccountDuplicateCode, CreateAccountInvalidCode, CreateAccountResultOk]
})