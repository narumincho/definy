...
await build({
  ...
  mappings: {
    "https://esm.sh/prettier@2.8.7?pin=v135": {
      name: "prettier",
      version: "^2.7.1",
    },
    "https://esm.sh/prettier@2.8.7/parser-typescript?pin=v135": {
      name: "prettier",
      version: "^2.7.1",
    ...
    "https://esm.sh/react-dom@18.2.0/client?pin=v135": {
      name: "react-dom",
      version: "^18.2.0",
      subPath: "client.js",
    },
    "https://esm.sh/react-dom@18.2.0/server?pin=v135": {
      name: "react-dom",
      version: "^18.2.0",
      subPath: "server.js",
    },
