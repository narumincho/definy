...
import * as a from "https://raw.githubusercontent.com/narumincho/definy/f9d7aaa5a3f1aba6dc0c478908ab96883eb5fad0/deno-lib/definyRpc/core/maybe.ts";
import * as b from "https://raw.githubusercontent.com/narumincho/definy/f9d7aaa5a3f1aba6dc0c478908ab96883eb5fad0/deno-lib/definyRpc/core/request.ts";
import * as c from "https://raw.githubusercontent.com/narumincho/definy/f9d7aaa5a3f1aba6dc0c478908ab96883eb5fad0/deno-lib/definyRpc/core/coreType.ts";
        ...
        c.DefinyRpcTypeInfo.from({
          ...
          body: c.TypeBody.sum([
            c.Pattern.from({
              ...
              parameter: c.Maybe.nothing(),
            }),
            c.Pattern.from({
              name: "local",
              description: "definy RPC を利用するユーザーが定義したモジュール",
              parameter: c.Maybe.just(c.List.type(c.String.type())),
            }),
          ]),
        }),
      ],
        ...
        c.DefinyRpcTypeInfo.from({
          ...
          body: c.TypeBody.product([
            ...
            c.Field.from({
              name: "parameter",
              description: "パラメーター",
              type: c.List.type(c.TypeParameterInfo.type()),
            }),
            c.Field.from({
              name: "attribute",
