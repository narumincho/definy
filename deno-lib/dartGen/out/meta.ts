...
export const name = (parameter: {
  /**
   * api end point
   * @default new URL("http://localhost:2403")
   */
  readonly url?: globalThis.URL | undefined;
}): globalThis.Promise<a.Result<string, string>> =>
  b.requestQuery({
    url: parameter.url ?? new globalThis.URL("http://localhost:2403"),
 ...
 *  保存先:file:///C:/Users/narum/Documents/GitHub/definy/deno-lib/dartGen/out/
 */
